...
"""
Delete a Patient Record - ADT_A23
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A23 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A23
from utils.hl7.v2_5_1.segments import (
    PV1, PD1, DB1, MSH, SFT, PID, EVN, OBX, PV2
)

adt_a23 = ADT_A23(  #  - The A23 event is used to delete visit or episode-specific information from the patient record
...
-----END TRIGGER_EVENT::ADT_A23 TEMPLATE-----
"""


class ADT_A23(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A23"""
    _hl7_name = """Delete a Patient Record"""
    _hl7_description = """The A23 event is used to delete visit or episode-specific information from the patient record"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A23"""
    ...
    def __init__(
        ...
        """
         - `ADT_A23 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A23>`_
