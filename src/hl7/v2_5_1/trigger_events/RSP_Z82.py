...
"""
Dispense History Response - RSP_Z82
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RSP_Z82 TEMPLATE-----
...
rsp_z82 = RSP_Z82(  #  - The purpose of this query/response is to retrieve patient pharmacy dispense history information from the Server
    ...
    query_response=rsp_z82_query_response_group,  # RSP_Z82_QUERY_RESPONSE_GROUP(...)  # Required.
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RSP_Z82 TEMPLATE-----
"""


class RSP_Z82(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    ...
    _hl7_description = """The purpose of this query/response is to retrieve patient pharmacy dispense history information from the Server"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z82"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 1, 65535, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "R", "R", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "7", "None", "32")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RCP, RSP_Z82_QUERY_RESPONSE_GROUP, DSC)
    ...
    def __init__(
        ...
        query_response: RSP_Z82_QUERY_RESPONSE_GROUP
        | tuple[RSP_Z82_QUERY_RESPONSE_GROUP, ...],  #  Required. (, ...)
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        error: ERR | None = None,  #  ERR.4
        continuation_pointer: DSC | None = None,  #  DSC.32
    ):
        """
         - `RSP_Z82 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z82>`_
    ...
    def query_response(self) -> tuple[RSP_Z82_QUERY_RESPONSE_GROUP, ...]:
        """
        id: RSP_Z82_QUERY_RESPONSE_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RSP_Z82_QUERY_RESPONSE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_Z82_QUERY_RESPONSE_GROUP
        """
    ...
    def query_response(
        self,
        query_response: RSP_Z82_QUERY_RESPONSE_GROUP
        | tuple[RSP_Z82_QUERY_RESPONSE_GROUP, ...],
    ):
        """
        id: QUERY RESPONSE SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RSP_Z82_QUERY_RESPONSE_GROUP.None | tuple[RSP_Z82_QUERY_RESPONSE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_Z82_QUERY_RESPONSE_GROUP
        """
