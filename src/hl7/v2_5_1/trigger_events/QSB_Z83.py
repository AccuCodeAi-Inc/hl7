...
"""
Publish ORU Subscription - QSB_Z83
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QSB_Z83 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QSB_Z83
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, SFT, RCP, DSC
)

qsb_z83 = QSB_Z83(  #  - The purpose of this publish/response pair is to send Lab Results, either filtered or unfiltered, as specified in the input parameters
...
-----END TRIGGER_EVENT::QSB_Z83 TEMPLATE-----
"""


class QSB_Z83(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QSB_Z83"""
    _hl7_name = """Publish ORU Subscription"""
    _hl7_description = """The purpose of this publish/response pair is to send Lab Results, either filtered or unfiltered, as specified in the input parameters"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QSB_Z83"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QSB_Z83 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QSB_Z83>`_
