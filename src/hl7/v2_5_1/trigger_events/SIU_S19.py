...
"""
Notification of Modification of Service/Resource on Appointment - SIU_S19
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::SIU_S19 TEMPLATE-----
...
siu_s19 = SIU_S19(  #  - The notification of modification of service/resource is triggered on the filler application when the information pertaining to an existing service or resource has been changed for an existing appointment
    ...
    patient=None,  # SIU_S19_PATIENT_GROUP(...) 
    resources=siu_s19_resources_group,  # SIU_S19_RESOURCES_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::SIU_S19 TEMPLATE-----
"""


class SIU_S19(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """SIU_S19"""
    _hl7_name = """Notification of Modification of Service/Resource on Appointment"""
    _hl7_description = """The notification of modification of service/resource is triggered on the filler application when the information pertaining to an existing service or resource has been changed for an existing appointment"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SIU_S19"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 65535)
    _c_usage = ("R", "R", "O", "O", "O", "R")
    _c_aliases = ("1", "2", "3", "4", "None", "None")
    _c_components = (MSH, SCH, TQ1, NTE, SIU_S19_PATIENT_GROUP, SIU_S19_RESOURCES_GROUP)
    ...
    def __init__(
        ...
        | tuple[SIU_S19_RESOURCES_GROUP, ...],  #  Required. (RGS.11, ...)
        timing_or_quantity: TQ1 | tuple[TQ1, ...] | None = None,  #  TQ1.3
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.4
        patient: SIU_S19_PATIENT_GROUP
        | tuple[SIU_S19_PATIENT_GROUP, ...]
        | None = None,  #  (PID.5, PD1.6, PV1.7, PV2.8, OBX.9, DG1.10, ...)
    ):
        """
         - `SIU_S19 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SIU_S19>`_
    ...
    def patient(self) -> tuple[SIU_S19_PATIENT_GROUP, ...] | tuple[None]:
        """
        id: SIU_S19_PATIENT_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[SIU_S19_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S19_PATIENT_GROUP
        """
        return self._c_data[4]

    @patient.setter  # set PATIENT
    def patient(
        self, patient: SIU_S19_PATIENT_GROUP | tuple[SIU_S19_PATIENT_GROUP, ...] | None
    ):
        """
        id: PATIENT SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: SIU_S19_PATIENT_GROUP.None | tuple[SIU_S19_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S19_PATIENT_GROUP
        """
    ...
    def resources(self) -> tuple[SIU_S19_RESOURCES_GROUP, ...]:
        """
        id: SIU_S19_RESOURCES_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[SIU_S19_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S19_RESOURCES_GROUP
        """
        return self._c_data[5]

    @resources.setter  # set RESOURCES
    def resources(
        self, resources: SIU_S19_RESOURCES_GROUP | tuple[SIU_S19_RESOURCES_GROUP, ...]
    ):
        """
        id: RESOURCES SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: SIU_S19_RESOURCES_GROUP.None | tuple[SIU_S19_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S19_RESOURCES_GROUP
        """
