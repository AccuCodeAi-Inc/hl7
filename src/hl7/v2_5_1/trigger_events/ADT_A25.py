...
"""
Cancel Pending Discharge - ADT_A25
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A25 TEMPLATE-----
...
-----END TRIGGER_EVENT::ADT_A25 TEMPLATE-----
"""


class ADT_A25(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A25"""
    _hl7_name = """Cancel Pending Discharge"""
    _hl7_description = """The A25 event is sent when an A16 (pending discharge) event is cancelled, either because of erroneous entry of the A16 event or because of a decision not to discharge the patient after all"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A25"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A25 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A25>`_
