...
"""
Pharmacy/Treatment Administration Information Query - QRY_Q27
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QRY_Q27 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QRY_Q27
from utils.hl7.v2_5_1.segments import (
    DSC, QRD, MSH, SFT, QRF
)

qry_q27 = QRY_Q27(  #  - This query/response pair is retained for backward compatibility only
...
-----END TRIGGER_EVENT::QRY_Q27 TEMPLATE-----
"""


class QRY_Q27(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QRY_Q27"""
    _hl7_name = """Pharmacy/Treatment Administration Information Query"""
    _hl7_description = """This query/response pair is retained for backward compatibility only"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_Q27"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QRY_Q27 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_Q27>`_
