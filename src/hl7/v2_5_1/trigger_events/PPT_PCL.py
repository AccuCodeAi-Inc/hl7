...
"""
Pathway (goal-oriented) query response - PPT_PCL
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::PPT_PCL TEMPLATE-----
...
ppt_pcl = PPT_PCL(  #  - The following trigger/message event is served by PPT (a response from the system responsible for maintaining the goal-oriented pathway information)
    ...
    patient=ppt_pcl_patient_group,  # PPT_PCL_PATIENT_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::PPT_PCL TEMPLATE-----
"""


class PPT_PCL(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """PPT_PCL"""
    _hl7_name = """Pathway (goal-oriented) query response"""
    _hl7_description = """The following trigger/message event is served by PPT (a response from the system responsible for maintaining the goal-oriented pathway information)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PPT_PCL"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 65535, 1, 1, 65535)
    _c_usage = ("R", "O", "R", "O", "O", "R", "R")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QRD, PPT_PCL_PATIENT_GROUP)
    ...
    def __init__(
        ...
        | tuple[PPT_PCL_PATIENT_GROUP, ...],  #  Required. (PID.7, ...)
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        error: ERR | tuple[ERR, ...] | None = None,  #  ERR.4
        query_acknowledgment: QAK | None = None,  #  QAK.5
    ):
        """
         - `PPT_PCL <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PPT_PCL>`_
    ...
    def patient(self) -> tuple[PPT_PCL_PATIENT_GROUP, ...]:
        """
        id: PPT_PCL_PATIENT_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[PPT_PCL_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PPT_PCL_PATIENT_GROUP
        """
        return self._c_data[6]

    @patient.setter  # set PATIENT
    def patient(
        self, patient: PPT_PCL_PATIENT_GROUP | tuple[PPT_PCL_PATIENT_GROUP, ...]
    ):
        """
        id: PATIENT SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: PPT_PCL_PATIENT_GROUP.None | tuple[PPT_PCL_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PPT_PCL_PATIENT_GROUP
        """
