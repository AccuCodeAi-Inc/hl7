...
from ..segment_groups.MFR_M04_MF_QUERY_GROUP import MFR_M04_MF_QUERY_GROUP


"""
Master Files Response - Charge description master file - MFR_M04
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::MFR_M04 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import MFR_M04
from utils.hl7.v2_5_1.segments import (
    MSH, QRD, MFI, SFT, ERR, QRF, DSC, QAK, MSA
)
from utils.hl7.v2_5_1.segment_groups import (
    MFR_M04_MF_QUERY_GROUP
)

mfr_m04 = MFR_M04(  #  - The MFQ/MFR transaction allows a system to query for a particular record or group records (defined by the primary key) in a particular master file
    ...
    mf_query=mfr_m04_mf_query_group,  # MFR_M04_MF_QUERY_GROUP(...)  # Required.
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::MFR_M04 TEMPLATE-----
"""


class MFR_M04(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """MFR_M04"""
    _hl7_name = """Master Files Response - Charge description master file"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MFR_M04"""
    ...
    _c_components = (MSH, SFT, MSA, ERR, QAK, QRD, QRF, MFI, MFR_M04_MF_QUERY_GROUP, DSC)
    ...
    def __init__(
        ...
        mf_query: MFR_M04_MF_QUERY_GROUP
        | tuple[MFR_M04_MF_QUERY_GROUP, ...],  #  Required. (MFE.9, CDM.10, PRC.11, ...)
        ...
        """
         - `MFR_M04 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MFR_M04>`_
        ...
        :param mf_query: Mf Query segment group: [MFE, CDM, PRC|None] (id: MF QUERY | seq: 9, 10, 11 | use: R | rpt: *)
    ...
    def mf_query(self) -> tuple[MFR_M04_MF_QUERY_GROUP, ...]:
        """
        id: MFR_M04_MF_QUERY_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[MFR_M04_MF_QUERY_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MFR_M04_MF_QUERY_GROUP
        """
        return self._c_data[8]

    @mf_query.setter  # set MF QUERY
    def mf_query(
        self, mf_query: MFR_M04_MF_QUERY_GROUP | tuple[MFR_M04_MF_QUERY_GROUP, ...]
    ):
        """
        id: MF QUERY SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: MFR_M04_MF_QUERY_GROUP.None | tuple[MFR_M04_MF_QUERY_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MFR_M04_MF_QUERY_GROUP
        """
