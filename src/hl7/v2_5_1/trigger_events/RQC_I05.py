...
from ..segment_groups.RQC_I05_PROVIDER_GROUP import RQC_I05_PROVIDER_GROUP
...
"""
Request for patient clinical information - RQC_I05
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RQC_I05 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RQC_I05
from utils.hl7.v2_5_1.segments import (
    PID, MSH, QRD, NK1, SFT, GT1, NTE, QRF
)
from utils.hl7.v2_5_1.segment_groups import (
    RQC_I05_PROVIDER_GROUP
)

rqc_i05 = RQC_I05(  #  - This event is used to request clinical information for a specific patient
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    original_style_query_definition=qrd,  # QRD(...)  # Required.
    original_style_query_filter=None,  # QRF(...) 
    provider=rqc_i05_provider_group,  # RQC_I05_PROVIDER_GROUP(...)  # Required.
...
-----END TRIGGER_EVENT::RQC_I05 TEMPLATE-----
"""


class RQC_I05(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RQC_I05"""
    _hl7_name = """Request for patient clinical information"""
    _hl7_description = """This event is used to request clinical information for a specific patient"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQC_I05"""
    ...
    _c_components = (MSH, SFT, QRD, QRF, RQC_I05_PROVIDER_GROUP, PID, NK1, GT1, NTE)
    ...
    def __init__(
        ...
        | tuple[RQC_I05_PROVIDER_GROUP, ...],  #  Required. (PRD.5, CTD.6, ...)
        ...
        """
         - `RQC_I05 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQC_I05>`_
    ...
    def provider(self) -> tuple[RQC_I05_PROVIDER_GROUP, ...]:
        """
        id: RQC_I05_PROVIDER_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RQC_I05_PROVIDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQC_I05_PROVIDER_GROUP
        """
        return self._c_data[4]

    @provider.setter  # set PROVIDER
    def provider(
        self, provider: RQC_I05_PROVIDER_GROUP | tuple[RQC_I05_PROVIDER_GROUP, ...]
    ):
        """
        id: PROVIDER SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RQC_I05_PROVIDER_GROUP.None | tuple[RQC_I05_PROVIDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQC_I05_PROVIDER_GROUP
        """
