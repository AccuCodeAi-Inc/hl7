...
from ..segment_groups.SRR_S09_SCHEDULE_GROUP import SRR_S09_SCHEDULE_GROUP
from ..segments.MSH import MSH
from ..segments.ERR import ERR


"""
Scheduled request response - Cancellation of service/resource on appointment - SRR_S09
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::SRR_S09 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SRR_S09
from utils.hl7.v2_5_1.segments import (
    MSH, MSA, ERR
)
from utils.hl7.v2_5_1.segment_groups import (
    SRR_S09_SCHEDULE_GROUP
)

srr_s09 = SRR_S09(  #  - This trigger event requests that a service or resource be removed from an existing scheduled appointment that has not yet begun
    message_header=msh,  # MSH(...)  # Required.
    message_acknowledgment=msa,  # MSA(...)  # Required.
    error=None,  # ERR(...) 
    schedule=None,  # SRR_S09_SCHEDULE_GROUP(...) 
)

-----END TRIGGER_EVENT::SRR_S09 TEMPLATE-----
"""


class SRR_S09(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """SRR_S09"""
    _hl7_name = """Scheduled request response - Cancellation of service/resource on appointment"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S09"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 1)
    _c_usage = ("R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "None")
    _c_components = (MSH, MSA, ERR, SRR_S09_SCHEDULE_GROUP)
    ...
    def __init__(
        ...
        schedule: SRR_S09_SCHEDULE_GROUP | None = None,  #  SCH.4, TQ1.5, NTE.6
    ):
        """
         - `SRR_S09 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S09>`_
    ...
    @property  # get SRR_S09_SCHEDULE_GROUP.None
    def schedule(self) -> SRR_S09_SCHEDULE_GROUP | None:
        """
        id: SRR_S09_SCHEDULE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: SRR_S09_SCHEDULE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S09_SCHEDULE_GROUP
        """
        return self._c_data[3][0]

    @schedule.setter  # set SRR_S09_SCHEDULE_GROUP.None
    def schedule(self, schedule: SRR_S09_SCHEDULE_GROUP | None):
        """
        id: SRR_S09_SCHEDULE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: SRR_S09_SCHEDULE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S09_SCHEDULE_GROUP
        """
