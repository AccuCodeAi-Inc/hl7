...
from ..segment_groups.PRR_PC5_PATIENT_GROUP import PRR_PC5_PATIENT_GROUP
...
"""
Patient problem response - PRR_PC5
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::PRR_PC5 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import PRR_PC5
from utils.hl7.v2_5_1.segments import (
    QAK, QRD, SFT, ERR, MSA, MSH
)
from utils.hl7.v2_5_1.segment_groups import (
    PRR_PC5_PATIENT_GROUP
)

prr_pc5 = PRR_PC5(  #  - The following trigger/message event is served by PRR (a response from the system responsible for maintaining the problem information)
    ...
    patient=prr_pc5_patient_group,  # PRR_PC5_PATIENT_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::PRR_PC5 TEMPLATE-----
"""


class PRR_PC5(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """PRR_PC5"""
    _hl7_name = """Patient problem response"""
    _hl7_description = """The following trigger/message event is served by PRR (a response from the system responsible for maintaining the problem information)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PRR_PC5"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 65535, 1, 1, 65535)
    _c_usage = ("R", "O", "R", "O", "O", "R", "R")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QRD, PRR_PC5_PATIENT_GROUP)
    ...
    def __init__(
        ...
        | tuple[PRR_PC5_PATIENT_GROUP, ...],  #  Required. (PID.7, ...)
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        error: ERR | tuple[ERR, ...] | None = None,  #  ERR.4
        query_acknowledgment: QAK | None = None,  #  QAK.5
    ):
        """
         - `PRR_PC5 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PRR_PC5>`_
        ...
        :param patient: Patient segment group: [PID, PATIENT VISIT|None, PROBLEM] (id: PATIENT | seq: 7, None, None | use: R | rpt: *)
        """
        super().__init__()
    ...
    def patient(self) -> tuple[PRR_PC5_PATIENT_GROUP, ...]:
        """
        id: PRR_PC5_PATIENT_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[PRR_PC5_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PRR_PC5_PATIENT_GROUP
        """
        return self._c_data[6]

    @patient.setter  # set PATIENT
    def patient(
        self, patient: PRR_PC5_PATIENT_GROUP | tuple[PRR_PC5_PATIENT_GROUP, ...]
    ):
        """
        id: PATIENT SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: PRR_PC5_PATIENT_GROUP.None | tuple[PRR_PC5_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PRR_PC5_PATIENT_GROUP
        """
