...
"""
Original Mode Display Query Sent for Immediate Response - QRY_Q01
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QRY_Q01 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QRY_Q01
from utils.hl7.v2_5_1.segments import (
    DSC, QRF, SFT, MSH, QRD
)

qry_q01 = QRY_Q01(  #  - This section is retained for backward compatibility and the framework for the existing functional queries
...
-----END TRIGGER_EVENT::QRY_Q01 TEMPLATE-----
"""


class QRY_Q01(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QRY_Q01"""
    _hl7_name = """Original Mode Display Query Sent for Immediate Response"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_Q01"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QRY_Q01 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_Q01>`_
