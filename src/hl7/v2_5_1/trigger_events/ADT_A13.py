...
"""
Cancel Discharge / End Visit - ADT_A13
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A13 TEMPLATE-----
...
adt_a13 = ADT_A13(  #  - The A13 event is sent when an A03 (discharge/end visit) event is cancelled, either because of erroneous entry of the A03 event or because of a decision not to discharge or end the visit of the patient after all
    ...
    procedure=None,  # ADT_A13_PROCEDURE_GROUP(...) 
    guarantor=None,  # GT1(...) 
    insurance=None,  # ADT_A13_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    ub82_data=None,  # UB1(...) 
    ub92_data=None,  # UB2(...) 
...
-----END TRIGGER_EVENT::ADT_A13 TEMPLATE-----
"""


class ADT_A13(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A13"""
    _hl7_name = """Cancel Discharge / End Visit"""
    _hl7_description = """The A13 event is sent when an A03 (discharge/end visit) event is cancelled, either because of erroneous entry of the A03 event or because of a decision not to discharge or end the visit of the patient after all"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A13"""
    ...
    _c_components = (MSH, SFT, EVN, PID, PD1, ROL, NK1, PV1, PV2, ROL, DB1, OBX, AL1, DG1, DRG, ADT_A13_PROCEDURE_GROUP, GT1, ADT_A13_INSURANCE_GROUP, ACC, UB1, UB2, PDA)
    ...
    def __init__(
        ...
        procedure: ADT_A13_PROCEDURE_GROUP
        | tuple[ADT_A13_PROCEDURE_GROUP, ...]
        | None = None,  #  (PR1.16, ROL.17, ...)
        guarantor: GT1 | tuple[GT1, ...] | None = None,  #  GT1.18
        insurance: ADT_A13_INSURANCE_GROUP
        | tuple[ADT_A13_INSURANCE_GROUP, ...]
        ...
        """
                 - `ADT_A13 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A13>`_
    ...
    def procedure(self) -> tuple[ADT_A13_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A13_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A13_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A13_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: ADT_A13_PROCEDURE_GROUP | tuple[ADT_A13_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A13_PROCEDURE_GROUP.None | tuple[ADT_A13_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A13_PROCEDURE_GROUP
        """
    ...
    def insurance(self) -> tuple[ADT_A13_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A13_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A13_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A13_INSURANCE_GROUP
        """
    ...
    def insurance(
        self,
        insurance: ADT_A13_INSURANCE_GROUP | tuple[ADT_A13_INSURANCE_GROUP, ...] | None,
    ):
        """
        id: INSURANCE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A13_INSURANCE_GROUP.None | tuple[ADT_A13_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A13_INSURANCE_GROUP
        """
