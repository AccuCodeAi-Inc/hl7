...
from ..segment_groups.RRE_O12_RESPONSE_GROUP import RRE_O12_RESPONSE_GROUP
from ..segments.MSA import MSA


"""
Pharmacy/Treatment Encoded Order Acknowledgement - RRE_O12
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RRE_O12 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RRE_O12
from utils.hl7.v2_5_1.segments import (
    ERR, MSA, NTE, MSH, SFT
)
from utils.hl7.v2_5_1.segment_groups import (
    RRE_O12_RESPONSE_GROUP
)
...
rre_o12 = RRE_O12(  #  - 
    ...
    response=None,  # RRE_O12_RESPONSE_GROUP(...) 
)

-----END TRIGGER_EVENT::RRE_O12 TEMPLATE-----
"""


class RRE_O12(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RRE_O12"""
    _hl7_name = """Pharmacy/Treatment Encoded Order Acknowledgement"""
    _hl7_description = """"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRE_O12"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 1)
    _c_usage = ("R", "R", "O", "O", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "None")
    _c_components = (MSH, MSA, ERR, SFT, NTE, RRE_O12_RESPONSE_GROUP)
    ...
    def __init__(
        ...
        response: RRE_O12_RESPONSE_GROUP | None = None,  #
    ):
        """
         - `RRE_O12 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRE_O12>`_
    ...
    @property  # get RRE_O12_RESPONSE_GROUP.None
    def response(self) -> RRE_O12_RESPONSE_GROUP | None:
        """
        id: RRE_O12_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RRE_O12_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRE_O12_RESPONSE_GROUP
        """
        return self._c_data[5][0]

    @response.setter  # set RRE_O12_RESPONSE_GROUP.None
    def response(self, response: RRE_O12_RESPONSE_GROUP | None):
        """
        id: RRE_O12_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RRE_O12_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRE_O12_RESPONSE_GROUP
        """
