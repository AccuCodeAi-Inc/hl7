...
"""
Merge Patient - Patient Identifier List - ADT_A40
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A40 TEMPLATE-----
...
adt_a40 = ADT_A40(  #  - A merge has been done at the patient identifier list level
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    event_type=evn,  # EVN(...)  # Required.
    patient_id=adt_a40_patient_id_group,  # ADT_A40_PATIENT_ID_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::ADT_A40 TEMPLATE-----
"""


class ADT_A40(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A40"""
    _hl7_name = """Merge Patient - Patient Identifier List"""
    _hl7_description = """A merge has been done at the patient identifier list level"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A40"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 65535)
    _c_usage = ("R", "O", "R", "R")
    _c_aliases = ("1", "2", "3", "None")
    _c_components = (MSH, SFT, EVN, ADT_A40_PATIENT_ID_GROUP)
    ...
    def __init__(
        ...
        patient_id: ADT_A40_PATIENT_ID_GROUP
        | tuple[
            ADT_A40_PATIENT_ID_GROUP, ...
        ...
        """
                 - `ADT_A40 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A40>`_
    ...
    def patient_id(self) -> tuple[ADT_A40_PATIENT_ID_GROUP, ...]:
        """
        id: ADT_A40_PATIENT_ID_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A40_PATIENT_ID_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A40_PATIENT_ID_GROUP
        """
    ...
    def patient_id(
        self,
        patient_id: ADT_A40_PATIENT_ID_GROUP | tuple[ADT_A40_PATIENT_ID_GROUP, ...],
    ):
        """
        id: PATIENT ID SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: ADT_A40_PATIENT_ID_GROUP.None | tuple[ADT_A40_PATIENT_ID_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A40_PATIENT_ID_GROUP
        """
