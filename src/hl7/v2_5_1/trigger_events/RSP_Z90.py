...
from ..segment_groups.RSP_Z90_QUERY_RESPONSE_GROUP import RSP_Z90_QUERY_RESPONSE_GROUP
from ..segments.DSC import DSC
from ..segments.SFT import SFT


"""
Lab Results History Response - RSP_Z90
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RSP_Z90 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RSP_Z90
from utils.hl7.v2_5_1.segments import (
    QAK, SFT, RCP, ERR, MSA, QPD, MSH, DSC
)
from utils.hl7.v2_5_1.segment_groups import (
    RSP_Z90_QUERY_RESPONSE_GROUP
)

rsp_z90 = RSP_Z90(  #  - The purpose of this query/response pair is to retrieve patient laboratory results information from the Server
    ...
    query_response=rsp_z90_query_response_group,  # RSP_Z90_QUERY_RESPONSE_GROUP(...)  # Required.
    continuation_pointer=dsc,  # DSC(...)  # Required.
)

-----END TRIGGER_EVENT::RSP_Z90 TEMPLATE-----
"""


class RSP_Z90(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RSP_Z90"""
    _hl7_name = """Lab Results History Response"""
    _hl7_description = """The purpose of this query/response pair is to retrieve patient laboratory results information from the Server"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z90"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 1, 65535, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "R", "R", "R")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "7", "None", "24")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RCP, RSP_Z90_QUERY_RESPONSE_GROUP, DSC)
    ...
    def __init__(
        ...
        query_response: RSP_Z90_QUERY_RESPONSE_GROUP
        | tuple[RSP_Z90_QUERY_RESPONSE_GROUP, ...],  #  Required. (, ...)
        continuation_pointer: DSC,  #  Required. DSC.24
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        error: ERR | None = None,  #  ERR.4
    ):
        """
         - `RSP_Z90 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z90>`_
        ...
        :param query_response: Query Response segment group: [PATIENT|None, COMMON ORDER, SPECIMEN|None] (id: QUERY RESPONSE | seq: None, None, None | use: R | rpt: *)
        :param continuation_pointer: Continuation Pointer (id: DSC | seq: 24 | use: R | rpt: 1)
        """
        super().__init__()
    ...
    def query_response(self) -> tuple[RSP_Z90_QUERY_RESPONSE_GROUP, ...]:
        """
        id: RSP_Z90_QUERY_RESPONSE_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RSP_Z90_QUERY_RESPONSE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_Z90_QUERY_RESPONSE_GROUP
        """
    ...
    def query_response(
        self,
        query_response: RSP_Z90_QUERY_RESPONSE_GROUP
        | tuple[RSP_Z90_QUERY_RESPONSE_GROUP, ...],
    ):
        """
        id: QUERY RESPONSE SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RSP_Z90_QUERY_RESPONSE_GROUP.None | tuple[RSP_Z90_QUERY_RESPONSE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_Z90_QUERY_RESPONSE_GROUP
        """
    ...
    def continuation_pointer(self) -> DSC:
        """
        id: DSC | use: R | rpt: 1 | seq: 24
        ---
        return_type: DSC.24: Continuation Pointer
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/DSC
        """
        return self._c_data[8][0]

    @continuation_pointer.setter  # set DSC.24
    def continuation_pointer(self, dsc: DSC):
        """
        id: DSC | use: R | rpt: 1 | seq: 24
        ---
        param_type: DSC.24: Continuation Pointer
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/DSC
        """
        self._c_data[8] = (dsc,)
