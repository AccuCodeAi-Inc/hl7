...
from ..segment_groups.SIU_S16_RESOURCES_GROUP import SIU_S16_RESOURCES_GROUP
from ..segments.TQ1 import TQ1
from ..segment_groups.SIU_S16_PATIENT_GROUP import SIU_S16_PATIENT_GROUP
from ..segments.NTE import NTE
from ..segments.SCH import SCH


"""
Notification of Appointment Discontinuation - SIU_S16
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::SIU_S16 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SIU_S16
from utils.hl7.v2_5_1.segments import (
    TQ1, NTE, MSH, SCH
)
from utils.hl7.v2_5_1.segment_groups import (
    SIU_S16_RESOURCES_GROUP, SIU_S16_PATIENT_GROUP
)

siu_s16 = SIU_S16(  #  - A notification of appointment discontinuation is sent by the filler application to notify other applications that an appointment in progress has been stopped, or that the remaining occurrences of a parent appointment will not occur
    message_header=msh,  # MSH(...)  # Required.
    scheduling_activity_information=sch,  # SCH(...)  # Required.
    timing_or_quantity=None,  # TQ1(...) 
    notes_and_comments=None,  # NTE(...) 
    patient=None,  # SIU_S16_PATIENT_GROUP(...) 
    resources=siu_s16_resources_group,  # SIU_S16_RESOURCES_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::SIU_S16 TEMPLATE-----
"""


class SIU_S16(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """SIU_S16"""
    _hl7_name = """Notification of Appointment Discontinuation"""
    _hl7_description = """A notification of appointment discontinuation is sent by the filler application to notify other applications that an appointment in progress has been stopped, or that the remaining occurrences of a parent appointment will not occur"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SIU_S16"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 65535)
    _c_usage = ("R", "R", "O", "O", "O", "R")
    _c_aliases = ("1", "2", "3", "4", "None", "None")
    _c_components = (MSH, SCH, TQ1, NTE, SIU_S16_PATIENT_GROUP, SIU_S16_RESOURCES_GROUP)
    ...
    def __init__(
        ...
        | tuple[SIU_S16_RESOURCES_GROUP, ...],  #  Required. (RGS.11, ...)
        timing_or_quantity: TQ1 | tuple[TQ1, ...] | None = None,  #  TQ1.3
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.4
        patient: SIU_S16_PATIENT_GROUP
        | tuple[SIU_S16_PATIENT_GROUP, ...]
        | None = None,  #  (PID.5, PD1.6, PV1.7, PV2.8, OBX.9, DG1.10, ...)
    ):
        """
         - `SIU_S16 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SIU_S16>`_
    ...
    def patient(self) -> tuple[SIU_S16_PATIENT_GROUP, ...] | tuple[None]:
        """
        id: SIU_S16_PATIENT_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[SIU_S16_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S16_PATIENT_GROUP
        """
        return self._c_data[4]

    @patient.setter  # set PATIENT
    def patient(
        self, patient: SIU_S16_PATIENT_GROUP | tuple[SIU_S16_PATIENT_GROUP, ...] | None
    ):
        """
        id: PATIENT SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: SIU_S16_PATIENT_GROUP.None | tuple[SIU_S16_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S16_PATIENT_GROUP
        """
    ...
    def resources(self) -> tuple[SIU_S16_RESOURCES_GROUP, ...]:
        """
        id: SIU_S16_RESOURCES_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[SIU_S16_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S16_RESOURCES_GROUP
        """
        return self._c_data[5]

    @resources.setter  # set RESOURCES
    def resources(
        self, resources: SIU_S16_RESOURCES_GROUP | tuple[SIU_S16_RESOURCES_GROUP, ...]
    ):
        """
        id: RESOURCES SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: SIU_S16_RESOURCES_GROUP.None | tuple[SIU_S16_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S16_RESOURCES_GROUP
        """
