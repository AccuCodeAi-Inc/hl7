...
"""
Cancel Patient Arriving - Tracking - ADT_A32
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A32 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A32
from utils.hl7.v2_5_1.segments import (
    PV1, PD1, DB1, MSH, SFT, PID, EVN, OBX, PV2
)

adt_a32 = ADT_A32(  #  - The A32 event is sent when an A10 (patient arriving-tracking) event is cancelled, either because of erroneous entry of the A10 event or because of a decision not to receive the patient after all
...
-----END TRIGGER_EVENT::ADT_A32 TEMPLATE-----
"""


class ADT_A32(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A32"""
    _hl7_name = """Cancel Patient Arriving - Tracking"""
    _hl7_description = """The A32 event is sent when an A10 (patient arriving-tracking) event is cancelled, either because of erroneous entry of the A10 event or because of a decision not to receive the patient after all"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A32"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A32 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A32>`_
