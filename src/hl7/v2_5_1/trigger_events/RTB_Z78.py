...
"""
Query By Example - Tabular Patient List Response - RTB_Z78
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RTB_Z78 TEMPLATE-----
...
rtb_z78 = RTB_Z78(  #  - The purpose of this query/response pair is to find patient records that closely (as specified by the Client) match a set of input criteria using a specified algorithm
    ...
    row_definition=None,  # RTB_Z78_ROW_DEFINITION_GROUP(...) 
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RTB_Z78 TEMPLATE-----
"""


class RTB_Z78(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RTB_Z78"""
    _hl7_name = """Query By Example - Tabular Patient List Response"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_Z78"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 1, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "9")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RTB_Z78_ROW_DEFINITION_GROUP, DSC)
    ...
    def __init__(
        ...
        row_definition: RTB_Z78_ROW_DEFINITION_GROUP | None = None,  #  RDF.7, RDT.8
        continuation_pointer: DSC | None = None,  #  DSC.9
    ):
        """
         - `RTB_Z78 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_Z78>`_
    ...
    @property  # get RTB_Z78_ROW_DEFINITION_GROUP.None
    def row_definition(self) -> RTB_Z78_ROW_DEFINITION_GROUP | None:
        """
        id: RTB_Z78_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RTB_Z78_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RTB_Z78_ROW_DEFINITION_GROUP
        """
        return self._c_data[6][0]

    @row_definition.setter  # set RTB_Z78_ROW_DEFINITION_GROUP.None
    def row_definition(self, row_definition: RTB_Z78_ROW_DEFINITION_GROUP | None):
        """
        id: RTB_Z78_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RTB_Z78_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RTB_Z78_ROW_DEFINITION_GROUP
        """
