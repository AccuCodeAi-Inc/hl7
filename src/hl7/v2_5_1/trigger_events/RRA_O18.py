...
from ..segment_groups.RRA_O18_RESPONSE_GROUP import RRA_O18_RESPONSE_GROUP


"""
Pharmacy/Treatment Administration Acknowledgement - RRA_O18
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RRA_O18 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RRA_O18
from utils.hl7.v2_5_1.segments import (
    MSH, SFT, ERR, NTE, MSA
)
from utils.hl7.v2_5_1.segment_groups import (
    RRA_O18_RESPONSE_GROUP
)
...
rra_o18 = RRA_O18(  #  - 
    ...
    response=None,  # RRA_O18_RESPONSE_GROUP(...) 
)

-----END TRIGGER_EVENT::RRA_O18 TEMPLATE-----
"""


class RRA_O18(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RRA_O18"""
    _hl7_name = """Pharmacy/Treatment Administration Acknowledgement"""
    _hl7_description = """"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRA_O18"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 1)
    _c_usage = ("R", "R", "O", "O", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "None")
    _c_components = (MSH, MSA, ERR, SFT, NTE, RRA_O18_RESPONSE_GROUP)
    ...
    def __init__(
        ...
        response: RRA_O18_RESPONSE_GROUP | None = None,  #
    ):
        """
         - `RRA_O18 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRA_O18>`_
    ...
    @property  # get RRA_O18_RESPONSE_GROUP.None
    def response(self) -> RRA_O18_RESPONSE_GROUP | None:
        """
        id: RRA_O18_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RRA_O18_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRA_O18_RESPONSE_GROUP
        """
        return self._c_data[5][0]

    @response.setter  # set RRA_O18_RESPONSE_GROUP.None
    def response(self, response: RRA_O18_RESPONSE_GROUP | None):
        """
        id: RRA_O18_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RRA_O18_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRA_O18_RESPONSE_GROUP
        """
