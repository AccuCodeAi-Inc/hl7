...
from ..segment_groups.RSP_K23_QUERY_RESPONSE_GROUP import RSP_K23_QUERY_RESPONSE_GROUP
from ..segments.MSA import MSA
from ..segments.QPD import QPD


"""
Get Corresponding Identifiers Response - RSP_K23
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RSP_K23 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RSP_K23
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, SFT, ERR, DSC, QAK, MSA
)
from utils.hl7.v2_5_1.segment_groups import (
    RSP_K23_QUERY_RESPONSE_GROUP
)

rsp_k23 = RSP_K23(  #  - This query/response is designed for interaction between a client system and an MPI (Master Person Index)
    ...
    query_response=None,  # RSP_K23_QUERY_RESPONSE_GROUP(...) 
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RSP_K23 TEMPLATE-----
"""


class RSP_K23(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RSP_K23"""
    _hl7_name = """Get Corresponding Identifiers Response"""
    _hl7_description = """This query/response is designed for interaction between a client system and an MPI (Master Person Index)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_K23"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 1, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "8")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RSP_K23_QUERY_RESPONSE_GROUP, DSC)
    ...
    def __init__(
        ...
        query_response: RSP_K23_QUERY_RESPONSE_GROUP | None = None,  #  PID.7
        continuation_pointer: DSC | None = None,  #  DSC.8
    ):
        """
         - `RSP_K23 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_K23>`_
    ...
    @property  # get RSP_K23_QUERY_RESPONSE_GROUP.None
    def query_response(self) -> RSP_K23_QUERY_RESPONSE_GROUP | None:
        """
        id: RSP_K23_QUERY_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RSP_K23_QUERY_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_K23_QUERY_RESPONSE_GROUP
        """
        return self._c_data[6][0]

    @query_response.setter  # set RSP_K23_QUERY_RESPONSE_GROUP.None
    def query_response(self, query_response: RSP_K23_QUERY_RESPONSE_GROUP | None):
        """
        id: RSP_K23_QUERY_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RSP_K23_QUERY_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_K23_QUERY_RESPONSE_GROUP
        """
