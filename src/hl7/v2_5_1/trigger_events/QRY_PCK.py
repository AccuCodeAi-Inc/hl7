...
"""
Patient pathway (goal-oriented) query - QRY_PCK
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QRY_PCK TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QRY_PCK
from utils.hl7.v2_5_1.segments import (
    SFT, QRF, QRD, MSH
)

qry_pck = QRY_PCK(  #  - The following trigger/message event is served by QRY (a query from another system)
...
-----END TRIGGER_EVENT::QRY_PCK TEMPLATE-----
"""


class QRY_PCK(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QRY_PCK"""
    _hl7_name = """Patient pathway (goal-oriented) query"""
    _hl7_description = """The following trigger/message event is served by QRY (a query from another system)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_PCK"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1)
    _c_usage = ("R", "O", "R", "O")
    _c_aliases = ("1", "2", "3", "4")
    ...
    def __init__(
        ...
        """
         - `QRY_PCK <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_PCK>`_
