...
"""
Query sent for deferred response - QRY_Q02
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QRY_Q02 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QRY_Q02
from utils.hl7.v2_5_1.segments import (
    MSH, QRD, SFT, QRF, DSC
)

qry_q02 = QRY_Q02(  #  - This section is retained for backward compatibility and the framework for the existing functional queries
...
-----END TRIGGER_EVENT::QRY_Q02 TEMPLATE-----
"""


class QRY_Q02(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QRY_Q02"""
    _hl7_name = """Query sent for deferred response"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_Q02"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QRY_Q02 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_Q02>`_
