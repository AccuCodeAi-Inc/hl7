...
"""
Patient Returns from a Leave of Absence - ADT_A22
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A22 TEMPLATE-----
...
-----END TRIGGER_EVENT::ADT_A22 TEMPLATE-----
"""


class ADT_A22(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A22"""
    _hl7_name = """Patient Returns from a Leave of Absence"""
    _hl7_description = """An A22 event is sent to notify systems that an admitted patient has returned to the healthcare institution after a temporary “leave of absence"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A22"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A22 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A22>`_
