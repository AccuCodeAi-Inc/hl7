...
"""
Cancel Change Attending Doctor - ADT_A55
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A55 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A55
from utils.hl7.v2_5_1.segments import (
    PV1, PD1, MSH, SFT, PID, EVN, PV2
)

adt_a55 = ADT_A55(  #  - The A55 event is sent when an A54 (change attending doctor) event is cancelled, either because of erroneous entry of the A54 event or because of a decision not to change the attending doctor after all
...
-----END TRIGGER_EVENT::ADT_A55 TEMPLATE-----
"""


class ADT_A55(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A55"""
    _hl7_name = """Cancel Change Attending Doctor"""
    _hl7_description = """The A55 event is sent when an A54 (change attending doctor) event is cancelled, either because of erroneous entry of the A54 event or because of a decision not to change the attending doctor after all"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A55"""
    ...
    def __init__(
        ...
        """
         - `ADT_A55 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A55>`_
