...
from ..segment_groups.ADT_A04_INSURANCE_GROUP import ADT_A04_INSURANCE_GROUP
...
from ..segment_groups.ADT_A04_PROCEDURE_GROUP import ADT_A04_PROCEDURE_GROUP
...
-----BEGIN TRIGGER_EVENT::ADT_A04 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A04
from utils.hl7.v2_5_1.segments import (
    PV1, EVN, DG1, ROL, PID, NK1, MSH, PV2, AL1, UB1, DB1, PD1, OBX, DRG, UB2, SFT, ACC, GT1, PDA
)
from utils.hl7.v2_5_1.segment_groups import (
    ADT_A04_PROCEDURE_GROUP, ADT_A04_INSURANCE_GROUP
)

adt_a04 = ADT_A04(  #  - An A04 event signals that the patient has arrived or checked in as a one-time, or recurring outpatient, and is not assigned to a bed
    ...
    procedure=None,  # ADT_A04_PROCEDURE_GROUP(...) 
    guarantor=None,  # GT1(...) 
    insurance=None,  # ADT_A04_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    ub82_data=None,  # UB1(...) 
    ub92_data=None,  # UB2(...) 
...
-----END TRIGGER_EVENT::ADT_A04 TEMPLATE-----
"""


class ADT_A04(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A04"""
    _hl7_name = """Register a Patient"""
    _hl7_description = """An A04 event signals that the patient has arrived or checked in as a one-time, or recurring outpatient, and is not assigned to a bed"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A04"""
    ...
    _c_components = (MSH, SFT, EVN, PID, PD1, ROL, NK1, PV1, PV2, ROL, DB1, OBX, AL1, DG1, DRG, ADT_A04_PROCEDURE_GROUP, GT1, ADT_A04_INSURANCE_GROUP, ACC, UB1, UB2, PDA)
    ...
    def __init__(
        ...
        | tuple[ADT_A04_PROCEDURE_GROUP, ...]
        | None = None,  #  (PR1.16, ROL.17, ...)
        guarantor: GT1 | tuple[GT1, ...] | None = None,  #  GT1.18
        insurance: ADT_A04_INSURANCE_GROUP
        | tuple[ADT_A04_INSURANCE_GROUP, ...]
        ...
        """
         - `ADT_A04 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A04>`_
    ...
    def procedure(self) -> tuple[ADT_A04_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A04_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A04_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A04_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: ADT_A04_PROCEDURE_GROUP | tuple[ADT_A04_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A04_PROCEDURE_GROUP.None | tuple[ADT_A04_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A04_PROCEDURE_GROUP
        """
    ...
    def insurance(self) -> tuple[ADT_A04_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A04_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A04_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A04_INSURANCE_GROUP
        """
    ...
    def insurance(
        self,
        insurance: ADT_A04_INSURANCE_GROUP | tuple[ADT_A04_INSURANCE_GROUP, ...] | None,
    ):
        """
        id: INSURANCE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A04_INSURANCE_GROUP.None | tuple[ADT_A04_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A04_INSURANCE_GROUP
        """
