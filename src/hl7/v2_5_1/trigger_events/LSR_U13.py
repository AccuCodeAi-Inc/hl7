...
"""
Automated Equipment Log/Service Request - LSR_U13
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::LSR_U13 TEMPLATE-----
...
-----END TRIGGER_EVENT::LSR_U13 TEMPLATE-----
"""


class LSR_U13(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """LSR_U13"""
    _hl7_name = """Automated Equipment Log/Service Request"""
    _hl7_description = """This message is used to request log and/or service events from one application to another (e"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/LSR_U13"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `LSR_U13 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/LSR_U13>`_
