...
from ..segment_groups.RSP_Z86_QUERY_RESPONSE_GROUP import RSP_Z86_QUERY_RESPONSE_GROUP
from ..segments.QAK import QAK


"""
Pharmacy Information Comprehensive Response - RSP_Z86
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RSP_Z86 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RSP_Z86
from utils.hl7.v2_5_1.segments import (
    ERR, DSC, QPD, MSA, SFT, MSH, QAK
)
from utils.hl7.v2_5_1.segment_groups import (
    RSP_Z86_QUERY_RESPONSE_GROUP
)

rsp_z86 = RSP_Z86(  #  - The purpose of this query/response is to retrieve patient pharmacy history information from the Server
    ...
    query_response=rsp_z86_query_response_group,  # RSP_Z86_QUERY_RESPONSE_GROUP(...)  # Required.
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RSP_Z86 TEMPLATE-----
"""


class RSP_Z86(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RSP_Z86"""
    _hl7_name = """Pharmacy Information Comprehensive Response"""
    _hl7_description = """The purpose of this query/response is to retrieve patient pharmacy history information from the Server"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z86"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 65535, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "R", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "33")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RSP_Z86_QUERY_RESPONSE_GROUP, DSC)
    ...
    def __init__(
        ...
        query_response: RSP_Z86_QUERY_RESPONSE_GROUP
        | tuple[RSP_Z86_QUERY_RESPONSE_GROUP, ...],  #  Required. (, ...)
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        error: ERR | None = None,  #  ERR.4
        continuation_pointer: DSC | None = None,  #  DSC.33
    ):
        """
         - `RSP_Z86 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z86>`_
        ...
        :param continuation_pointer: Continuation Pointer (id: DSC | seq: 33 | use: O | rpt: 1)
        """
        super().__init__()
    ...
    def query_response(self) -> tuple[RSP_Z86_QUERY_RESPONSE_GROUP, ...]:
        """
        id: RSP_Z86_QUERY_RESPONSE_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RSP_Z86_QUERY_RESPONSE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_Z86_QUERY_RESPONSE_GROUP
        """
    ...
    def query_response(
        self,
        query_response: RSP_Z86_QUERY_RESPONSE_GROUP
        | tuple[RSP_Z86_QUERY_RESPONSE_GROUP, ...],
    ):
        """
        id: QUERY RESPONSE SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RSP_Z86_QUERY_RESPONSE_GROUP.None | tuple[RSP_Z86_QUERY_RESPONSE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_Z86_QUERY_RESPONSE_GROUP
        """
    ...
    def continuation_pointer(self) -> DSC | None:
        """
        id: DSC | use: O | rpt: 1 | seq: 33
        ---
        return_type: DSC.33: Continuation Pointer
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/DSC
        """
        return self._c_data[7][0]

    @continuation_pointer.setter  # set DSC.33
    def continuation_pointer(self, dsc: DSC | None):
        """
        id: DSC | use: O | rpt: 1 | seq: 33
        ---
        param_type: DSC.33: Continuation Pointer
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/DSC
        """
        self._c_data[7] = (dsc,)
