...
from ..segment_groups.RSP_Z84_ROW_DEFINITION_GROUP import RSP_Z84_ROW_DEFINITION_GROUP
...
"""
Tabular Response - Who Am I - RSP_Z84
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RSP_Z84 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RSP_Z84
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, SFT, ERR, DSC, QAK, MSA
)
from utils.hl7.v2_5_1.segment_groups import (
    RSP_Z84_ROW_DEFINITION_GROUP
)

rsp_z84 = RSP_Z84(  #  - The purpose of this query/response is to find the identity of the patient for specified medical record number(s)
    ...
    row_definition=None,  # RSP_Z84_ROW_DEFINITION_GROUP(...) 
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RSP_Z84 TEMPLATE-----
"""


class RSP_Z84(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RSP_Z84"""
    _hl7_name = """Tabular Response - Who Am I"""
    _hl7_description = """The purpose of this query/response is to find the identity of the patient for specified medical record number(s)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z84"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 1, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "9")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RSP_Z84_ROW_DEFINITION_GROUP, DSC)
    ...
    def __init__(
        ...
        row_definition: RSP_Z84_ROW_DEFINITION_GROUP | None = None,  #  RDF.7, RDT.8
        continuation_pointer: DSC | None = None,  #  DSC.9
    ):
        """
         - `RSP_Z84 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z84>`_
    ...
    @property  # get RSP_Z84_ROW_DEFINITION_GROUP.None
    def row_definition(self) -> RSP_Z84_ROW_DEFINITION_GROUP | None:
        """
        id: RSP_Z84_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RSP_Z84_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_Z84_ROW_DEFINITION_GROUP
        """
        return self._c_data[6][0]

    @row_definition.setter  # set RSP_Z84_ROW_DEFINITION_GROUP.None
    def row_definition(self, row_definition: RSP_Z84_ROW_DEFINITION_GROUP | None):
        """
        id: RSP_Z84_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RSP_Z84_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_Z84_ROW_DEFINITION_GROUP
        """
