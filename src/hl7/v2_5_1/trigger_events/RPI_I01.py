...
"""
Request for insurance information acknowledgement - RPI_I01
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RPI_I01 TEMPLATE-----
...
rpi_i01 = RPI_I01(  #  - This event triggers a message to be sent from one healthcare provider to another to request insurance information for a specified patient
    ...
    provider=rpi_i01_provider_group,  # RPI_I01_PROVIDER_GROUP(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    next_of_kin_or_associated_parties=None,  # NK1(...) 
    guarantor_insurance=None,  # RPI_I01_GUARANTOR_INSURANCE_GROUP(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT::RPI_I01 TEMPLATE-----
"""


class RPI_I01(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RPI_I01"""
    _hl7_name = """Request for insurance information acknowledgement"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RPI_I01"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 65535, 1, 65535, 1, 65535)
    _c_usage = ("R", "O", "R", "R", "R", "O", "O", "O")
    _c_aliases = ("1", "2", "3", "None", "6", "7", "None", "12")
    _c_components = (MSH, SFT, MSA, RPI_I01_PROVIDER_GROUP, PID, NK1, RPI_I01_GUARANTOR_INSURANCE_GROUP, NTE)
    ...
    def __init__(
        ...
        provider: RPI_I01_PROVIDER_GROUP
        | tuple[RPI_I01_PROVIDER_GROUP, ...],  #  Required. (PRD.4, CTD.5, ...)
        patient_identification: PID,  #  Required. PID.6
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        next_of_kin_or_associated_parties: NK1
        | tuple[NK1, ...]
        | None = None,  #  NK1.7
        guarantor_insurance: RPI_I01_GUARANTOR_INSURANCE_GROUP | None = None,  #  GT1.8
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.12
    ):
        """
         - `RPI_I01 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RPI_I01>`_
    ...
    def provider(self) -> tuple[RPI_I01_PROVIDER_GROUP, ...]:
        """
        id: RPI_I01_PROVIDER_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RPI_I01_PROVIDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPI_I01_PROVIDER_GROUP
        """
        return self._c_data[3]

    @provider.setter  # set PROVIDER
    def provider(
        self, provider: RPI_I01_PROVIDER_GROUP | tuple[RPI_I01_PROVIDER_GROUP, ...]
    ):
        """
        id: PROVIDER SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RPI_I01_PROVIDER_GROUP.None | tuple[RPI_I01_PROVIDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPI_I01_PROVIDER_GROUP
        """
    ...
    @property  # get RPI_I01_GUARANTOR_INSURANCE_GROUP.None
    def guarantor_insurance(self) -> RPI_I01_GUARANTOR_INSURANCE_GROUP | None:
        """
        id: RPI_I01_GUARANTOR_INSURANCE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RPI_I01_GUARANTOR_INSURANCE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPI_I01_GUARANTOR_INSURANCE_GROUP
        """
        return self._c_data[6][0]

    @guarantor_insurance.setter  # set RPI_I01_GUARANTOR_INSURANCE_GROUP.None
    def guarantor_insurance(
        self, guarantor_insurance: RPI_I01_GUARANTOR_INSURANCE_GROUP | None
    ):
        """
        id: RPI_I01_GUARANTOR_INSURANCE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RPI_I01_GUARANTOR_INSURANCE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPI_I01_GUARANTOR_INSURANCE_GROUP
        """
