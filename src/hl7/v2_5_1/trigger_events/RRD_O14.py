...
from ..segment_groups.RRD_O14_RESPONSE_GROUP import RRD_O14_RESPONSE_GROUP
...
"""
Pharmacy/Treatment Dispense Acknowledgement - RRD_O14
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RRD_O14 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RRD_O14
from utils.hl7.v2_5_1.segments import (
    NTE, SFT, ERR, MSA, MSH
)
from utils.hl7.v2_5_1.segment_groups import (
    RRD_O14_RESPONSE_GROUP
)
...
rrd_o14 = RRD_O14(  #  - 
    ...
    response=None,  # RRD_O14_RESPONSE_GROUP(...) 
)

-----END TRIGGER_EVENT::RRD_O14 TEMPLATE-----
"""


class RRD_O14(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RRD_O14"""
    _hl7_name = """Pharmacy/Treatment Dispense Acknowledgement"""
    _hl7_description = """"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRD_O14"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 1)
    _c_usage = ("R", "R", "O", "O", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "None")
    _c_components = (MSH, MSA, ERR, SFT, NTE, RRD_O14_RESPONSE_GROUP)
    ...
    def __init__(
        ...
        response: RRD_O14_RESPONSE_GROUP | None = None,  #
    ):
        """
         - `RRD_O14 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRD_O14>`_
    ...
    @property  # get RRD_O14_RESPONSE_GROUP.None
    def response(self) -> RRD_O14_RESPONSE_GROUP | None:
        """
        id: RRD_O14_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RRD_O14_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRD_O14_RESPONSE_GROUP
        """
        return self._c_data[5][0]

    @response.setter  # set RRD_O14_RESPONSE_GROUP.None
    def response(self, response: RRD_O14_RESPONSE_GROUP | None):
        """
        id: RRD_O14_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RRD_O14_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRD_O14_RESPONSE_GROUP
        """
