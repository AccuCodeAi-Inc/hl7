...
"""
Cancel Pending Admit - ADT_A27
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A27 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A27
from utils.hl7.v2_5_1.segments import (
    PV1, PD1, DB1, MSH, SFT, PID, EVN, OBX, PV2
)

adt_a27 = ADT_A27(  #  - The A27 event is sent when an A14 (pending admit) event is canceled, either because of erroneous entry of the A14 event or because of a decision not to admit the patient after all
...
-----END TRIGGER_EVENT::ADT_A27 TEMPLATE-----
"""


class ADT_A27(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A27"""
    _hl7_name = """Cancel Pending Admit"""
    _hl7_description = """The A27 event is sent when an A14 (pending admit) event is canceled, either because of erroneous entry of the A14 event or because of a decision not to admit the patient after all"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A27"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A27 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A27>`_
