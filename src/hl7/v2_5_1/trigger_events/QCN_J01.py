...
"""
Cancel Query - QCN_J01
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QCN_J01 TEMPLATE-----
...
-----END TRIGGER_EVENT::QCN_J01 TEMPLATE-----
"""


class QCN_J01(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QCN_J01"""
    _hl7_name = """Cancel Query"""
    _hl7_description = """"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QCN_J01"""
    _c_length = (-1,-1,-1,)
    _c_rpt = (1, 65535, 1)
    _c_usage = ("R", "O", "R")
    _c_aliases = ("1", "2", "3")
    ...
    def __init__(
        ...
        """
         - `QCN_J01 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QCN_J01>`_
