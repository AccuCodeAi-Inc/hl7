...
"""
Original Mode Display Immediate Response - DSR_Q01
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::DSR_Q01 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import DSR_Q01
from utils.hl7.v2_5_1.segments import (
    DSP, ERR, DSC, QRF, MSA, SFT, MSH, QRD, QAK
)

dsr_q01 = DSR_Q01(  #  - This section is retained for backward compatibility and the framework for the existing functional queries
...
-----END TRIGGER_EVENT::DSR_Q01 TEMPLATE-----
"""


class DSR_Q01(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """DSR_Q01"""
    _hl7_name = """Original Mode Display Immediate Response"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/DSR_Q01"""
    ...
    def __init__(
        ...
        """
         - `DSR_Q01 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/DSR_Q01>`_
