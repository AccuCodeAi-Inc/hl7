...
from ..segment_groups.RRI_I12_PROCEDURE_GROUP import RRI_I12_PROCEDURE_GROUP
...
from ..segment_groups.RRI_I12_OBSERVATION_GROUP import RRI_I12_OBSERVATION_GROUP
from ..segment_groups.RRI_I12_PROVIDER_CONTACT_GROUP import (
    RRI_I12_PROVIDER_CONTACT_GROUP,
)
from ..segment_groups.RRI_I12_AUTHORIZATION_CONTACT_GROUP import (
    RRI_I12_AUTHORIZATION_CONTACT_GROUP,
)
from ..segment_groups.RRI_I12_PATIENT_VISIT_GROUP import RRI_I12_PATIENT_VISIT_GROUP
from ..segments.AL1 import AL1


"""
Patient referral acknowledgement - RRI_I12
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RRI_I12 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RRI_I12
from utils.hl7.v2_5_1.segments import (
    RF1, NTE, MSA, SFT, ACC, DG1, PID, AL1, MSH, DRG
)
from utils.hl7.v2_5_1.segment_groups import (
    RRI_I12_PROVIDER_CONTACT_GROUP, RRI_I12_OBSERVATION_GROUP, RRI_I12_AUTHORIZATION_CONTACT_GROUP, RRI_I12_PROCEDURE_GROUP, RRI_I12_PATIENT_VISIT_GROUP
)

rri_i12 = RRI_I12(  #  - This event triggers a message to be sent from one healthcare provider to another regarding a specific patient
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    message_acknowledgment=None,  # MSA(...) 
    referral_information=None,  # RF1(...) 
    authorization_contact=None,  # RRI_I12_AUTHORIZATION_CONTACT_GROUP(...) 
    provider_contact=rri_i12_provider_contact_group,  # RRI_I12_PROVIDER_CONTACT_GROUP(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    accident=None,  # ACC(...) 
    diagnosis=None,  # DG1(...) 
    diagnosis_related_group=None,  # DRG(...) 
    patient_allergy_information=None,  # AL1(...) 
    procedure=None,  # RRI_I12_PROCEDURE_GROUP(...) 
    observation=None,  # RRI_I12_OBSERVATION_GROUP(...) 
    patient_visit=None,  # RRI_I12_PATIENT_VISIT_GROUP(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT::RRI_I12 TEMPLATE-----
"""


class RRI_I12(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RRI_I12"""
    _hl7_name = """Patient referral acknowledgement"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRI_I12"""
    ...
    _c_components = (MSH, SFT, MSA, RF1, RRI_I12_AUTHORIZATION_CONTACT_GROUP, RRI_I12_PROVIDER_CONTACT_GROUP, PID, ACC, DG1, DRG, AL1, RRI_I12_PROCEDURE_GROUP, RRI_I12_OBSERVATION_GROUP, RRI_I12_PATIENT_VISIT_GROUP, NTE)
    ...
    def __init__(
        ...
        provider_contact: RRI_I12_PROVIDER_CONTACT_GROUP
        | tuple[RRI_I12_PROVIDER_CONTACT_GROUP, ...],  #  Required. (PRD.7, CTD.8, ...)
        ...
        authorization_contact: RRI_I12_AUTHORIZATION_CONTACT_GROUP
        ...
        | tuple[RRI_I12_PROCEDURE_GROUP, ...]
        | None = None,  #  (PR1.14, ...)
        observation: RRI_I12_OBSERVATION_GROUP
        | tuple[RRI_I12_OBSERVATION_GROUP, ...]
        | None = None,  #  (OBR.17, NTE.18, ...)
        patient_visit: RRI_I12_PATIENT_VISIT_GROUP | None = None,  #  PV1.21, PV2.22
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.23
    ):
        """
         - `RRI_I12 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRI_I12>`_
    ...
    @property  # get RRI_I12_AUTHORIZATION_CONTACT_GROUP.None
    def authorization_contact(self) -> RRI_I12_AUTHORIZATION_CONTACT_GROUP | None:
        """
        id: RRI_I12_AUTHORIZATION_CONTACT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RRI_I12_AUTHORIZATION_CONTACT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_AUTHORIZATION_CONTACT_GROUP
        """
        return self._c_data[4][0]

    @authorization_contact.setter  # set RRI_I12_AUTHORIZATION_CONTACT_GROUP.None
    def authorization_contact(
        self, authorization_contact: RRI_I12_AUTHORIZATION_CONTACT_GROUP | None
    ):
        """
        id: RRI_I12_AUTHORIZATION_CONTACT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RRI_I12_AUTHORIZATION_CONTACT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_AUTHORIZATION_CONTACT_GROUP
        """
    ...
    def provider_contact(self) -> tuple[RRI_I12_PROVIDER_CONTACT_GROUP, ...]:
        """
        id: RRI_I12_PROVIDER_CONTACT_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RRI_I12_PROVIDER_CONTACT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_PROVIDER_CONTACT_GROUP
        """
    ...
    def provider_contact(
        self,
        provider_contact: RRI_I12_PROVIDER_CONTACT_GROUP
        | tuple[RRI_I12_PROVIDER_CONTACT_GROUP, ...],
    ):
        """
        id: PROVIDER CONTACT SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RRI_I12_PROVIDER_CONTACT_GROUP.None | tuple[RRI_I12_PROVIDER_CONTACT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_PROVIDER_CONTACT_GROUP
        """
    ...
    def procedure(self) -> tuple[RRI_I12_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: RRI_I12_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RRI_I12_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: RRI_I12_PROCEDURE_GROUP | tuple[RRI_I12_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: RRI_I12_PROCEDURE_GROUP.None | tuple[RRI_I12_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_PROCEDURE_GROUP
        """
    ...
    def observation(self) -> tuple[RRI_I12_OBSERVATION_GROUP, ...] | tuple[None]:
        """
        id: RRI_I12_OBSERVATION_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RRI_I12_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_OBSERVATION_GROUP
        """
    ...
    def observation(
        ...
        ---
        param_type: RRI_I12_OBSERVATION_GROUP.None | tuple[RRI_I12_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_OBSERVATION_GROUP
        """
    ...
    @property  # get RRI_I12_PATIENT_VISIT_GROUP.None
    def patient_visit(self) -> RRI_I12_PATIENT_VISIT_GROUP | None:
        """
        id: RRI_I12_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RRI_I12_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_PATIENT_VISIT_GROUP
        """
        return self._c_data[13][0]

    @patient_visit.setter  # set RRI_I12_PATIENT_VISIT_GROUP.None
    def patient_visit(self, patient_v_isit: RRI_I12_PATIENT_VISIT_GROUP | None):
        """
        id: RRI_I12_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RRI_I12_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRI_I12_PATIENT_VISIT_GROUP
        """
