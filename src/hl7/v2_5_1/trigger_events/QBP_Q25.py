...
"""
Query - Personnel information - QBP_Q25
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Q25 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Q25
from utils.hl7.v2_5_1.segments import (
    SFT, RCP, DSC, QPD, MSH
)

qbp_q25 = QBP_Q25(  #  - The following trigger event is served by the following Conformance Statement: Another application determines a need for Personnel data about a person and sends a query to a system providing this information
...
-----END TRIGGER_EVENT::QBP_Q25 TEMPLATE-----
"""


class QBP_Q25(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Q25"""
    _hl7_name = """Query - Personnel information"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q25"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QBP_Q25 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q25>`_
