...
from ..segment_groups.RSP_K22_QUERY_RESPONSE_GROUP import RSP_K22_QUERY_RESPONSE_GROUP
...
"""
Find Candidates Response - RSP_K22
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RSP_K22 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RSP_K22
from utils.hl7.v2_5_1.segments import (
    QAK, SFT, ERR, MSA, QPD, MSH, DSC
)
from utils.hl7.v2_5_1.segment_groups import (
    RSP_K22_QUERY_RESPONSE_GROUP
)

rsp_k22 = RSP_K22(  #  - This query/response is designed for interaction between a client system and an MPI (Master Person Index)
    ...
    query_response=None,  # RSP_K22_QUERY_RESPONSE_GROUP(...) 
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RSP_K22 TEMPLATE-----
"""


class RSP_K22(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RSP_K22"""
    _hl7_name = """Find Candidates Response"""
    _hl7_description = """This query/response is designed for interaction between a client system and an MPI (Master Person Index)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_K22"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 65535, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "11")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RSP_K22_QUERY_RESPONSE_GROUP, DSC)
    ...
    def __init__(
        ...
        query_response: RSP_K22_QUERY_RESPONSE_GROUP
        | tuple[RSP_K22_QUERY_RESPONSE_GROUP, ...]
        | None = None,  #  (PID.7, PD1.8, NK1.9, QRI.10, ...)
        continuation_pointer: DSC | None = None,  #  DSC.11
    ):
        """
                 - `RSP_K22 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_K22>`_
        ...
        Each returned person, specified by a PID segment, can also have an optional QRI - Query Response Instance segment containing information about the quality of the match.
                ...
                :param query_response: Query Response segment group: [PID, PD1|None, NK1|None, QRI|None] (id: QUERY RESPONSE | seq: 7, 8, 9, 10 | use: O | rpt: *)
    ...
    def query_response(self) -> tuple[RSP_K22_QUERY_RESPONSE_GROUP, ...] | tuple[None]:
        """
        id: RSP_K22_QUERY_RESPONSE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RSP_K22_QUERY_RESPONSE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_K22_QUERY_RESPONSE_GROUP
        """
    ...
    def query_response(
        ...
        """
        id: QUERY RESPONSE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: RSP_K22_QUERY_RESPONSE_GROUP.None | tuple[RSP_K22_QUERY_RESPONSE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RSP_K22_QUERY_RESPONSE_GROUP
        """
