...
from ..segment_groups.RTB_K13_ROW_DEFINITION_GROUP import RTB_K13_ROW_DEFINITION_GROUP
...
"""
Tabular Response in Response to QBP_Q13 - RTB_K13
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RTB_K13 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RTB_K13
from utils.hl7.v2_5_1.segments import (
    ERR, DSC, QPD, MSA, SFT, MSH, QAK
)
from utils.hl7.v2_5_1.segment_groups import (
    RTB_K13_ROW_DEFINITION_GROUP
)

rtb_k13 = RTB_K13(  #  - The RTB_K13 supports a Tabular Response to the QBP and contains the MSH, MSA, ERR, QAK, QPD, RDF, RDT and the DSC
    ...
    row_definition=None,  # RTB_K13_ROW_DEFINITION_GROUP(...) 
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RTB_K13 TEMPLATE-----
"""


class RTB_K13(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RTB_K13"""
    _hl7_name = """Tabular Response in Response to QBP_Q13"""
    _hl7_description = """The RTB_K13 supports a Tabular Response to the QBP and contains the MSH, MSA, ERR, QAK, QPD, RDF, RDT and the DSC"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_K13"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 1, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "9")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RTB_K13_ROW_DEFINITION_GROUP, DSC)
    ...
    def __init__(
        ...
        row_definition: RTB_K13_ROW_DEFINITION_GROUP | None = None,  #  RDF.7, RDT.8
        continuation_pointer: DSC | None = None,  #  DSC.9
    ):
        """
                 - `RTB_K13 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_K13>`_
    ...
    @property  # get RTB_K13_ROW_DEFINITION_GROUP.None
    def row_definition(self) -> RTB_K13_ROW_DEFINITION_GROUP | None:
        """
        id: RTB_K13_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RTB_K13_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RTB_K13_ROW_DEFINITION_GROUP
        """
        return self._c_data[6][0]

    @row_definition.setter  # set RTB_K13_ROW_DEFINITION_GROUP.None
    def row_definition(self, row_definition: RTB_K13_ROW_DEFINITION_GROUP | None):
        """
        id: RTB_K13_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RTB_K13_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RTB_K13_ROW_DEFINITION_GROUP
        """
