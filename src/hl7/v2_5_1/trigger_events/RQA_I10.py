...
from utils.hl7.v2_5_1.segment_groups import (
    RQA_I10_PROCEDURE_GROUP, RQA_I10_VISIT_GROUP, RQA_I10_GUARANTOR_INSURANCE_GROUP, RQA_I10_OBSERVATION_GROUP, RQA_I10_PROVIDER_GROUP, RQA_I10_AUTHORIZATION_GROUP
)
