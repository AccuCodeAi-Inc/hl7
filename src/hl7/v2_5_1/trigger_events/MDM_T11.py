...
from ..segment_groups.MDM_T11_COMMON_ORDER_GROUP import MDM_T11_COMMON_ORDER_GROUP
...
"""
Original document notification - MDM_T11
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::MDM_T11 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import MDM_T11
from utils.hl7.v2_5_1.segments import (
    PID, MSH, PV1, SFT, TXA, EVN
)
from utils.hl7.v2_5_1.segment_groups import (
    MDM_T11_COMMON_ORDER_GROUP
)

mdm_t11 = MDM_T11(  #  - This is a notification of a cancellation of a document
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    event_type=evn,  # EVN(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    patient_visit=pv1,  # PV1(...)  # Required.
    common_order=None,  # MDM_T11_COMMON_ORDER_GROUP(...) 
    transcription_document_header=txa,  # TXA(...)  # Required.
)

-----END TRIGGER_EVENT::MDM_T11 TEMPLATE-----
"""


class MDM_T11(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    ...
    _hl7_description = """This is a notification of a cancellation of a document"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T11"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 65535, 1)
    _c_usage = ("R", "O", "R", "R", "R", "O", "R")
    _c_aliases = ("1", "2", "3", "4", "5", "None", "11")
    _c_components = (MSH, SFT, EVN, PID, PV1, MDM_T11_COMMON_ORDER_GROUP, TXA)
    ...
    def __init__(
        ...
        common_order: MDM_T11_COMMON_ORDER_GROUP
        | tuple[MDM_T11_COMMON_ORDER_GROUP, ...]
        | None = None,  #  (ORC.6, OBR.9, NTE.10, ...)
    ):
        """
         - `MDM_T11 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T11>`_
    ...
    def common_order(self) -> tuple[MDM_T11_COMMON_ORDER_GROUP, ...] | tuple[None]:
        """
        id: MDM_T11_COMMON_ORDER_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[MDM_T11_COMMON_ORDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MDM_T11_COMMON_ORDER_GROUP
        """
    ...
    def common_order(
        ...
        ---
        param_type: MDM_T11_COMMON_ORDER_GROUP.None | tuple[MDM_T11_COMMON_ORDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MDM_T11_COMMON_ORDER_GROUP
        """
