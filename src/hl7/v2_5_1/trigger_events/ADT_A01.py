...
from ..segment_groups.ADT_A01_INSURANCE_GROUP import ADT_A01_INSURANCE_GROUP
from ..segments.ROL import ROL
from ..segments.DB1 import DB1
from ..segments.PDA import PDA
from ..segments.PV1 import PV1
from ..segment_groups.ADT_A01_PROCEDURE_GROUP import ADT_A01_PROCEDURE_GROUP
...
"""
Admit/Visit Notification - ADT_A01
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A01 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A01
from utils.hl7.v2_5_1.segments import (
    PV1, EVN, DG1, ROL, PID, NK1, MSH, PV2, AL1, UB1, DB1, PD1, OBX, DRG, UB2, SFT, ACC, GT1, PDA
)
from utils.hl7.v2_5_1.segment_groups import (
    ADT_A01_INSURANCE_GROUP, ADT_A01_PROCEDURE_GROUP
)

adt_a01 = ADT_A01(  #  - An A01 event is intended to be used for “Admitted” patients only
    ...
    procedure=None,  # ADT_A01_PROCEDURE_GROUP(...) 
    guarantor=None,  # GT1(...) 
    insurance=None,  # ADT_A01_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    ub82_data=None,  # UB1(...) 
    ub92_data=None,  # UB2(...) 
...
-----END TRIGGER_EVENT::ADT_A01 TEMPLATE-----
"""


class ADT_A01(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A01"""
    _hl7_name = """Admit/Visit Notification"""
    _hl7_description = """An A01 event is intended to be used for “Admitted” patients only"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A01"""
    ...
    _c_components = (MSH, SFT, EVN, PID, PD1, ROL, NK1, PV1, PV2, ROL, DB1, OBX, AL1, DG1, DRG, ADT_A01_PROCEDURE_GROUP, GT1, ADT_A01_INSURANCE_GROUP, ACC, UB1, UB2, PDA)
    ...
    def __init__(
        ...
        """
         - `ADT_A01 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A01>`_
    ...
    def procedure(self) -> tuple[ADT_A01_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A01_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A01_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A01_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: ADT_A01_PROCEDURE_GROUP | tuple[ADT_A01_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A01_PROCEDURE_GROUP.None | tuple[ADT_A01_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A01_PROCEDURE_GROUP
        """
    ...
    def insurance(self) -> tuple[ADT_A01_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A01_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A01_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A01_INSURANCE_GROUP
        """
    ...
    def insurance(
        self,
        insurance: ADT_A01_INSURANCE_GROUP | tuple[ADT_A01_INSURANCE_GROUP, ...] | None,
    ):
        """
        id: INSURANCE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A01_INSURANCE_GROUP.None | tuple[ADT_A01_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A01_INSURANCE_GROUP
        """
