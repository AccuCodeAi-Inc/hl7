...
"""
Laboratory Order for Multiple Orders Related to a Single Specimen  - OML_O33
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::OML_O33 TEMPLATE-----
...
from utils.hl7.v2_5_1.segment_groups import (
    OML_O33_PATIENT_GROUP, OML_O33_SPECIMEN_GROUP
)

oml_o33 = OML_O33(  #  - The trigger event for this message is any change to a laboratory order
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    notes_and_comments=None,  # NTE(...) 
    patient=None,  # OML_O33_PATIENT_GROUP(...) 
    specimen=oml_o33_specimen_group,  # OML_O33_SPECIMEN_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::OML_O33 TEMPLATE-----
"""


class OML_O33(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """OML_O33"""
    _hl7_name = """Laboratory Order for Multiple Orders Related to a Single Specimen """
    _hl7_description = """The trigger event for this message is any change to a laboratory order"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O33"""
    _c_length = (-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 65535, 1, 65535)
    _c_usage = ("R", "O", "O", "O", "R")
    _c_aliases = ("1", "2", "3", "None", "None")
    _c_components = (MSH, SFT, NTE, OML_O33_PATIENT_GROUP, OML_O33_SPECIMEN_GROUP)
    ...
    def __init__(
        ...
        | tuple[
            OML_O33_SPECIMEN_GROUP, ...
        ],  #  Required. (SPM.15, OBX.16, SAC.17, ...)
        ...
        """
                 - `OML_O33 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O33>`_
        ...
        The following message structure may be used for the communication of laboratory and other order messages and must be used for lab automation messages where the message requires Specimen/container information to group a number of orders.  While the ORM message with the OBR segment can be used for backwards compatibility for general lab messages, only the OML message should be used to take advantage of the specimen and container extensions required in laboratory automation.
                ...
                :param specimen: Specimen segment group: [SPM, OBX|None, SAC|None, ORDER] (id: SPECIMEN | seq: 15, 16, 17, None | use: R | rpt: *)
        """
        super().__init__()
    ...
    @property  # get OML_O33_PATIENT_GROUP.None
    def patient(self) -> OML_O33_PATIENT_GROUP | None:
        """
        id: OML_O33_PATIENT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: OML_O33_PATIENT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_PATIENT_GROUP
        """
        return self._c_data[3][0]

    @patient.setter  # set OML_O33_PATIENT_GROUP.None
    def patient(self, patient: OML_O33_PATIENT_GROUP | None):
        """
        id: OML_O33_PATIENT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: OML_O33_PATIENT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_PATIENT_GROUP
        """
    ...
    def specimen(self) -> tuple[OML_O33_SPECIMEN_GROUP, ...]:
        """
        id: OML_O33_SPECIMEN_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[OML_O33_SPECIMEN_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_SPECIMEN_GROUP
        """
        return self._c_data[4]

    @specimen.setter  # set SPECIMEN
    def specimen(
        self, specimen: OML_O33_SPECIMEN_GROUP | tuple[OML_O33_SPECIMEN_GROUP, ...]
    ):
        """
        id: SPECIMEN SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: OML_O33_SPECIMEN_GROUP.None | tuple[OML_O33_SPECIMEN_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_SPECIMEN_GROUP
        """
