...
"""
Change Patient ID - ADT_A46
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A46 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A46
from utils.hl7.v2_5_1.segments import (
    MRG, PID, SFT, EVN, MSH, PD1
)

adt_a46 = ADT_A46(  #  - Event A46 has been retained for backward compatibility only, corresponding with PID-2 - Patient ID, which is also retained for backward compatibility
...
-----END TRIGGER_EVENT::ADT_A46 TEMPLATE-----
"""


class ADT_A46(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A46"""
    _hl7_name = """Change Patient ID"""
    _hl7_description = """Event A46 has been retained for backward compatibility only, corresponding with PID-2 - Patient ID, which is also retained for backward compatibility"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A46"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A46 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A46>`_
