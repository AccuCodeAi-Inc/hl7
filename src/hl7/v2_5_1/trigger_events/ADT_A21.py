...
"""
Patient Goes on a Leave of Absence - ADT_A21
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A21 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A21
from utils.hl7.v2_5_1.segments import (
    PV1, PD1, DB1, MSH, SFT, PID, EVN, OBX, PV2
)

adt_a21 = ADT_A21(  #  - An A21 event is sent to notify systems that an admitted patient has left the healthcare institution temporarily
...
-----END TRIGGER_EVENT::ADT_A21 TEMPLATE-----
"""


class ADT_A21(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A21"""
    _hl7_name = """Patient Goes on a Leave of Absence"""
    _hl7_description = """An A21 event is sent to notify systems that an admitted patient has left the healthcare institution temporarily"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A21"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A21 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A21>`_
