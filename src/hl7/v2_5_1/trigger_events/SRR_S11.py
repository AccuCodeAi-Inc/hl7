...
from ..segment_groups.SRR_S11_SCHEDULE_GROUP import SRR_S11_SCHEDULE_GROUP
from ..segments.ERR import ERR


"""
Scheduled request response - Deletion of service/resource on appointment - SRR_S11
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::SRR_S11 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SRR_S11
from utils.hl7.v2_5_1.segments import (
    ERR, MSA, MSH
)
from utils.hl7.v2_5_1.segment_groups import (
    SRR_S11_SCHEDULE_GROUP
)

srr_s11 = SRR_S11(  #  - A request deletion of service/resource is sent by the placer application to the filler application to request that a scheduled appointment requiring a service or resource entered in error be removed from the system
    message_header=msh,  # MSH(...)  # Required.
    message_acknowledgment=msa,  # MSA(...)  # Required.
    error=None,  # ERR(...) 
    schedule=None,  # SRR_S11_SCHEDULE_GROUP(...) 
)

-----END TRIGGER_EVENT::SRR_S11 TEMPLATE-----
"""


class SRR_S11(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """SRR_S11"""
    _hl7_name = """Scheduled request response - Deletion of service/resource on appointment"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S11"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 1)
    _c_usage = ("R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "None")
    _c_components = (MSH, MSA, ERR, SRR_S11_SCHEDULE_GROUP)
    ...
    def __init__(
        ...
        schedule: SRR_S11_SCHEDULE_GROUP | None = None,  #  SCH.4, TQ1.5, NTE.6
    ):
        """
         - `SRR_S11 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S11>`_
    ...
    @property  # get SRR_S11_SCHEDULE_GROUP.None
    def schedule(self) -> SRR_S11_SCHEDULE_GROUP | None:
        """
        id: SRR_S11_SCHEDULE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: SRR_S11_SCHEDULE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S11_SCHEDULE_GROUP
        """
        return self._c_data[3][0]

    @schedule.setter  # set SRR_S11_SCHEDULE_GROUP.None
    def schedule(self, schedule: SRR_S11_SCHEDULE_GROUP | None):
        """
        id: SRR_S11_SCHEDULE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: SRR_S11_SCHEDULE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S11_SCHEDULE_GROUP
        """
