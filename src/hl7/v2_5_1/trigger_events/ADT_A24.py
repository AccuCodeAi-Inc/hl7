...
"""
Link Patient Information - ADT_A24
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A24 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A24
from utils.hl7.v2_5_1.segments import (
    PV1, PD1, DB1, MSH, SFT, PID, EVN
)

adt_a24 = ADT_A24(  #  - The A24 event is used when the first PID segment needs to be linked to the second PID segment and when both patient identifiers identify the same patient
...
-----END TRIGGER_EVENT::ADT_A24 TEMPLATE-----
"""


class ADT_A24(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A24"""
    _hl7_name = """Link Patient Information"""
    _hl7_description = """The A24 event is used when the first PID segment needs to be linked to the second PID segment and when both patient identifiers identify the same patient"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A24"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A24 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A24>`_
