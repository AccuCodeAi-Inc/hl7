...
"""
Terminate Practicing Person - PMU_B06
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::PMU_B06 TEMPLATE-----
...
-----END TRIGGER_EVENT::PMU_B06 TEMPLATE-----
"""


class PMU_B06(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """PMU_B06"""
    _hl7_name = """Terminate Practicing Person"""
    _hl7_description = """An event B06 signals that the formal relationship between a staff member and the institution has ended (e"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PMU_B06"""
    ...
    def __init__(
        ...
        """
         - `PMU_B06 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PMU_B06>`_
