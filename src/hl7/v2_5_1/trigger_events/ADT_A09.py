...
"""
Patient Departing - Tracking - ADT_A09
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A09 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A09
from utils.hl7.v2_5_1.segments import (
    OBX, PID, MSH, PD1, PV1, PV2, DG1, DB1, SFT, EVN
)

adt_a09 = ADT_A09(  #  - The A09 and A10 - patient arriving-tracking events are used when there is a change in a patient’s physical location (inpatient or outpatient) and when this is NOT a change in the official census bed location, as in the case of an outpatient setting
...
-----END TRIGGER_EVENT::ADT_A09 TEMPLATE-----
"""


class ADT_A09(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A09"""
    _hl7_name = """Patient Departing - Tracking"""
    _hl7_description = """The A09 and A10 - patient arriving-tracking events are used when there is a change in a patient’s physical location (inpatient or outpatient) and when this is NOT a change in the official census bed location, as in the case of an outpatient setting"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A09"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A09 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A09>`_
