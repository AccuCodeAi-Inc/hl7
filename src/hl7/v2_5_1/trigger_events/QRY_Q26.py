...
"""
Pharmacy/Treatment Order Query - QRY_Q26
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QRY_Q26 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QRY_Q26
from utils.hl7.v2_5_1.segments import (
    MSH, QRD, SFT, QRF, DSC
)

qry_q26 = QRY_Q26(  #  - This query/response pair is retained for backward compatibility only
...
-----END TRIGGER_EVENT::QRY_Q26 TEMPLATE-----
"""


class QRY_Q26(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QRY_Q26"""
    _hl7_name = """Pharmacy/Treatment Order Query"""
    _hl7_description = """This query/response pair is retained for backward compatibility only"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_Q26"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QRY_Q26 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_Q26>`_
