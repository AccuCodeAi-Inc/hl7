...
"""
Get Corresponding Identifiers Query - QBP_Q23
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Q23 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Q23
from utils.hl7.v2_5_1.segments import (
    QPD, DSC, RCP, MSH, SFT
)

qbp_q23 = QBP_Q23(  #  - This query/response is designed for interaction between a client system and an MPI (Master Person Index)
...
-----END TRIGGER_EVENT::QBP_Q23 TEMPLATE-----
"""


class QBP_Q23(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Q23"""
    _hl7_name = """Get Corresponding Identifiers Query"""
    _hl7_description = """This query/response is designed for interaction between a client system and an MPI (Master Person Index)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q23"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
                 - `QBP_Q23 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q23>`_
