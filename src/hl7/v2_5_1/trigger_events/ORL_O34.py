...
from ..segment_groups.ORL_O34_RESPONSE_GROUP import ORL_O34_RESPONSE_GROUP
...
"""
Laboratory Order Response to a Multiple Order Related to Single Specimen OML - ORL_O34
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ORL_O34 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ORL_O34
from utils.hl7.v2_5_1.segments import (
    MSH, SFT, ERR, NTE, MSA
)
from utils.hl7.v2_5_1.segment_groups import (
    ORL_O34_RESPONSE_GROUP
)

orl_o34 = ORL_O34(  #  - The function of this message is to respond to an OML message where the original trigger event produced an OML with the Specimen Group segment above the ORC
    message_header=msh,  # MSH(...)  # Required.
    message_acknowledgment=msa,  # MSA(...)  # Required.
    error=None,  # ERR(...) 
    software_segment=None,  # SFT(...) 
    notes_and_comments=None,  # NTE(...) 
    response=None,  # ORL_O34_RESPONSE_GROUP(...) 
)

-----END TRIGGER_EVENT::ORL_O34 TEMPLATE-----
"""


class ORL_O34(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ORL_O34"""
    _hl7_name = """Laboratory Order Response to a Multiple Order Related to Single Specimen OML"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORL_O34"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 1)
    _c_usage = ("R", "R", "O", "O", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "None")
    _c_components = (MSH, MSA, ERR, SFT, NTE, ORL_O34_RESPONSE_GROUP)
    ...
    def __init__(
        ...
        response: ORL_O34_RESPONSE_GROUP | None = None,  #
    ):
        """
         - `ORL_O34 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORL_O34>`_
    ...
    @property  # get ORL_O34_RESPONSE_GROUP.None
    def response(self) -> ORL_O34_RESPONSE_GROUP | None:
        """
        id: ORL_O34_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: ORL_O34_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORL_O34_RESPONSE_GROUP
        """
        return self._c_data[5][0]

    @response.setter  # set ORL_O34_RESPONSE_GROUP.None
    def response(self, response: ORL_O34_RESPONSE_GROUP | None):
        """
        id: ORL_O34_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: ORL_O34_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORL_O34_RESPONSE_GROUP
        """
