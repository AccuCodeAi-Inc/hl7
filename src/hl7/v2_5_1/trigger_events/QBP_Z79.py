...
"""
Dispense Information Query - QBP_Z79
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Z79 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Z79
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, SFT, RCP, DSC
)

qbp_z79 = QBP_Z79(  #  - The purpose of this query/response pair is to retrieve patient pharmacy dispense history information from the Server
...
-----END TRIGGER_EVENT::QBP_Z79 TEMPLATE-----
"""


class QBP_Z79(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z79"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QBP_Z79 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z79>`_
