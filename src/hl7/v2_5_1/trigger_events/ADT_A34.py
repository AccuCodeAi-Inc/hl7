...
"""
Merge Patient Information - Patient ID Only - ADT_A34
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A34 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A34
from utils.hl7.v2_5_1.segments import (
    MRG, PID, SFT, EVN, MSH, PD1
)

adt_a34 = ADT_A34(  #  - Event A34 has been retained for backward compatibility only
...
-----END TRIGGER_EVENT::ADT_A34 TEMPLATE-----
"""


class ADT_A34(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A34"""
    _hl7_name = """Merge Patient Information - Patient ID Only"""
    _hl7_description = """Event A34 has been retained for backward compatibility only"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A34"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A34 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A34>`_
