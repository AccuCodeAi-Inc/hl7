...
"""
Pharmacy Information Comprehensive Query - QBP_Z85
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Z85 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Z85
from utils.hl7.v2_5_1.segments import (
    SFT, RCP, DSC, QPD, MSH
)

qbp_z85 = QBP_Z85(  #  - The purpose of this query/response is to retrieve patient pharmacy history information from the Server
...
-----END TRIGGER_EVENT::QBP_Z85 TEMPLATE-----
"""


class QBP_Z85(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Z85"""
    _hl7_name = """Pharmacy Information Comprehensive Query"""
    _hl7_description = """The purpose of this query/response is to retrieve patient pharmacy history information from the Server"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z85"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QBP_Z85 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z85>`_
