...
"""
Patient pathway (problem-oriented) query - QRY_PCE
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QRY_PCE TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QRY_PCE
from utils.hl7.v2_5_1.segments import (
    QRF, QRD, MSH
)

qry_pce = QRY_PCE(  #  - The following trigger/message event is served by QRY (a query from another system)
    message_header=msh,  # MSH(...)  # Required.
    original_style_query_definition=qrd,  # QRD(...)  # Required.
    original_style_query_filter=None,  # QRF(...) 
)

-----END TRIGGER_EVENT::QRY_PCE TEMPLATE-----
"""


class QRY_PCE(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QRY_PCE"""
    _hl7_name = """Patient pathway (problem-oriented) query"""
    _hl7_description = """The following trigger/message event is served by QRY (a query from another system)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_PCE"""
    _c_length = (-1,-1,-1,)
    _c_rpt = (1, 1, 1)
    _c_usage = ("R", "R", "O")
    _c_aliases = ("1", "2", "3")
    ...
    def __init__(
        ...
        """
         - `QRY_PCE <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_PCE>`_
