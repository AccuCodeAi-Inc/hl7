...
from ..segment_groups.ADT_A07_PROCEDURE_GROUP import ADT_A07_PROCEDURE_GROUP
...
from ..segment_groups.ADT_A07_INSURANCE_GROUP import ADT_A07_INSURANCE_GROUP
...
"""
Change an Inpatient to an Outpatient - ADT_A07
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A07 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A07
from utils.hl7.v2_5_1.segments import (
    PV1, EVN, DG1, ROL, PID, NK1, MSH, PV2, MRG, AL1, UB1, DB1, PD1, OBX, UB2, SFT, ACC, GT1, DRG
)
from utils.hl7.v2_5_1.segment_groups import (
    ADT_A07_PROCEDURE_GROUP, ADT_A07_INSURANCE_GROUP
)

adt_a07 = ADT_A07(  #  - An A07 event is sent when a patient who was admitted changes his/her status to “no longer admitted” but is still being seen for this episode of care
    ...
    procedure=None,  # ADT_A07_PROCEDURE_GROUP(...) 
    guarantor=None,  # GT1(...) 
    insurance=None,  # ADT_A07_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    ub82_data=None,  # UB1(...) 
    ub92_data=None,  # UB2(...) 
)

-----END TRIGGER_EVENT::ADT_A07 TEMPLATE-----
"""


class ADT_A07(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A07"""
    _hl7_name = """Change an Inpatient to an Outpatient"""
    _hl7_description = """An A07 event is sent when a patient who was admitted changes his/her status to “no longer admitted” but is still being seen for this episode of care"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A07"""
    ...
    _c_components = (MSH, SFT, EVN, PID, PD1, ROL, MRG, NK1, PV1, PV2, ROL, DB1, OBX, AL1, DG1, DRG, ADT_A07_PROCEDURE_GROUP, GT1, ADT_A07_INSURANCE_GROUP, ACC, UB1, UB2)
    ...
    def __init__(
        ...
        | tuple[ADT_A07_PROCEDURE_GROUP, ...]
        | None = None,  #  (PR1.17, ROL.18, ...)
        guarantor: GT1 | tuple[GT1, ...] | None = None,  #  GT1.19
        insurance: ADT_A07_INSURANCE_GROUP
        | tuple[ADT_A07_INSURANCE_GROUP, ...]
        ...
        """
         - `ADT_A07 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A07>`_
    ...
    def procedure(self) -> tuple[ADT_A07_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A07_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A07_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A07_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: ADT_A07_PROCEDURE_GROUP | tuple[ADT_A07_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A07_PROCEDURE_GROUP.None | tuple[ADT_A07_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A07_PROCEDURE_GROUP
        """
    ...
    def insurance(self) -> tuple[ADT_A07_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A07_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A07_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A07_INSURANCE_GROUP
        """
    ...
    def insurance(
        self,
        insurance: ADT_A07_INSURANCE_GROUP | tuple[ADT_A07_INSURANCE_GROUP, ...] | None,
    ):
        """
        id: INSURANCE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A07_INSURANCE_GROUP.None | tuple[ADT_A07_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A07_INSURANCE_GROUP
        """
