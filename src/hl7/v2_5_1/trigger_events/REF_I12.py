...
from utils.hl7.v2_5_1.segment_groups import (
    REF_I12_AUTHORIZATION_CONTACT_GROUP, REF_I12_PROVIDER_CONTACT_GROUP, REF_I12_INSURANCE_GROUP, REF_I12_PROCEDURE_GROUP, REF_I12_OBSERVATION_GROUP, REF_I12_PATIENT_VISIT_GROUP
)
