...
"""
Dispense History Query - QBP_Q31
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Q31 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Q31
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, SFT, RCP, DSC
)

qbp_q31 = QBP_Q31(  #  - The purpose of this query/response pair is to retrieve patient pharmacy dispense history information from the Server
...
-----END TRIGGER_EVENT::QBP_Q31 TEMPLATE-----
"""


class QBP_Q31(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q31"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QBP_Q31 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q31>`_
