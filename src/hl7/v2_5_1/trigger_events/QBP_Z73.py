...
"""
Information about Phone Calls Query - QBP_Z73
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Z73 TEMPLATE-----
...
-----END TRIGGER_EVENT::QBP_Z73 TEMPLATE-----
"""


class QBP_Z73(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Z73"""
    _hl7_name = """Information about Phone Calls Query"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z73"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1)
    _c_usage = ("R", "O", "R", "R")
    _c_aliases = ("1", "2", "3", "4")
    _c_components = (MSH, SFT, QPD, RCP)
    _c_name = ("MSH", "SFT", "QPD", "RCP")
    _c_is_group = (False, False, False, False)
    _c_attrs = ("message_header", "software_segment", "query_parameter_definition", "response_control_parameter",)
    # fmt: on
    ...
    def __init__(
        ...
        """
         - `QBP_Z73 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z73>`_
