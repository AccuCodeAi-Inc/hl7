...
"""
Schedule request - New appointment booking - SRM_S01
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::SRM_S01 TEMPLATE-----
...
srm_s01 = SRM_S01(  #  - A placer application sends a transaction with this trigger event to a filler application to request that a new appointment be booked
    ...
    patient=None,  # SRM_S01_PATIENT_GROUP(...) 
    resources=srm_s01_resources_group,  # SRM_S01_RESOURCES_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::SRM_S01 TEMPLATE-----
"""


class SRM_S01(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """SRM_S01"""
    _hl7_name = """Schedule request - New appointment booking"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S01"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 1, 65535, 65535, 65535)
    _c_usage = ("R", "R", "O", "O", "O", "R")
    _c_aliases = ("1", "2", "3", "4", "None", "None")
    _c_components = (MSH, ARQ, APR, NTE, SRM_S01_PATIENT_GROUP, SRM_S01_RESOURCES_GROUP)
    ...
    def __init__(
        ...
        | tuple[SRM_S01_RESOURCES_GROUP, ...],  #  Required. (RGS.10, ...)
        appointment_preferences: APR | None = None,  #  APR.3
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.4
        patient: SRM_S01_PATIENT_GROUP
        | tuple[SRM_S01_PATIENT_GROUP, ...]
        | None = None,  #  (PID.5, PV1.6, PV2.7, OBX.8, DG1.9, ...)
    ):
        """
         - `SRM_S01 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S01>`_
    ...
    def patient(self) -> tuple[SRM_S01_PATIENT_GROUP, ...] | tuple[None]:
        """
        id: SRM_S01_PATIENT_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[SRM_S01_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRM_S01_PATIENT_GROUP
        """
        return self._c_data[4]

    @patient.setter  # set PATIENT
    def patient(
        self, patient: SRM_S01_PATIENT_GROUP | tuple[SRM_S01_PATIENT_GROUP, ...] | None
    ):
        """
        id: PATIENT SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: SRM_S01_PATIENT_GROUP.None | tuple[SRM_S01_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRM_S01_PATIENT_GROUP
        """
    ...
    def resources(self) -> tuple[SRM_S01_RESOURCES_GROUP, ...]:
        """
        id: SRM_S01_RESOURCES_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[SRM_S01_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRM_S01_RESOURCES_GROUP
        """
        return self._c_data[5]

    @resources.setter  # set RESOURCES
    def resources(
        self, resources: SRM_S01_RESOURCES_GROUP | tuple[SRM_S01_RESOURCES_GROUP, ...]
    ):
        """
        id: RESOURCES SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: SRM_S01_RESOURCES_GROUP.None | tuple[SRM_S01_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRM_S01_RESOURCES_GROUP
        """
