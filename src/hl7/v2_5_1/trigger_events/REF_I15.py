...
from utils.hl7.v2_5_1.segment_groups import (
    REF_I15_PROVIDER_CONTACT_GROUP, REF_I15_PATIENT_VISIT_GROUP, REF_I15_AUTHORIZATION_CONTACT_GROUP, REF_I15_INSURANCE_GROUP, REF_I15_OBSERVATION_GROUP, REF_I15_PROCEDURE_GROUP
)
