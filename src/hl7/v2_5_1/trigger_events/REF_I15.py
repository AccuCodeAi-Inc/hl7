...
from ..segment_groups.REF_I15_AUTHORIZATION_CONTACT_GROUP import (
    REF_I15_AUTHORIZATION_CONTACT_GROUP,
)
from ..segment_groups.REF_I15_OBSERVATION_GROUP import REF_I15_OBSERVATION_GROUP
from ..segments.NTE import NTE
from ..segment_groups.REF_I15_PROCEDURE_GROUP import REF_I15_PROCEDURE_GROUP
from ..segment_groups.REF_I15_INSURANCE_GROUP import REF_I15_INSURANCE_GROUP
from ..segments.ACC import ACC
from ..segments.NK1 import NK1
from ..segment_groups.REF_I15_PROVIDER_CONTACT_GROUP import (
    REF_I15_PROVIDER_CONTACT_GROUP,
)
from ..segments.MSH import MSH
from ..segment_groups.REF_I15_PATIENT_VISIT_GROUP import REF_I15_PATIENT_VISIT_GROUP
...
"""
Request patient referral status - REF_I15
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::REF_I15 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import REF_I15
from utils.hl7.v2_5_1.segments import (
    NK1, DG1, ACC, AL1, NTE, PID, SFT, MSH, RF1, DRG, GT1
)
from utils.hl7.v2_5_1.segment_groups import (
    REF_I15_INSURANCE_GROUP, REF_I15_PROCEDURE_GROUP, REF_I15_AUTHORIZATION_CONTACT_GROUP, REF_I15_OBSERVATION_GROUP, REF_I15_PROVIDER_CONTACT_GROUP, REF_I15_PATIENT_VISIT_GROUP
)

ref_i15 = REF_I15(  #  - This event triggers a message to be sent between healthcare providers regarding the status of a patient referral request
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    referral_information=None,  # RF1(...) 
    authorization_contact=None,  # REF_I15_AUTHORIZATION_CONTACT_GROUP(...) 
    provider_contact=ref_i15_provider_contact_group,  # REF_I15_PROVIDER_CONTACT_GROUP(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    next_of_kin_or_associated_parties=None,  # NK1(...) 
    guarantor=None,  # GT1(...) 
    insurance=None,  # REF_I15_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    diagnosis=None,  # DG1(...) 
    diagnosis_related_group=None,  # DRG(...) 
    patient_allergy_information=None,  # AL1(...) 
    procedure=None,  # REF_I15_PROCEDURE_GROUP(...) 
    observation=None,  # REF_I15_OBSERVATION_GROUP(...) 
    patient_visit=None,  # REF_I15_PATIENT_VISIT_GROUP(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT::REF_I15 TEMPLATE-----
"""


class REF_I15(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """REF_I15"""
    _hl7_name = """Request patient referral status"""
    _hl7_description = """This event triggers a message to be sent between healthcare providers regarding the status of a patient referral request"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I15"""
    ...
    _c_components = (MSH, SFT, RF1, REF_I15_AUTHORIZATION_CONTACT_GROUP, REF_I15_PROVIDER_CONTACT_GROUP, PID, NK1, GT1, REF_I15_INSURANCE_GROUP, ACC, DG1, DRG, AL1, REF_I15_PROCEDURE_GROUP, REF_I15_OBSERVATION_GROUP, REF_I15_PATIENT_VISIT_GROUP, NTE)
    ...
    def __init__(
        ...
        provider_contact: REF_I15_PROVIDER_CONTACT_GROUP
        | tuple[REF_I15_PROVIDER_CONTACT_GROUP, ...],  #  Required. (PRD.6, CTD.7, ...)
        patient_identification: PID,  #  Required. PID.8
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        referral_information: RF1 | None = None,  #  RF1.3
        authorization_contact: REF_I15_AUTHORIZATION_CONTACT_GROUP
        | None = None,  #  AUT.4, CTD.5
        next_of_kin_or_associated_parties: NK1
        | tuple[NK1, ...]
        | None = None,  #  NK1.9
        guarantor: GT1 | tuple[GT1, ...] | None = None,  #  GT1.10
        insurance: REF_I15_INSURANCE_GROUP
        | tuple[REF_I15_INSURANCE_GROUP, ...]
        ...
        procedure: REF_I15_PROCEDURE_GROUP
        | tuple[REF_I15_PROCEDURE_GROUP, ...]
        | None = None,  #  (PR1.18, ...)
        observation: REF_I15_OBSERVATION_GROUP
        | tuple[REF_I15_OBSERVATION_GROUP, ...]
        | None = None,  #  (OBR.21, NTE.22, ...)
        patient_visit: REF_I15_PATIENT_VISIT_GROUP | None = None,  #  PV1.25, PV2.26
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.27
    ):
        """
         - `REF_I15 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I15>`_
    ...
    @property  # get REF_I15_AUTHORIZATION_CONTACT_GROUP.None
    def authorization_contact(self) -> REF_I15_AUTHORIZATION_CONTACT_GROUP | None:
        """
        id: REF_I15_AUTHORIZATION_CONTACT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: REF_I15_AUTHORIZATION_CONTACT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_AUTHORIZATION_CONTACT_GROUP
        """
        return self._c_data[3][0]

    @authorization_contact.setter  # set REF_I15_AUTHORIZATION_CONTACT_GROUP.None
    def authorization_contact(
        self, authorization_contact: REF_I15_AUTHORIZATION_CONTACT_GROUP | None
    ):
        """
        id: REF_I15_AUTHORIZATION_CONTACT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: REF_I15_AUTHORIZATION_CONTACT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_AUTHORIZATION_CONTACT_GROUP
        """
    ...
    def provider_contact(self) -> tuple[REF_I15_PROVIDER_CONTACT_GROUP, ...]:
        """
        id: REF_I15_PROVIDER_CONTACT_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[REF_I15_PROVIDER_CONTACT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_PROVIDER_CONTACT_GROUP
        """
    ...
    def provider_contact(
        self,
        provider_contact: REF_I15_PROVIDER_CONTACT_GROUP
        | tuple[REF_I15_PROVIDER_CONTACT_GROUP, ...],
    ):
        """
        id: PROVIDER CONTACT SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: REF_I15_PROVIDER_CONTACT_GROUP.None | tuple[REF_I15_PROVIDER_CONTACT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_PROVIDER_CONTACT_GROUP
        """
    ...
    def insurance(self) -> tuple[REF_I15_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: REF_I15_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[REF_I15_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_INSURANCE_GROUP
        """
    ...
    def insurance(
        self,
        insurance: REF_I15_INSURANCE_GROUP | tuple[REF_I15_INSURANCE_GROUP, ...] | None,
    ):
        """
        id: INSURANCE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: REF_I15_INSURANCE_GROUP.None | tuple[REF_I15_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_INSURANCE_GROUP
        """
    ...
    def procedure(self) -> tuple[REF_I15_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: REF_I15_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[REF_I15_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: REF_I15_PROCEDURE_GROUP | tuple[REF_I15_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: REF_I15_PROCEDURE_GROUP.None | tuple[REF_I15_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_PROCEDURE_GROUP
        """
    ...
    def observation(self) -> tuple[REF_I15_OBSERVATION_GROUP, ...] | tuple[None]:
        """
        id: REF_I15_OBSERVATION_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[REF_I15_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_OBSERVATION_GROUP
        """
    ...
    def observation(
        ...
        ---
        param_type: REF_I15_OBSERVATION_GROUP.None | tuple[REF_I15_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_OBSERVATION_GROUP
        """
    ...
    @property  # get REF_I15_PATIENT_VISIT_GROUP.None
    def patient_visit(self) -> REF_I15_PATIENT_VISIT_GROUP | None:
        """
        id: REF_I15_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: REF_I15_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_PATIENT_VISIT_GROUP
        """
        return self._c_data[15][0]

    @patient_visit.setter  # set REF_I15_PATIENT_VISIT_GROUP.None
    def patient_visit(self, patient_v_isit: REF_I15_PATIENT_VISIT_GROUP | None):
        """
        id: REF_I15_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: REF_I15_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I15_PATIENT_VISIT_GROUP
        """
