...
from ..segment_groups.ORP_O10_RESPONSE_GROUP import ORP_O10_RESPONSE_GROUP
...
"""
Pharmacy/Treatment Order Acknowledgement - ORP_O10
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ORP_O10 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ORP_O10
from utils.hl7.v2_5_1.segments import (
    MSH, SFT, ERR, NTE, MSA
)
from utils.hl7.v2_5_1.segment_groups import (
    ORP_O10_RESPONSE_GROUP
)

orp_o10 = ORP_O10(  #  - Pharmacy/Treatment Orders can use the ORM message with the RXO, RXC, and RXR segments for the detail segment, or use the OMP and ORP messages
    message_header=msh,  # MSH(...)  # Required.
    message_acknowledgment=msa,  # MSA(...)  # Required.
    error=None,  # ERR(...) 
    software_segment=None,  # SFT(...) 
    notes_and_comments=None,  # NTE(...) 
    response=None,  # ORP_O10_RESPONSE_GROUP(...) 
)

-----END TRIGGER_EVENT::ORP_O10 TEMPLATE-----
"""


class ORP_O10(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ORP_O10"""
    _hl7_name = """Pharmacy/Treatment Order Acknowledgement"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORP_O10"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 1)
    _c_usage = ("R", "R", "O", "O", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "None")
    _c_components = (MSH, MSA, ERR, SFT, NTE, ORP_O10_RESPONSE_GROUP)
    ...
    def __init__(
        ...
        response: ORP_O10_RESPONSE_GROUP | None = None,  #
    ):
        """
         - `ORP_O10 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORP_O10>`_
    ...
    @property  # get ORP_O10_RESPONSE_GROUP.None
    def response(self) -> ORP_O10_RESPONSE_GROUP | None:
        """
        id: ORP_O10_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: ORP_O10_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORP_O10_RESPONSE_GROUP
        """
        return self._c_data[5][0]

    @response.setter  # set ORP_O10_RESPONSE_GROUP.None
    def response(self, response: ORP_O10_RESPONSE_GROUP | None):
        """
        id: ORP_O10_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: ORP_O10_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORP_O10_RESPONSE_GROUP
        """
