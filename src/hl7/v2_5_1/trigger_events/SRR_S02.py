...
from ..segment_groups.SRR_S02_SCHEDULE_GROUP import SRR_S02_SCHEDULE_GROUP
...
"""
Scheduled request response - Appointment rescheduling - SRR_S02
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::SRR_S02 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SRR_S02
from utils.hl7.v2_5_1.segments import (
    ERR, MSA, MSH
)
from utils.hl7.v2_5_1.segment_groups import (
    SRR_S02_SCHEDULE_GROUP
)

srr_s02 = SRR_S02(  #  - A placer application sends a transaction with this trigger event to a filler application to request that a new appointment be booked
    message_header=msh,  # MSH(...)  # Required.
    message_acknowledgment=msa,  # MSA(...)  # Required.
    error=None,  # ERR(...) 
    schedule=None,  # SRR_S02_SCHEDULE_GROUP(...) 
)

-----END TRIGGER_EVENT::SRR_S02 TEMPLATE-----
"""


class SRR_S02(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """SRR_S02"""
    _hl7_name = """Scheduled request response - Appointment rescheduling"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S02"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 1)
    _c_usage = ("R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "None")
    _c_components = (MSH, MSA, ERR, SRR_S02_SCHEDULE_GROUP)
    ...
    def __init__(
        ...
        schedule: SRR_S02_SCHEDULE_GROUP | None = None,  #  SCH.4, TQ1.5, NTE.6
    ):
        """
         - `SRR_S02 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S02>`_
    ...
    @property  # get SRR_S02_SCHEDULE_GROUP.None
    def schedule(self) -> SRR_S02_SCHEDULE_GROUP | None:
        """
        id: SRR_S02_SCHEDULE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: SRR_S02_SCHEDULE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S02_SCHEDULE_GROUP
        """
        return self._c_data[3][0]

    @schedule.setter  # set SRR_S02_SCHEDULE_GROUP.None
    def schedule(self, schedule: SRR_S02_SCHEDULE_GROUP | None):
        """
        id: SRR_S02_SCHEDULE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: SRR_S02_SCHEDULE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S02_SCHEDULE_GROUP
        """
