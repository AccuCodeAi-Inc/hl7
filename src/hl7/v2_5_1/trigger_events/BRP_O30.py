...
from ..segment_groups.BRP_O30_RESPONSE_GROUP import BRP_O30_RESPONSE_GROUP
from ..segments.MSA import MSA


"""
Blood Product Dispense Status Acknowledgment - BRP_O30
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::BRP_O30 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import BRP_O30
from utils.hl7.v2_5_1.segments import (
    ERR, MSA, NTE, MSH, SFT
)
from utils.hl7.v2_5_1.segment_groups import (
    BRP_O30_RESPONSE_GROUP
)

brp_o30 = BRP_O30(  #  - Blood product dispense status messages use the BPS and BRP messages
    message_header=msh,  # MSH(...)  # Required.
    message_acknowledgment=msa,  # MSA(...)  # Required.
    error=None,  # ERR(...) 
    software_segment=None,  # SFT(...) 
    notes_and_comments=None,  # NTE(...) 
    response=None,  # BRP_O30_RESPONSE_GROUP(...) 
)

-----END TRIGGER_EVENT::BRP_O30 TEMPLATE-----
"""


class BRP_O30(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """BRP_O30"""
    _hl7_name = """Blood Product Dispense Status Acknowledgment"""
    _hl7_description = """Blood product dispense status messages use the BPS and BRP messages"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/BRP_O30"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 1)
    _c_usage = ("R", "R", "O", "O", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "None")
    _c_components = (MSH, MSA, ERR, SFT, NTE, BRP_O30_RESPONSE_GROUP)
    ...
    def __init__(
        ...
        response: BRP_O30_RESPONSE_GROUP | None = None,  #
    ):
        """
         - `BRP_O30 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/BRP_O30>`_
    ...
    @property  # get BRP_O30_RESPONSE_GROUP.None
    def response(self) -> BRP_O30_RESPONSE_GROUP | None:
        """
        id: BRP_O30_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: BRP_O30_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/BRP_O30_RESPONSE_GROUP
        """
        return self._c_data[5][0]

    @response.setter  # set BRP_O30_RESPONSE_GROUP.None
    def response(self, response: BRP_O30_RESPONSE_GROUP | None):
        """
        id: BRP_O30_RESPONSE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: BRP_O30_RESPONSE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/BRP_O30_RESPONSE_GROUP
        """
