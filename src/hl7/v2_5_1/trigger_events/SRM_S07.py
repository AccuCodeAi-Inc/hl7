...
from ..segment_groups.SRM_S07_PATIENT_GROUP import SRM_S07_PATIENT_GROUP
from ..segments.ARQ import ARQ
from ..segment_groups.SRM_S07_RESOURCES_GROUP import SRM_S07_RESOURCES_GROUP
...
"""
Schedule request - Addition of service/resource on appointment - SRM_S07
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::SRM_S07 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SRM_S07
from utils.hl7.v2_5_1.segments import (
    ARQ, APR, NTE, MSH
)
from utils.hl7.v2_5_1.segment_groups import (
    SRM_S07_RESOURCES_GROUP, SRM_S07_PATIENT_GROUP
)

srm_s07 = SRM_S07(  #  - The request addition of service/resource is triggered by the placer application to request that a new service or resource be added to an existing appointment
    message_header=msh,  # MSH(...)  # Required.
    appointment_request=arq,  # ARQ(...)  # Required.
    appointment_preferences=None,  # APR(...) 
    notes_and_comments=None,  # NTE(...) 
    patient=None,  # SRM_S07_PATIENT_GROUP(...) 
    resources=srm_s07_resources_group,  # SRM_S07_RESOURCES_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::SRM_S07 TEMPLATE-----
"""


class SRM_S07(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """SRM_S07"""
    _hl7_name = """Schedule request - Addition of service/resource on appointment"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S07"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 1, 65535, 65535, 65535)
    _c_usage = ("R", "R", "O", "O", "O", "R")
    _c_aliases = ("1", "2", "3", "4", "None", "None")
    _c_components = (MSH, ARQ, APR, NTE, SRM_S07_PATIENT_GROUP, SRM_S07_RESOURCES_GROUP)
    ...
    def __init__(
        ...
        | tuple[SRM_S07_RESOURCES_GROUP, ...],  #  Required. (RGS.10, ...)
        appointment_preferences: APR | None = None,  #  APR.3
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.4
        patient: SRM_S07_PATIENT_GROUP
        | tuple[SRM_S07_PATIENT_GROUP, ...]
        | None = None,  #  (PID.5, PV1.6, PV2.7, OBX.8, DG1.9, ...)
    ):
        """
         - `SRM_S07 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S07>`_
    ...
    def patient(self) -> tuple[SRM_S07_PATIENT_GROUP, ...] | tuple[None]:
        """
        id: SRM_S07_PATIENT_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[SRM_S07_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRM_S07_PATIENT_GROUP
        """
        return self._c_data[4]

    @patient.setter  # set PATIENT
    def patient(
        self, patient: SRM_S07_PATIENT_GROUP | tuple[SRM_S07_PATIENT_GROUP, ...] | None
    ):
        """
        id: PATIENT SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: SRM_S07_PATIENT_GROUP.None | tuple[SRM_S07_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRM_S07_PATIENT_GROUP
        """
    ...
    def resources(self) -> tuple[SRM_S07_RESOURCES_GROUP, ...]:
        """
        id: SRM_S07_RESOURCES_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[SRM_S07_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRM_S07_RESOURCES_GROUP
        """
        return self._c_data[5]

    @resources.setter  # set RESOURCES
    def resources(
        self, resources: SRM_S07_RESOURCES_GROUP | tuple[SRM_S07_RESOURCES_GROUP, ...]
    ):
        """
        id: RESOURCES SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: SRM_S07_RESOURCES_GROUP.None | tuple[SRM_S07_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRM_S07_RESOURCES_GROUP
        """
