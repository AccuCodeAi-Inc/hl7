...
"""
Pharmacy/Treatment Dose Information - RGR_RGR
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RGR_RGR TEMPLATE-----
...
rgr_rgr = RGR_RGR(  #  - This query/response pair is retained for backward compatibility only
    message_header=msh,  # MSH(...)  # Required.
    message_acknowledgment=msa,  # MSA(...)  # Required.
    error=None,  # ERR(...) 
    software_segment=None,  # SFT(...) 
    definition=rgr_rgr_definition_group,  # RGR_RGR_DEFINITION_GROUP(...)  # Required.
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RGR_RGR TEMPLATE-----
"""


class RGR_RGR(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RGR_RGR"""
    _hl7_name = """Pharmacy/Treatment Dose Information"""
    _hl7_description = """This query/response pair is retained for backward compatibility only"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RGR_RGR"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 1)
    _c_usage = ("R", "R", "O", "O", "R", "O")
    _c_aliases = ("1", "2", "3", "4", "None", "16")
    _c_components = (MSH, MSA, ERR, SFT, RGR_RGR_DEFINITION_GROUP, DSC)
    ...
    def __init__(
        ...
        | tuple[RGR_RGR_DEFINITION_GROUP, ...],  #  Required. (QRD.5, QRF.6, ...)
        ...
        """
         - `RGR_RGR <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RGR_RGR>`_
    ...
    def definition(self) -> tuple[RGR_RGR_DEFINITION_GROUP, ...]:
        """
        id: RGR_RGR_DEFINITION_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RGR_RGR_DEFINITION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RGR_RGR_DEFINITION_GROUP
        """
    ...
    def definition(
        self,
        definition: RGR_RGR_DEFINITION_GROUP | tuple[RGR_RGR_DEFINITION_GROUP, ...],
    ):
        """
        id: DEFINITION SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RGR_RGR_DEFINITION_GROUP.None | tuple[RGR_RGR_DEFINITION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RGR_RGR_DEFINITION_GROUP
        """
