...
"""
Query by Parameter Requesting an RSP Segment Pattern Response - QBP_Q11
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Q11 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Q11
from utils.hl7.v2_5_1.segments import (
    DSC, RCP, QPD, SFT, MSH
)

qbp_q11 = QBP_Q11(  #  - The QBP_Q11 structure supports a Segment Pattern Response and contains the MSH, QPD, RCP, and DSC segments
...
-----END TRIGGER_EVENT::QBP_Q11 TEMPLATE-----
"""


class QBP_Q11(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Q11"""
    _hl7_name = """Query by Parameter Requesting an RSP Segment Pattern Response"""
    _hl7_description = """The QBP_Q11 structure supports a Segment Pattern Response and contains the MSH, QPD, RCP, and DSC segments"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q11"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
                 - `QBP_Q11 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q11>`_
