...
from utils.hl7.v2_5_1.segment_groups import (
    REF_I13_AUTHORIZATION_CONTACT_GROUP, REF_I13_PROVIDER_CONTACT_GROUP, REF_I13_INSURANCE_GROUP, REF_I13_OBSERVATION_GROUP, REF_I13_PROCEDURE_GROUP, REF_I13_PATIENT_VISIT_GROUP
)
