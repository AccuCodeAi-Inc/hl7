...
"""
Cancel patient referral - REF_I14
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::REF_I14 TEMPLATE-----
...
from utils.hl7.v2_5_1.segment_groups import (
    REF_I14_INSURANCE_GROUP, REF_I14_PROVIDER_CONTACT_GROUP, REF_I14_AUTHORIZATION_CONTACT_GROUP, REF_I14_PATIENT_VISIT_GROUP, REF_I14_PROCEDURE_GROUP, REF_I14_OBSERVATION_GROUP
)
...
ref_i14 = REF_I14(  #  - This event triggers a message to be sent from one healthcare provider to another canceling a referral
    ...
    authorization_contact=None,  # REF_I14_AUTHORIZATION_CONTACT_GROUP(...) 
    provider_contact=ref_i14_provider_contact_group,  # REF_I14_PROVIDER_CONTACT_GROUP(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    next_of_kin_or_associated_parties=None,  # NK1(...) 
    guarantor=None,  # GT1(...) 
    insurance=None,  # REF_I14_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    diagnosis=None,  # DG1(...) 
    diagnosis_related_group=None,  # DRG(...) 
    patient_allergy_information=None,  # AL1(...) 
    procedure=None,  # REF_I14_PROCEDURE_GROUP(...) 
    observation=None,  # REF_I14_OBSERVATION_GROUP(...) 
    patient_visit=None,  # REF_I14_PATIENT_VISIT_GROUP(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT::REF_I14 TEMPLATE-----
"""


class REF_I14(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """REF_I14"""
    _hl7_name = """Cancel patient referral"""
    _hl7_description = """This event triggers a message to be sent from one healthcare provider to another canceling a referral"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I14"""
    ...
    _c_components = (MSH, SFT, RF1, REF_I14_AUTHORIZATION_CONTACT_GROUP, REF_I14_PROVIDER_CONTACT_GROUP, PID, NK1, GT1, REF_I14_INSURANCE_GROUP, ACC, DG1, DRG, AL1, REF_I14_PROCEDURE_GROUP, REF_I14_OBSERVATION_GROUP, REF_I14_PATIENT_VISIT_GROUP, NTE)
    ...
    def __init__(
        ...
        provider_contact: REF_I14_PROVIDER_CONTACT_GROUP
        | tuple[REF_I14_PROVIDER_CONTACT_GROUP, ...],  #  Required. (PRD.6, CTD.7, ...)
        patient_identification: PID,  #  Required. PID.8
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        referral_information: RF1 | None = None,  #  RF1.3
        authorization_contact: REF_I14_AUTHORIZATION_CONTACT_GROUP
        ...
        procedure: REF_I14_PROCEDURE_GROUP
        | tuple[REF_I14_PROCEDURE_GROUP, ...]
        | None = None,  #  (PR1.18, ...)
        observation: REF_I14_OBSERVATION_GROUP
        | tuple[REF_I14_OBSERVATION_GROUP, ...]
        | None = None,  #  (OBR.21, NTE.22, ...)
        patient_visit: REF_I14_PATIENT_VISIT_GROUP | None = None,  #  PV1.25, PV2.26
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.27
    ):
        """
         - `REF_I14 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I14>`_
    ...
    @property  # get REF_I14_AUTHORIZATION_CONTACT_GROUP.None
    def authorization_contact(self) -> REF_I14_AUTHORIZATION_CONTACT_GROUP | None:
        """
        id: REF_I14_AUTHORIZATION_CONTACT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: REF_I14_AUTHORIZATION_CONTACT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_AUTHORIZATION_CONTACT_GROUP
        """
        return self._c_data[3][0]

    @authorization_contact.setter  # set REF_I14_AUTHORIZATION_CONTACT_GROUP.None
    def authorization_contact(
        self, authorization_contact: REF_I14_AUTHORIZATION_CONTACT_GROUP | None
    ):
        """
        id: REF_I14_AUTHORIZATION_CONTACT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: REF_I14_AUTHORIZATION_CONTACT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_AUTHORIZATION_CONTACT_GROUP
        """
    ...
    def provider_contact(self) -> tuple[REF_I14_PROVIDER_CONTACT_GROUP, ...]:
        """
        id: REF_I14_PROVIDER_CONTACT_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[REF_I14_PROVIDER_CONTACT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_PROVIDER_CONTACT_GROUP
        """
    ...
    def provider_contact(
        self,
        provider_contact: REF_I14_PROVIDER_CONTACT_GROUP
        | tuple[REF_I14_PROVIDER_CONTACT_GROUP, ...],
    ):
        """
        id: PROVIDER CONTACT SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: REF_I14_PROVIDER_CONTACT_GROUP.None | tuple[REF_I14_PROVIDER_CONTACT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_PROVIDER_CONTACT_GROUP
        """
    ...
    def insurance(self) -> tuple[REF_I14_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: REF_I14_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[REF_I14_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_INSURANCE_GROUP
        """
    ...
    def insurance(
        self,
        insurance: REF_I14_INSURANCE_GROUP | tuple[REF_I14_INSURANCE_GROUP, ...] | None,
    ):
        """
        id: INSURANCE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: REF_I14_INSURANCE_GROUP.None | tuple[REF_I14_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_INSURANCE_GROUP
        """
    ...
    def procedure(self) -> tuple[REF_I14_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: REF_I14_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[REF_I14_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: REF_I14_PROCEDURE_GROUP | tuple[REF_I14_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: REF_I14_PROCEDURE_GROUP.None | tuple[REF_I14_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_PROCEDURE_GROUP
        """
    ...
    def observation(self) -> tuple[REF_I14_OBSERVATION_GROUP, ...] | tuple[None]:
        """
        id: REF_I14_OBSERVATION_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[REF_I14_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_OBSERVATION_GROUP
        """
    ...
    def observation(
        ...
        ---
        param_type: REF_I14_OBSERVATION_GROUP.None | tuple[REF_I14_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_OBSERVATION_GROUP
        """
    ...
    @property  # get REF_I14_PATIENT_VISIT_GROUP.None
    def patient_visit(self) -> REF_I14_PATIENT_VISIT_GROUP | None:
        """
        id: REF_I14_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: REF_I14_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_PATIENT_VISIT_GROUP
        """
        return self._c_data[15][0]

    @patient_visit.setter  # set REF_I14_PATIENT_VISIT_GROUP.None
    def patient_visit(self, patient_v_isit: REF_I14_PATIENT_VISIT_GROUP | None):
        """
        id: REF_I14_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: REF_I14_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/REF_I14_PATIENT_VISIT_GROUP
        """
