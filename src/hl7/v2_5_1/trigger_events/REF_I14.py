...
from utils.hl7.v2_5_1.segment_groups import (
    REF_I14_PROVIDER_CONTACT_GROUP, REF_I14_INSURANCE_GROUP, REF_I14_AUTHORIZATION_CONTACT_GROUP, REF_I14_PROCEDURE_GROUP, REF_I14_PATIENT_VISIT_GROUP, REF_I14_OBSERVATION_GROUP
)
