...
from ..segment_groups.ROR_ROR_DEFINITION_GROUP import ROR_ROR_DEFINITION_GROUP


"""
Pharmacy/Treatment Order Response - ROR_ROR
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ROR_ROR TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ROR_ROR
from utils.hl7.v2_5_1.segments import (
    ERR, DSC, SFT, MSA, MSH
)
from utils.hl7.v2_5_1.segment_groups import (
    ROR_ROR_DEFINITION_GROUP
)

ror_ror = ROR_ROR(  #  - This query/response pair is retained for backward compatibility only
    message_header=msh,  # MSH(...)  # Required.
    message_acknowledgment=msa,  # MSA(...)  # Required.
    error=None,  # ERR(...) 
    software_segment=None,  # SFT(...) 
    definition=ror_ror_definition_group,  # ROR_ROR_DEFINITION_GROUP(...)  # Required.
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::ROR_ROR TEMPLATE-----
"""


class ROR_ROR(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ROR_ROR"""
    _hl7_name = """Pharmacy/Treatment Order Response"""
    _hl7_description = """This query/response pair is retained for backward compatibility only"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ROR_ROR"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 1)
    _c_usage = ("R", "R", "O", "O", "R", "O")
    _c_aliases = ("1", "2", "3", "4", "None", "13")
    _c_components = (MSH, MSA, ERR, SFT, ROR_ROR_DEFINITION_GROUP, DSC)
    ...
    def __init__(
        ...
        | tuple[ROR_ROR_DEFINITION_GROUP, ...],  #  Required. (QRD.5, QRF.6, ...)
        ...
        """
         - `ROR_ROR <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ROR_ROR>`_
    ...
    def definition(self) -> tuple[ROR_ROR_DEFINITION_GROUP, ...]:
        """
        id: ROR_ROR_DEFINITION_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[ROR_ROR_DEFINITION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ROR_ROR_DEFINITION_GROUP
        """
    ...
    def definition(
        self,
        definition: ROR_ROR_DEFINITION_GROUP | tuple[ROR_ROR_DEFINITION_GROUP, ...],
    ):
        """
        id: DEFINITION SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: ROR_ROR_DEFINITION_GROUP.None | tuple[ROR_ROR_DEFINITION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ROR_ROR_DEFINITION_GROUP
        """
