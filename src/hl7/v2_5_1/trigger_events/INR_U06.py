...
"""
Automated equipment inventory request - INR_U06
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::INR_U06 TEMPLATE-----
...
-----END TRIGGER_EVENT::INR_U06 TEMPLATE-----
"""


class INR_U06(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """INR_U06"""
    _hl7_name = """Automated equipment inventory request"""
    _hl7_description = """This message is used to request information about inventory items from one application to another (e"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/INR_U06"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `INR_U06 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/INR_U06>`_
