...
"""
Cancel Patient Returns from a Leave of Absence - ADT_A53
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A53 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A53
from utils.hl7.v2_5_1.segments import (
    PV1, PD1, MSH, SFT, PID, EVN, PV2
)

adt_a53 = ADT_A53(  #  - The A53 event is sent when an A22 (patient returns from “leave of absence”) event is cancelled, either because of erroneous entry of the A22 event or because of a decision not to return the patient from “leave of absence” after all
...
-----END TRIGGER_EVENT::ADT_A53 TEMPLATE-----
"""


class ADT_A53(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A53"""
    _hl7_name = """Cancel Patient Returns from a Leave of Absence"""
    _hl7_description = """The A53 event is sent when an A22 (patient returns from “leave of absence”) event is cancelled, either because of erroneous entry of the A22 event or because of a decision not to return the patient from “leave of absence” after all"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A53"""
    ...
    def __init__(
        ...
        """
         - `ADT_A53 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A53>`_
