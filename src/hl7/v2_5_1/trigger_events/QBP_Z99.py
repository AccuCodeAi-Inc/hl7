...
"""
Query by Parameter - Who Am I - QBP_Z99
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Z99 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Z99
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, RDF, SFT, RCP, DSC
)

qbp_z99 = QBP_Z99(  #  - The purpose of this query/response is to find the identity of the patient for specified medical record number(s)
...
-----END TRIGGER_EVENT::QBP_Z99 TEMPLATE-----
"""


class QBP_Z99(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Z99"""
    _hl7_name = """Query by Parameter - Who Am I"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z99"""
    ...
    def __init__(
        ...
        """
         - `QBP_Z99 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z99>`_
