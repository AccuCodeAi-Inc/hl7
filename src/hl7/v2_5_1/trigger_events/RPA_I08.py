...
"""
Request for treatment authorization information acknowledgement - RPA_I08
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RPA_I08 TEMPLATE-----
...
from utils.hl7.v2_5_1.segment_groups import (
    RPA_I08_AUTHORIZATION_GROUP, RPA_I08_INSURANCE_GROUP, RPA_I08_OBSERVATION_GROUP, RPA_I08_VISIT_GROUP, RPA_I08_PROCEDURE_GROUP, RPA_I08_PROVIDER_GROUP
)
...
rpa_i08 = RPA_I08(  #  - This event triggers a message to be sent from a healthcare provider to a payor requesting authorization to perform specific medical procedures or tests on a given patient
    ...
    authorization=None,  # RPA_I08_AUTHORIZATION_GROUP(...) 
    provider=rpa_i08_provider_group,  # RPA_I08_PROVIDER_GROUP(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    next_of_kin_or_associated_parties=None,  # NK1(...) 
    guarantor=None,  # GT1(...) 
    insurance=None,  # RPA_I08_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    diagnosis=None,  # DG1(...) 
    diagnosis_related_group=None,  # DRG(...) 
    patient_allergy_information=None,  # AL1(...) 
    procedure=rpa_i08_procedure_group,  # RPA_I08_PROCEDURE_GROUP(...)  # Required.
    observation=None,  # RPA_I08_OBSERVATION_GROUP(...) 
    visit=None,  # RPA_I08_VISIT_GROUP(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT::RPA_I08 TEMPLATE-----
"""


class RPA_I08(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RPA_I08"""
    _hl7_name = """Request for treatment authorization information acknowledgement"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RPA_I08"""
    ...
    _c_components = (MSH, SFT, MSA, RF1, RPA_I08_AUTHORIZATION_GROUP, RPA_I08_PROVIDER_GROUP, PID, NK1, GT1, RPA_I08_INSURANCE_GROUP, ACC, DG1, DRG, AL1, RPA_I08_PROCEDURE_GROUP, RPA_I08_OBSERVATION_GROUP, RPA_I08_VISIT_GROUP, NTE)
    ...
    def __init__(
        ...
        | tuple[RPA_I08_PROVIDER_GROUP, ...],  #  Required. (PRD.7, CTD.8, ...)
        patient_identification: PID,  #  Required. PID.9
        procedure: RPA_I08_PROCEDURE_GROUP
        | tuple[RPA_I08_PROCEDURE_GROUP, ...],  #  Required. (PR1.19, ...)
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        referral_information: RF1 | None = None,  #  RF1.4
        authorization: RPA_I08_AUTHORIZATION_GROUP | None = None,  #  AUT.5, CTD.6
        next_of_kin_or_associated_parties: NK1
        | tuple[NK1, ...]
        | None = None,  #  NK1.10
        guarantor: GT1 | tuple[GT1, ...] | None = None,  #  GT1.11
        insurance: RPA_I08_INSURANCE_GROUP
        | tuple[RPA_I08_INSURANCE_GROUP, ...]
        ...
        | tuple[RPA_I08_OBSERVATION_GROUP, ...]
        | None = None,  #  (OBR.22, NTE.23, ...)
        visit: RPA_I08_VISIT_GROUP | None = None,  #  PV1.26, PV2.27
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.28
    ):
        """
         - `RPA_I08 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RPA_I08>`_
    ...
    @property  # get RPA_I08_AUTHORIZATION_GROUP.None
    def authorization(self) -> RPA_I08_AUTHORIZATION_GROUP | None:
        """
        id: RPA_I08_AUTHORIZATION_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RPA_I08_AUTHORIZATION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_AUTHORIZATION_GROUP
        """
        return self._c_data[4][0]

    @authorization.setter  # set RPA_I08_AUTHORIZATION_GROUP.None
    def authorization(self, authorization: RPA_I08_AUTHORIZATION_GROUP | None):
        """
        id: RPA_I08_AUTHORIZATION_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RPA_I08_AUTHORIZATION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_AUTHORIZATION_GROUP
        """
    ...
    def provider(self) -> tuple[RPA_I08_PROVIDER_GROUP, ...]:
        """
        id: RPA_I08_PROVIDER_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RPA_I08_PROVIDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_PROVIDER_GROUP
        """
        return self._c_data[5]

    @provider.setter  # set PROVIDER
    def provider(
        self, provider: RPA_I08_PROVIDER_GROUP | tuple[RPA_I08_PROVIDER_GROUP, ...]
    ):
        """
        id: PROVIDER SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RPA_I08_PROVIDER_GROUP.None | tuple[RPA_I08_PROVIDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_PROVIDER_GROUP
        """
    ...
    def insurance(self) -> tuple[RPA_I08_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: RPA_I08_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RPA_I08_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_INSURANCE_GROUP
        """
    ...
    def insurance(
        self,
        insurance: RPA_I08_INSURANCE_GROUP | tuple[RPA_I08_INSURANCE_GROUP, ...] | None,
    ):
        """
        id: INSURANCE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: RPA_I08_INSURANCE_GROUP.None | tuple[RPA_I08_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_INSURANCE_GROUP
        """
    ...
    def procedure(self) -> tuple[RPA_I08_PROCEDURE_GROUP, ...]:
        """
        id: RPA_I08_PROCEDURE_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RPA_I08_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_PROCEDURE_GROUP
        """
        return self._c_data[14]

    @procedure.setter  # set PROCEDURE
    def procedure(
        self, procedure: RPA_I08_PROCEDURE_GROUP | tuple[RPA_I08_PROCEDURE_GROUP, ...]
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RPA_I08_PROCEDURE_GROUP.None | tuple[RPA_I08_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_PROCEDURE_GROUP
        """
    ...
    def observation(self) -> tuple[RPA_I08_OBSERVATION_GROUP, ...] | tuple[None]:
        """
        id: RPA_I08_OBSERVATION_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RPA_I08_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_OBSERVATION_GROUP
        """
    ...
    def observation(
        ...
        ---
        param_type: RPA_I08_OBSERVATION_GROUP.None | tuple[RPA_I08_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_OBSERVATION_GROUP
        """
    ...
    @property  # get RPA_I08_VISIT_GROUP.None
    def visit(self) -> RPA_I08_VISIT_GROUP | None:
        """
        id: RPA_I08_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RPA_I08_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_VISIT_GROUP
        """
        return self._c_data[16][0]

    @visit.setter  # set RPA_I08_VISIT_GROUP.None
    def visit(self, v_isit: RPA_I08_VISIT_GROUP | None):
        """
        id: RPA_I08_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RPA_I08_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RPA_I08_VISIT_GROUP
        """
