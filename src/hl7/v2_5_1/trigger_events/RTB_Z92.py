...
from ..segment_groups.RTB_Z92_ROW_DEFINITION_GROUP import RTB_Z92_ROW_DEFINITION_GROUP


"""
Who Am I Response - RTB_Z92
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RTB_Z92 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RTB_Z92
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, SFT, ERR, DSC, QAK, MSA
)
from utils.hl7.v2_5_1.segment_groups import (
    RTB_Z92_ROW_DEFINITION_GROUP
)

rtb_z92 = RTB_Z92(  #  - The purpose of this query/response pair is to find the identity of the patient for specified medical record number(s)
    ...
    row_definition=None,  # RTB_Z92_ROW_DEFINITION_GROUP(...) 
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RTB_Z92 TEMPLATE-----
"""


class RTB_Z92(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RTB_Z92"""
    _hl7_name = """Who Am I Response"""
    _hl7_description = """The purpose of this query/response pair is to find the identity of the patient for specified medical record number(s)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_Z92"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 1, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "9")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RTB_Z92_ROW_DEFINITION_GROUP, DSC)
    ...
    def __init__(
        ...
        row_definition: RTB_Z92_ROW_DEFINITION_GROUP | None = None,  #  RDF.7, RDT.8
        continuation_pointer: DSC | None = None,  #  DSC.9
    ):
        """
         - `RTB_Z92 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_Z92>`_
    ...
    @property  # get RTB_Z92_ROW_DEFINITION_GROUP.None
    def row_definition(self) -> RTB_Z92_ROW_DEFINITION_GROUP | None:
        """
        id: RTB_Z92_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RTB_Z92_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RTB_Z92_ROW_DEFINITION_GROUP
        """
        return self._c_data[6][0]

    @row_definition.setter  # set RTB_Z92_ROW_DEFINITION_GROUP.None
    def row_definition(self, row_definition: RTB_Z92_ROW_DEFINITION_GROUP | None):
        """
        id: RTB_Z92_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RTB_Z92_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RTB_Z92_ROW_DEFINITION_GROUP
        """
