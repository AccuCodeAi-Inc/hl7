...
from ..segment_groups.SIU_S20_PATIENT_GROUP import SIU_S20_PATIENT_GROUP
from ..segments.SCH import SCH
from ..segment_groups.SIU_S20_RESOURCES_GROUP import SIU_S20_RESOURCES_GROUP
...
"""
Notification of Cancellation of Service/Resource on Appointment - SIU_S20
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::SIU_S20 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SIU_S20
from utils.hl7.v2_5_1.segments import (
    SCH, TQ1, NTE, MSH
)
from utils.hl7.v2_5_1.segment_groups import (
    SIU_S20_PATIENT_GROUP, SIU_S20_RESOURCES_GROUP
)

siu_s20 = SIU_S20(  #  - This trigger event notifies other applications that a service or resource has been removed from an existing scheduled appointment that has not yet begun
    message_header=msh,  # MSH(...)  # Required.
    scheduling_activity_information=sch,  # SCH(...)  # Required.
    timing_or_quantity=None,  # TQ1(...) 
    notes_and_comments=None,  # NTE(...) 
    patient=None,  # SIU_S20_PATIENT_GROUP(...) 
    resources=siu_s20_resources_group,  # SIU_S20_RESOURCES_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::SIU_S20 TEMPLATE-----
"""


class SIU_S20(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """SIU_S20"""
    _hl7_name = """Notification of Cancellation of Service/Resource on Appointment"""
    _hl7_description = """This trigger event notifies other applications that a service or resource has been removed from an existing scheduled appointment that has not yet begun"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SIU_S20"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 65535)
    _c_usage = ("R", "R", "O", "O", "O", "R")
    _c_aliases = ("1", "2", "3", "4", "None", "None")
    _c_components = (MSH, SCH, TQ1, NTE, SIU_S20_PATIENT_GROUP, SIU_S20_RESOURCES_GROUP)
    ...
    def __init__(
        ...
        | tuple[SIU_S20_RESOURCES_GROUP, ...],  #  Required. (RGS.11, ...)
        ...
        | tuple[SIU_S20_PATIENT_GROUP, ...]
        | None = None,  #  (PID.5, PD1.6, PV1.7, PV2.8, OBX.9, DG1.10, ...)
    ):
        """
         - `SIU_S20 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SIU_S20>`_
    ...
    def patient(self) -> tuple[SIU_S20_PATIENT_GROUP, ...] | tuple[None]:
        """
        id: SIU_S20_PATIENT_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[SIU_S20_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S20_PATIENT_GROUP
        """
        return self._c_data[4]

    @patient.setter  # set PATIENT
    def patient(
        self, patient: SIU_S20_PATIENT_GROUP | tuple[SIU_S20_PATIENT_GROUP, ...] | None
    ):
        """
        id: PATIENT SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: SIU_S20_PATIENT_GROUP.None | tuple[SIU_S20_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S20_PATIENT_GROUP
        """
    ...
    def resources(self) -> tuple[SIU_S20_RESOURCES_GROUP, ...]:
        """
        id: SIU_S20_RESOURCES_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[SIU_S20_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S20_RESOURCES_GROUP
        """
        return self._c_data[5]

    @resources.setter  # set RESOURCES
    def resources(
        self, resources: SIU_S20_RESOURCES_GROUP | tuple[SIU_S20_RESOURCES_GROUP, ...]
    ):
        """
        id: RESOURCES SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: SIU_S20_RESOURCES_GROUP.None | tuple[SIU_S20_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SIU_S20_RESOURCES_GROUP
        """
