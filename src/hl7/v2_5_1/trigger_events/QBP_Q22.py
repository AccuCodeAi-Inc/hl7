...
"""
Find Candidates Query - QBP_Q22
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Q22 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Q22
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, SFT, RCP, DSC
)

qbp_q22 = QBP_Q22(  #  - This query/response is designed for interaction between a client system and an MPI (Master Person Index)
...
-----END TRIGGER_EVENT::QBP_Q22 TEMPLATE-----
"""


class QBP_Q22(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Q22"""
    _hl7_name = """Find Candidates Query"""
    _hl7_description = """This query/response is designed for interaction between a client system and an MPI (Master Person Index)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q22"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QBP_Q22 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q22>`_
