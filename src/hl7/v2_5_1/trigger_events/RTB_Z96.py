...
from ..segment_groups.RTB_Z96_ROW_DEFINITION_GROUP import RTB_Z96_ROW_DEFINITION_GROUP
...
"""
Tabular Dispense History Response - RTB_Z96
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RTB_Z96 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RTB_Z96
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, SFT, ERR, DSC, QAK, MSA
)
from utils.hl7.v2_5_1.segment_groups import (
    RTB_Z96_ROW_DEFINITION_GROUP
)

rtb_z96 = RTB_Z96(  #  - The purpose of this query/response pair is to retrieve patient pharmacy dispense history information from the Server
    ...
    row_definition=None,  # RTB_Z96_ROW_DEFINITION_GROUP(...) 
    continuation_pointer=None,  # DSC(...) 
)

-----END TRIGGER_EVENT::RTB_Z96 TEMPLATE-----
"""


class RTB_Z96(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_Z96"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 1, 1, 1)
    _c_usage = ("R", "O", "R", "O", "R", "R", "O", "O")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "9")
    _c_components = (MSH, SFT, MSA, ERR, QAK, QPD, RTB_Z96_ROW_DEFINITION_GROUP, DSC)
    ...
    def __init__(
        ...
        row_definition: RTB_Z96_ROW_DEFINITION_GROUP | None = None,  #  RDF.7, RDT.8
        continuation_pointer: DSC | None = None,  #  DSC.9
    ):
        """
         - `RTB_Z96 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_Z96>`_
    ...
    @property  # get RTB_Z96_ROW_DEFINITION_GROUP.None
    def row_definition(self) -> RTB_Z96_ROW_DEFINITION_GROUP | None:
        """
        id: RTB_Z96_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RTB_Z96_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RTB_Z96_ROW_DEFINITION_GROUP
        """
        return self._c_data[6][0]

    @row_definition.setter  # set RTB_Z96_ROW_DEFINITION_GROUP.None
    def row_definition(self, row_definition: RTB_Z96_ROW_DEFINITION_GROUP | None):
        """
        id: RTB_Z96_ROW_DEFINITION_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RTB_Z96_ROW_DEFINITION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RTB_Z96_ROW_DEFINITION_GROUP
        """
