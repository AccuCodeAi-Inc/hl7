...
"""
Tabular Dispense History Query - QBP_Z95
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Z95 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Z95
from utils.hl7.v2_5_1.segments import (
    QPD, MSH, RDF, SFT, RCP, DSC
)

qbp_z95 = QBP_Z95(  #  - The purpose of this query/response pair is to retrieve patient pharmacy dispense history information from the Server
...
-----END TRIGGER_EVENT::QBP_Z95 TEMPLATE-----
"""


class QBP_Z95(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Z95"""
    _hl7_name = """Tabular Dispense History Query"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z95"""
    ...
    def __init__(
        ...
        """
         - `QBP_Z95 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z95>`_
