...
"""
Change Patient Account Number - ADT_A49
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A49 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A49
from utils.hl7.v2_5_1.segments import (
    MRG, PID, SFT, EVN, MSH, PD1
)

adt_a49 = ADT_A49(  #  - A change has been done at the account identifier level
...
-----END TRIGGER_EVENT::ADT_A49 TEMPLATE-----
"""


class ADT_A49(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A49"""
    _hl7_name = """Change Patient Account Number"""
    _hl7_description = """A change has been done at the account identifier level"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A49"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A49 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A49>`_
