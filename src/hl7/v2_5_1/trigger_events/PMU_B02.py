...
"""
Add personnel record - PMU_B02
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::PMU_B02 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import PMU_B02
from utils.hl7.v2_5_1.segments import (
    AFF, STF, ORG, EDU, LAN, CER, MSH, SFT, PRA, EVN
)

pmu_b02 = PMU_B02(  #  - An event B02 signals to update the record with the healthcare administration information about an individual healthcare practitioner
...
-----END TRIGGER_EVENT::PMU_B02 TEMPLATE-----
"""


class PMU_B02(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    ...
    _hl7_description = """An event B02 signals to update the record with the healthcare administration information about an individual healthcare practitioner"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PMU_B02"""
    ...
    def __init__(
        ...
        """
         - `PMU_B02 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PMU_B02>`_
