...
from utils.hl7.v2_5_1.segment_groups import (
    RQA_I08_PROVIDER_GROUP, RQA_I08_AUTHORIZATION_GROUP, RQA_I08_PROCEDURE_GROUP, RQA_I08_OBSERVATION_GROUP, RQA_I08_GUARANTOR_INSURANCE_GROUP, RQA_I08_VISIT_GROUP
)
