...
"""
Query for master file record - MFQ_M01
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::MFQ_M01 TEMPLATE-----
...
-----END TRIGGER_EVENT::MFQ_M01 TEMPLATE-----
"""


class MFQ_M01(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """MFQ_M01"""
    _hl7_name = """Query for master file record"""
    _hl7_description = """The MFQ transaction allows a system to query for a particular record or group records (defined by the primary key) in a particular master file"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MFQ_M01"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `MFQ_M01 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MFQ_M01>`_
