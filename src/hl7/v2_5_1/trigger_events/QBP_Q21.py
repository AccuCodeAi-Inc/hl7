...
"""
Get Person Demographics Query - QBP_Q21
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Q21 TEMPLATE-----
...
-----END TRIGGER_EVENT::QBP_Q21 TEMPLATE-----
"""


class QBP_Q21(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QBP_Q21"""
    _hl7_name = """Get Person Demographics Query"""
    _hl7_description = """This query/response is designed for interaction between a client system and an MPI (Master Person Index)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q21"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QBP_Q21 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Q21>`_
