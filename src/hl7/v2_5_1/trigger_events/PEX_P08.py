...
"""
Unsolicited update individual product experience report - PEX_P08
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::PEX_P08 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import PEX_P08
from utils.hl7.v2_5_1.segments import (
    NTE, PD1, MSH, SFT, PID, EVN
)
...
pex_p08 = PEX_P08(  #  - The primary application of this message is to transfer information related to an adverse event occurring while a patient was exposed to a product
    ...
    visit=None,  # PEX_P08_VISIT_GROUP(...) 
    experience=pex_p08_experience_group,  # PEX_P08_EXPERIENCE_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::PEX_P08 TEMPLATE-----
"""


class PEX_P08(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """PEX_P08"""
    _hl7_name = """Unsolicited update individual product experience report"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PEX_P08"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 65535, 1, 65535)
    _c_usage = ("R", "O", "R", "R", "O", "O", "O", "R")
    _c_aliases = ("1", "2", "3", "4", "5", "6", "None", "None")
    _c_components = (MSH, SFT, EVN, PID, PD1, NTE, PEX_P08_VISIT_GROUP, PEX_P08_EXPERIENCE_GROUP)
    ...
    def __init__(
        ...
        | tuple[PEX_P08_EXPERIENCE_GROUP, ...],  #  Required. (PES.9, ...)
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        patient_additional_demographic: PD1 | None = None,  #  PD1.5
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.6
        visit: PEX_P08_VISIT_GROUP | None = None,  #  PV1.7, PV2.8
    ):
        """
         - `PEX_P08 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PEX_P08>`_
    ...
    @property  # get PEX_P08_VISIT_GROUP.None
    def visit(self) -> PEX_P08_VISIT_GROUP | None:
        """
        id: PEX_P08_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: PEX_P08_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PEX_P08_VISIT_GROUP
        """
        return self._c_data[6][0]

    @visit.setter  # set PEX_P08_VISIT_GROUP.None
    def visit(self, v_isit: PEX_P08_VISIT_GROUP | None):
        """
        id: PEX_P08_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: PEX_P08_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PEX_P08_VISIT_GROUP
        """
    ...
    def experience(self) -> tuple[PEX_P08_EXPERIENCE_GROUP, ...]:
        """
        id: PEX_P08_EXPERIENCE_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[PEX_P08_EXPERIENCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PEX_P08_EXPERIENCE_GROUP
        """
    ...
    def experience(
        self,
        experience: PEX_P08_EXPERIENCE_GROUP | tuple[PEX_P08_EXPERIENCE_GROUP, ...],
    ):
        """
        id: EXPERIENCE SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: PEX_P08_EXPERIENCE_GROUP.None | tuple[PEX_P08_EXPERIENCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PEX_P08_EXPERIENCE_GROUP
        """
