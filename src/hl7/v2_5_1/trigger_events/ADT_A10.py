...
"""
Patient Arriving - Tracking - ADT_A10
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A10 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A10
from utils.hl7.v2_5_1.segments import (
    OBX, PID, MSH, PD1, PV1, PV2, DG1, DB1, SFT, EVN
)

adt_a10 = ADT_A10(  #  - The A10 event is sent when a patient arrives at a new location in the healthcare facility (inpatient or outpatient)
...
-----END TRIGGER_EVENT::ADT_A10 TEMPLATE-----
"""


class ADT_A10(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A10"""
    _hl7_name = """Patient Arriving - Tracking"""
    _hl7_description = """The A10 event is sent when a patient arrives at a new location in the healthcare facility (inpatient or outpatient)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A10"""
    ...
    def __init__(
        ...
        """
         - `ADT_A10 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A10>`_
