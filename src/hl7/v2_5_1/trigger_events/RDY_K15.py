...
"""
Display Response in Response to QBP_Q15 - RDY_K15
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RDY_K15 TEMPLATE-----
...
-----END TRIGGER_EVENT::RDY_K15 TEMPLATE-----
"""


class RDY_K15(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RDY_K15"""
    _hl7_name = """Display Response in Response to QBP_Q15"""
    _hl7_description = """The RDY_K15 supports a Display Response to the QBP and contains the MSH, MSA, ERR, QAK, DSP, and the DSC"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RDY_K15"""
    ...
    def __init__(
        ...
        """
         - `RDY_K15 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RDY_K15>`_
