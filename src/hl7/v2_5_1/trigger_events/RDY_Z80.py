...
"""
Dispense Information Response - RDY_Z80
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RDY_Z80 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RDY_Z80
from utils.hl7.v2_5_1.segments import (
    QAK, ERR, MSA, QPD, DSC, DSP, MSH, SFT
)

rdy_z80 = RDY_Z80(  #  - The purpose of this query/response pair is to retrieve patient pharmacy dispense history information from the Server
...
-----END TRIGGER_EVENT::RDY_Z80 TEMPLATE-----
"""


class RDY_Z80(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RDY_Z80"""
    ...
    def __init__(
        ...
        """
         - `RDY_Z80 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RDY_Z80>`_
