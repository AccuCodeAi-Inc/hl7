...
"""
Cancel Pending Transfer - ADT_A26
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A26 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A26
from utils.hl7.v2_5_1.segments import (
    PV1, PD1, DB1, MSH, SFT, PID, EVN, OBX, PV2
)

adt_a26 = ADT_A26(  #  - The A26 event is sent when an A15 (pending transfer) event is cancelled, either because of erroneous entry of the A15 event or because of a decision not to transfer the patient after all
...
-----END TRIGGER_EVENT::ADT_A26 TEMPLATE-----
"""


class ADT_A26(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A26"""
    _hl7_name = """Cancel Pending Transfer"""
    _hl7_description = """The A26 event is sent when an A15 (pending transfer) event is cancelled, either because of erroneous entry of the A15 event or because of a decision not to transfer the patient after all"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A26"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A26 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A26>`_
