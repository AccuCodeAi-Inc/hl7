...
from ..segment_groups.MDM_T09_COMMON_ORDER_GROUP import MDM_T09_COMMON_ORDER_GROUP
from ..segments.EVN import EVN


"""
Document replacement notification - MDM_T09
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::MDM_T09 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import MDM_T09
from utils.hl7.v2_5_1.segments import (
    PID, MSH, PV1, SFT, TXA, EVN
)
from utils.hl7.v2_5_1.segment_groups import (
    MDM_T09_COMMON_ORDER_GROUP
)

mdm_t09 = MDM_T09(  #  - This is a notification of replacement to a document without the accompanying content
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    event_type=evn,  # EVN(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    patient_visit=pv1,  # PV1(...)  # Required.
    common_order=None,  # MDM_T09_COMMON_ORDER_GROUP(...) 
    transcription_document_header=txa,  # TXA(...)  # Required.
)

-----END TRIGGER_EVENT::MDM_T09 TEMPLATE-----
"""


class MDM_T09(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """MDM_T09"""
    _hl7_name = """Document replacement notification"""
    _hl7_description = """This is a notification of replacement to a document without the accompanying content"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T09"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 65535, 1)
    _c_usage = ("R", "O", "R", "R", "R", "O", "R")
    _c_aliases = ("1", "2", "3", "4", "5", "None", "11")
    _c_components = (MSH, SFT, EVN, PID, PV1, MDM_T09_COMMON_ORDER_GROUP, TXA)
    ...
    def __init__(
        ...
        common_order: MDM_T09_COMMON_ORDER_GROUP
        | tuple[MDM_T09_COMMON_ORDER_GROUP, ...]
        | None = None,  #  (ORC.6, OBR.9, NTE.10, ...)
    ):
        """
                 - `MDM_T09 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T09>`_
    ...
    def common_order(self) -> tuple[MDM_T09_COMMON_ORDER_GROUP, ...] | tuple[None]:
        """
        id: MDM_T09_COMMON_ORDER_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[MDM_T09_COMMON_ORDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MDM_T09_COMMON_ORDER_GROUP
        """
    ...
    def common_order(
        ...
        ---
        param_type: MDM_T09_COMMON_ORDER_GROUP.None | tuple[MDM_T09_COMMON_ORDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MDM_T09_COMMON_ORDER_GROUP
        """
