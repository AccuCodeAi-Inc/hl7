...
"""
Patient goal query - QRY_PC9
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QRY_PC9 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QRY_PC9
from utils.hl7.v2_5_1.segments import (
    QRF, QRD, SFT, MSH
)

qry_pc9 = QRY_PC9(  #  - The following trigger/message event is served by QRY (a query from another system)
...
-----END TRIGGER_EVENT::QRY_PC9 TEMPLATE-----
"""


class QRY_PC9(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """QRY_PC9"""
    _hl7_name = """Patient goal query"""
    _hl7_description = """The following trigger/message event is served by QRY (a query from another system)"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_PC9"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1)
    _c_usage = ("R", "O", "R", "O")
    _c_aliases = ("1", "2", "3", "4")
    ...
    def __init__(
        ...
        """
         - `QRY_PC9 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QRY_PC9>`_
