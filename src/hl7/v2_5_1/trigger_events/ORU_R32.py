...
"""
Unsolicited Pre-Ordered Point-Of-Care Observation - ORU_R32
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ORU_R32 TEMPLATE-----
...
from utils.hl7.v2_5_1.segment_groups import (
    ORU_R32_OBSERVATION_GROUP, ORU_R32_VISIT_GROUP, ORU_R32_TIMING_QTY_GROUP
)
...
oru_r32 = ORU_R32(  #  - This event trigger instructs the receiver to place the result with the order information included in the message
    ...
    visit=None,  # ORU_R32_VISIT_GROUP(...) 
    common_order=orc,  # ORC(...)  # Required.
    observation_request=obr,  # OBR(...)  # Required.
    notes_and_comments=None,  # NTE(...) 
    timing_qty=None,  # ORU_R32_TIMING_QTY_GROUP(...) 
    observation=oru_r32_observation_group,  # ORU_R32_OBSERVATION_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::ORU_R32 TEMPLATE-----
"""


class ORU_R32(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ORU_R32"""
    _hl7_name = """Unsolicited Pre-Ordered Point-Of-Care Observation"""
    _hl7_description = """This event trigger instructs the receiver to place the result with the order information included in the message"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORU_R32"""
    ...
    _c_components = (MSH, SFT, PID, PD1, ORU_R32_VISIT_GROUP, ORC, OBR, NTE, ORU_R32_TIMING_QTY_GROUP, ORU_R32_OBSERVATION_GROUP)
    ...
    def __init__(
        ...
        | tuple[ORU_R32_OBSERVATION_GROUP, ...],  #  Required. (OBX.12, NTE.13, ...)
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        patient_additional_demographic: PD1 | None = None,  #  PD1.4
        visit: ORU_R32_VISIT_GROUP | None = None,  #  PV1.5, PV2.6
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.9
        timing_qty: ORU_R32_TIMING_QTY_GROUP
        | tuple[ORU_R32_TIMING_QTY_GROUP, ...]
        | None = None,  #  (TQ1.10, TQ2.11, ...)
    ):
        """
         - `ORU_R32 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORU_R32>`_
    ...
    @property  # get ORU_R32_VISIT_GROUP.None
    def visit(self) -> ORU_R32_VISIT_GROUP | None:
        """
        id: ORU_R32_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: ORU_R32_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORU_R32_VISIT_GROUP
        """
        return self._c_data[4][0]

    @visit.setter  # set ORU_R32_VISIT_GROUP.None
    def visit(self, v_isit: ORU_R32_VISIT_GROUP | None):
        """
        id: ORU_R32_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: ORU_R32_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORU_R32_VISIT_GROUP
        """
    ...
    def timing_qty(self) -> tuple[ORU_R32_TIMING_QTY_GROUP, ...] | tuple[None]:
        """
        id: ORU_R32_TIMING_QTY_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ORU_R32_TIMING_QTY_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORU_R32_TIMING_QTY_GROUP
        """
    ...
    def timing_qty(
        ...
        ---
        param_type: ORU_R32_TIMING_QTY_GROUP.None | tuple[ORU_R32_TIMING_QTY_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORU_R32_TIMING_QTY_GROUP
        """
    ...
    def observation(self) -> tuple[ORU_R32_OBSERVATION_GROUP, ...]:
        """
        id: ORU_R32_OBSERVATION_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[ORU_R32_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORU_R32_OBSERVATION_GROUP
        """
    ...
    def observation(
        self,
        observation: ORU_R32_OBSERVATION_GROUP | tuple[ORU_R32_OBSERVATION_GROUP, ...],
    ):
        """
        id: OBSERVATION SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: ORU_R32_OBSERVATION_GROUP.None | tuple[ORU_R32_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORU_R32_OBSERVATION_GROUP
        """
