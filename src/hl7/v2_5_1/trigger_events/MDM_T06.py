...
from ..segment_groups.MDM_T06_COMMON_ORDER_GROUP import MDM_T06_COMMON_ORDER_GROUP
from ..segments.SFT import SFT
from ..segments.MSH import MSH
from ..segments.TXA import TXA
from ..segments.PID import PID
from ..segment_groups.MDM_T06_OBXNTE_GROUP import MDM_T06_OBXNTE_GROUP
from ..segments.EVN import EVN


"""
Document addendum notification and content - MDM_T06
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::MDM_T06 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import MDM_T06
from utils.hl7.v2_5_1.segments import (
    PID, MSH, PV1, SFT, TXA, EVN
)
from utils.hl7.v2_5_1.segment_groups import (
    MDM_T06_COMMON_ORDER_GROUP, MDM_T06_OBXNTE_GROUP
)

mdm_t06 = MDM_T06(  #  - This is a notification of an addendum to a document with the accompanying content
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    event_type=evn,  # EVN(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    patient_visit=pv1,  # PV1(...)  # Required.
    common_order=None,  # MDM_T06_COMMON_ORDER_GROUP(...) 
    transcription_document_header=txa,  # TXA(...)  # Required.
    obxnte=mdm_t06_obxnte_group,  # MDM_T06_OBXNTE_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT::MDM_T06 TEMPLATE-----
"""


class MDM_T06(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """MDM_T06"""
    _hl7_name = """Document addendum notification and content"""
    _hl7_description = """This is a notification of an addendum to a document with the accompanying content"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T06"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 1, 65535, 1, 65535)
    _c_usage = ("R", "O", "R", "R", "R", "O", "R", "R")
    _c_aliases = ("1", "2", "3", "4", "5", "None", "11", "None")
    _c_components = (MSH, SFT, EVN, PID, PV1, MDM_T06_COMMON_ORDER_GROUP, TXA, MDM_T06_OBXNTE_GROUP)
    ...
    def __init__(
        ...
        obxnte: MDM_T06_OBXNTE_GROUP
        | tuple[MDM_T06_OBXNTE_GROUP, ...],  #  Required. (OBX.12, NTE.13, ...)
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        common_order: MDM_T06_COMMON_ORDER_GROUP
        | tuple[MDM_T06_COMMON_ORDER_GROUP, ...]
        | None = None,  #  (ORC.6, OBR.9, NTE.10, ...)
    ):
        """
         - `MDM_T06 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T06>`_
    ...
    def common_order(self) -> tuple[MDM_T06_COMMON_ORDER_GROUP, ...] | tuple[None]:
        """
        id: MDM_T06_COMMON_ORDER_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[MDM_T06_COMMON_ORDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MDM_T06_COMMON_ORDER_GROUP
        """
    ...
    def common_order(
        ...
        ---
        param_type: MDM_T06_COMMON_ORDER_GROUP.None | tuple[MDM_T06_COMMON_ORDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MDM_T06_COMMON_ORDER_GROUP
        """
    ...
    @property  # get OBXNTE
    def obxnte(self) -> tuple[MDM_T06_OBXNTE_GROUP, ...]:
        """
        id: MDM_T06_OBXNTE_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[MDM_T06_OBXNTE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MDM_T06_OBXNTE_GROUP
        """
        return self._c_data[7]

    @obxnte.setter  # set OBXNTE
    def obxnte(self, obxnte: MDM_T06_OBXNTE_GROUP | tuple[MDM_T06_OBXNTE_GROUP, ...]):
        """
        id: OBXNTE SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: MDM_T06_OBXNTE_GROUP.None | tuple[MDM_T06_OBXNTE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MDM_T06_OBXNTE_GROUP
        """
