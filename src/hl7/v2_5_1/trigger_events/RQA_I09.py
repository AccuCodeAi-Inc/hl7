...
from ..segment_groups.RQA_I09_PROVIDER_GROUP import RQA_I09_PROVIDER_GROUP
from ..segment_groups.RQA_I09_AUTHORIZATION_GROUP import RQA_I09_AUTHORIZATION_GROUP
from ..segments.ACC import ACC
from ..segments.NK1 import NK1
from ..segment_groups.RQA_I09_GUARANTOR_INSURANCE_GROUP import (
    RQA_I09_GUARANTOR_INSURANCE_GROUP,
)
from ..segments.MSH import MSH
from ..segments.AL1 import AL1
from ..segments.RF1 import RF1
from ..segment_groups.RQA_I09_OBSERVATION_GROUP import RQA_I09_OBSERVATION_GROUP
from ..segment_groups.RQA_I09_PROCEDURE_GROUP import RQA_I09_PROCEDURE_GROUP
from ..segments.DRG import DRG
from ..segments.PID import PID
from ..segment_groups.RQA_I09_VISIT_GROUP import RQA_I09_VISIT_GROUP
from ..segments.DG1 import DG1
from ..segments.SFT import SFT


"""
Request for modification to an authorization - RQA_I09
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::RQA_I09 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RQA_I09
from utils.hl7.v2_5_1.segments import (
    NK1, DG1, ACC, AL1, NTE, PID, SFT, MSH, RF1, DRG
)
from utils.hl7.v2_5_1.segment_groups import (
    RQA_I09_VISIT_GROUP, RQA_I09_GUARANTOR_INSURANCE_GROUP, RQA_I09_PROCEDURE_GROUP, RQA_I09_PROVIDER_GROUP, RQA_I09_OBSERVATION_GROUP, RQA_I09_AUTHORIZATION_GROUP
)

rqa_i09 = RQA_I09(  #  - This event triggers a message sent from a healthcare provider to a payor requesting changes to a previously referenced authorization
    message_header=msh,  # MSH(...)  # Required.
    software_segment=None,  # SFT(...) 
    referral_information=None,  # RF1(...) 
    authorization=None,  # RQA_I09_AUTHORIZATION_GROUP(...) 
    provider=rqa_i09_provider_group,  # RQA_I09_PROVIDER_GROUP(...)  # Required.
    patient_identification=pid,  # PID(...)  # Required.
    next_of_kin_or_associated_parties=None,  # NK1(...) 
    guarantor_insurance=None,  # RQA_I09_GUARANTOR_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    diagnosis=None,  # DG1(...) 
    diagnosis_related_group=None,  # DRG(...) 
    patient_allergy_information=None,  # AL1(...) 
    procedure=None,  # RQA_I09_PROCEDURE_GROUP(...) 
    observation=None,  # RQA_I09_OBSERVATION_GROUP(...) 
    visit=None,  # RQA_I09_VISIT_GROUP(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT::RQA_I09 TEMPLATE-----
"""


class RQA_I09(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """RQA_I09"""
    _hl7_name = """Request for modification to an authorization"""
    _hl7_description = """This event triggers a message sent from a healthcare provider to a payor requesting changes to a previously referenced authorization"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I09"""
    ...
    _c_components = (MSH, SFT, RF1, RQA_I09_AUTHORIZATION_GROUP, RQA_I09_PROVIDER_GROUP, PID, NK1, RQA_I09_GUARANTOR_INSURANCE_GROUP, ACC, DG1, DRG, AL1, RQA_I09_PROCEDURE_GROUP, RQA_I09_OBSERVATION_GROUP, RQA_I09_VISIT_GROUP, NTE)
    ...
    def __init__(
        ...
        provider: RQA_I09_PROVIDER_GROUP
        | tuple[RQA_I09_PROVIDER_GROUP, ...],  #  Required. (PRD.6, CTD.7, ...)
        patient_identification: PID,  #  Required. PID.8
        software_segment: SFT | tuple[SFT, ...] | None = None,  #  SFT.2
        referral_information: RF1 | None = None,  #  RF1.3
        authorization: RQA_I09_AUTHORIZATION_GROUP | None = None,  #  AUT.4, CTD.5
        next_of_kin_or_associated_parties: NK1
        | tuple[NK1, ...]
        | None = None,  #  NK1.9
        guarantor_insurance: RQA_I09_GUARANTOR_INSURANCE_GROUP | None = None,  #  GT1.10
        ...
        | tuple[RQA_I09_PROCEDURE_GROUP, ...]
        | None = None,  #  (PR1.18, ...)
        observation: RQA_I09_OBSERVATION_GROUP
        | tuple[RQA_I09_OBSERVATION_GROUP, ...]
        | None = None,  #  (OBR.21, NTE.22, ...)
        visit: RQA_I09_VISIT_GROUP | None = None,  #  PV1.25, PV2.26
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.27
    ):
        """
         - `RQA_I09 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I09>`_
    ...
    @property  # get RQA_I09_AUTHORIZATION_GROUP.None
    def authorization(self) -> RQA_I09_AUTHORIZATION_GROUP | None:
        """
        id: RQA_I09_AUTHORIZATION_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RQA_I09_AUTHORIZATION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_AUTHORIZATION_GROUP
        """
        return self._c_data[3][0]

    @authorization.setter  # set RQA_I09_AUTHORIZATION_GROUP.None
    def authorization(self, authorization: RQA_I09_AUTHORIZATION_GROUP | None):
        """
        id: RQA_I09_AUTHORIZATION_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RQA_I09_AUTHORIZATION_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_AUTHORIZATION_GROUP
        """
    ...
    def provider(self) -> tuple[RQA_I09_PROVIDER_GROUP, ...]:
        """
        id: RQA_I09_PROVIDER_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RQA_I09_PROVIDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_PROVIDER_GROUP
        """
        return self._c_data[4]

    @provider.setter  # set PROVIDER
    def provider(
        self, provider: RQA_I09_PROVIDER_GROUP | tuple[RQA_I09_PROVIDER_GROUP, ...]
    ):
        """
        id: PROVIDER SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RQA_I09_PROVIDER_GROUP.None | tuple[RQA_I09_PROVIDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_PROVIDER_GROUP
        """
    ...
    @property  # get RQA_I09_GUARANTOR_INSURANCE_GROUP.None
    def guarantor_insurance(self) -> RQA_I09_GUARANTOR_INSURANCE_GROUP | None:
        """
        id: RQA_I09_GUARANTOR_INSURANCE_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RQA_I09_GUARANTOR_INSURANCE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_GUARANTOR_INSURANCE_GROUP
        """
        return self._c_data[7][0]

    @guarantor_insurance.setter  # set RQA_I09_GUARANTOR_INSURANCE_GROUP.None
    def guarantor_insurance(
        self, guarantor_insurance: RQA_I09_GUARANTOR_INSURANCE_GROUP | None
    ):
        """
        id: RQA_I09_GUARANTOR_INSURANCE_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RQA_I09_GUARANTOR_INSURANCE_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_GUARANTOR_INSURANCE_GROUP
        """
    ...
    def procedure(self) -> tuple[RQA_I09_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: RQA_I09_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RQA_I09_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: RQA_I09_PROCEDURE_GROUP | tuple[RQA_I09_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: RQA_I09_PROCEDURE_GROUP.None | tuple[RQA_I09_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_PROCEDURE_GROUP
        """
    ...
    def observation(self) -> tuple[RQA_I09_OBSERVATION_GROUP, ...] | tuple[None]:
        """
        id: RQA_I09_OBSERVATION_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RQA_I09_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_OBSERVATION_GROUP
        """
    ...
    def observation(
        ...
        ---
        param_type: RQA_I09_OBSERVATION_GROUP.None | tuple[RQA_I09_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_OBSERVATION_GROUP
        """
    ...
    @property  # get RQA_I09_VISIT_GROUP.None
    def visit(self) -> RQA_I09_VISIT_GROUP | None:
        """
        id: RQA_I09_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RQA_I09_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_VISIT_GROUP
        """
        return self._c_data[14][0]

    @visit.setter  # set RQA_I09_VISIT_GROUP.None
    def visit(self, v_isit: RQA_I09_VISIT_GROUP | None):
        """
        id: RQA_I09_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RQA_I09_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RQA_I09_VISIT_GROUP
        """
