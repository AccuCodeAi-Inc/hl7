...
"""
Dispense History Query - QBP_Z97
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::QBP_Z97 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import QBP_Z97
from utils.hl7.v2_5_1.segments import (
    SFT, RCP, DSC, QPD, MSH
)

qbp_z97 = QBP_Z97(  #  - The purpose of this query/response pair is to retrieve patient pharmacy dispense history information from the Server
...
-----END TRIGGER_EVENT::QBP_Z97 TEMPLATE-----
"""


class QBP_Z97(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    ...
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z97"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
         - `QBP_Z97 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/QBP_Z97>`_
