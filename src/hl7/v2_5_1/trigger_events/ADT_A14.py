...
from ..segment_groups.ADT_A14_PROCEDURE_GROUP import ADT_A14_PROCEDURE_GROUP
from ..segments.PID import PID
from ..segments.EVN import EVN
from ..segments.PV1 import PV1
from ..segments.SFT import SFT
from ..segments.PD1 import PD1
from ..segment_groups.ADT_A14_INSURANCE_GROUP import ADT_A14_INSURANCE_GROUP
from ..segments.ACC import ACC


"""
Pending Admit - ADT_A14
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A14 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A14
from utils.hl7.v2_5_1.segments import (
    OBX, PID, MSH, PD1, PV1, NK1, ROL, PV2, SFT, DB1, AL1, DG1, GT1, UB1, ACC, UB2, DRG, EVN
)
from utils.hl7.v2_5_1.segment_groups import (
    ADT_A14_PROCEDURE_GROUP, ADT_A14_INSURANCE_GROUP
)

adt_a14 = ADT_A14(  #  - An A14 event notifies other systems of a planned admission, when there is a reservation or when patient admission is to occur imminently
    ...
    procedure=None,  # ADT_A14_PROCEDURE_GROUP(...) 
    guarantor=None,  # GT1(...) 
    insurance=None,  # ADT_A14_INSURANCE_GROUP(...) 
    accident=None,  # ACC(...) 
    ub82_data=None,  # UB1(...) 
    ub92_data=None,  # UB2(...) 
)

-----END TRIGGER_EVENT::ADT_A14 TEMPLATE-----
"""


class ADT_A14(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A14"""
    _hl7_name = """Pending Admit"""
    _hl7_description = """An A14 event notifies other systems of a planned admission, when there is a reservation or when patient admission is to occur imminently"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A14"""
    ...
    _c_components = (MSH, SFT, EVN, PID, PD1, ROL, NK1, PV1, PV2, ROL, DB1, OBX, AL1, DG1, DRG, ADT_A14_PROCEDURE_GROUP, GT1, ADT_A14_INSURANCE_GROUP, ACC, UB1, UB2)
    ...
    def __init__(
        ...
        procedure: ADT_A14_PROCEDURE_GROUP
        | tuple[ADT_A14_PROCEDURE_GROUP, ...]
        | None = None,  #  (PR1.16, ROL.17, ...)
        guarantor: GT1 | tuple[GT1, ...] | None = None,  #  GT1.18
        insurance: ADT_A14_INSURANCE_GROUP
        | tuple[ADT_A14_INSURANCE_GROUP, ...]
        ...
        """
         - `ADT_A14 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A14>`_
    ...
    def procedure(self) -> tuple[ADT_A14_PROCEDURE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A14_PROCEDURE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A14_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A14_PROCEDURE_GROUP
        """
    ...
    def procedure(
        self,
        procedure: ADT_A14_PROCEDURE_GROUP | tuple[ADT_A14_PROCEDURE_GROUP, ...] | None,
    ):
        """
        id: PROCEDURE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A14_PROCEDURE_GROUP.None | tuple[ADT_A14_PROCEDURE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A14_PROCEDURE_GROUP
        """
    ...
    def insurance(self) -> tuple[ADT_A14_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: ADT_A14_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ADT_A14_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A14_INSURANCE_GROUP
        """
    ...
    def insurance(
        self,
        insurance: ADT_A14_INSURANCE_GROUP | tuple[ADT_A14_INSURANCE_GROUP, ...] | None,
    ):
        """
        id: INSURANCE SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        param_type: ADT_A14_INSURANCE_GROUP.None | tuple[ADT_A14_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ADT_A14_INSURANCE_GROUP
        """
