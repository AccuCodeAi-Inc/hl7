...
"""
Master file application acknowledgment - MFK_M01
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::MFK_M01 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import MFK_M01
from utils.hl7.v2_5_1.segments import (
    ERR, MSA, MFI, MSH, SFT, MFA
)
...
-----END TRIGGER_EVENT::MFK_M01 TEMPLATE-----
"""


class MFK_M01(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """MFK_M01"""
    _hl7_name = """Master file application acknowledgment"""
    _hl7_description = """"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MFK_M01"""
    ...
    def __init__(
        ...
        """
         - `MFK_M01 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MFK_M01>`_
