...
"""
Merge Patient Information - Account Number Only - ADT_A35
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT::ADT_A35 TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A35
from utils.hl7.v2_5_1.segments import (
    MRG, PD1, MSH, SFT, PID, EVN
)

adt_a35 = ADT_A35(  #  - Event A35 has been retained for backward compatibility only
...
-----END TRIGGER_EVENT::ADT_A35 TEMPLATE-----
"""


class ADT_A35(HL7TriggerEvent):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT"""
    _hl7_length = -1
    _hl7_id = """ADT_A35"""
    _hl7_name = """Merge Patient Information - Account Number Only"""
    _hl7_description = """Event A35 has been retained for backward compatibility only"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A35"""
    ...
    def __init__(
        ...
        """
                 - `ADT_A35 <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A35>`_
