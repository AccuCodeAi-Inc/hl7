...
"""
ROW DEFINITION - RTB_Z96_ROW_DEFINITION_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RTB_Z96_ROW_DEFINITION_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RTB_Z96_ROW_DEFINITION_GROUP
from utils.hl7.v2_5_1.segments import (
    RDF, RDT
)

rtb_z96_row_definition_group = RTB_Z96_ROW_DEFINITION_GROUP(  # ROW DEFINITION - Segment group for RTB_Z96 - Tabular Dispense History Response consisting of RDF, RDT|None
    table_row_definition=rdf,  # RDF(...)  # Required.
    table_row_data=None,  # RDT(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RTB_Z96_ROW_DEFINITION_GROUP TEMPLATE-----
"""


class RTB_Z96_ROW_DEFINITION_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RTB_Z96_ROW_DEFINITION_GROUP"""
    _hl7_name = """ROW DEFINITION"""
    _hl7_description = """Segment group for RTB_Z96 - Tabular Dispense History Response consisting of RDF, RDT|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_Z96_ROW_DEFINITION_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("7", "8")
    ...
    def __init__(
        ...
        """
        None - `RTB_Z96_ROW_DEFINITION_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RTB_Z96_ROW_DEFINITION_GROUP>`_
        Segment group for RTB_Z96 - Tabular Dispense History Response consisting of RDF, RDT|None
