...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP
from utils.hl7.v2_5_1.segments import (
    PV2, PID, DG1, PV1
)

srr_s02_schedule_group_patient_group = SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP(  # PATIENT - Segment group for SRR_S02_SCHEDULE_GROUP - SCHEDULE consisting of PID, PV1|None, PV2|None, DG1|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP TEMPLATE-----
"""


class SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for SRR_S02_SCHEDULE_GROUP - SCHEDULE consisting of PID, PV1|None, PV2|None, DG1|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 1, 1, 65535)
    _c_usage = ("R", "O", "O", "O")
    _c_aliases = ("7", "8", "9", "10")
    ...
    def __init__(
        ...
        """
        None - `SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S02_SCHEDULE_GROUP_PATIENT_GROUP>`_
        Segment group for SRR_S02_SCHEDULE_GROUP - SCHEDULE consisting of PID, PV1|None, PV2|None, DG1|None
