...
from ..segment_groups.RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP import (
    RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP,
)
...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP
...
rre_o26_response_group_order_group_encoding_group = RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP(  # ENCODING - Segment group for RRE_O26_RESPONSE_GROUP_ORDER_GROUP - ORDER consisting of RXE, NTE|None, TIMING ENCODED, RXR, RXC|None
    pharmacy_or_treatment_encoded_order=rxe,  # RXE(...)  # Required.
    notes_and_comments=None,  # NTE(...) 
    timing_encoded=rre_o26_response_group_order_group_encoding_group_timing_encoded_group,  # RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP(...)  # Required.
    pharmacy_or_treatment_route=rxr,  # RXR(...)  # Required.
    pharmacy_or_treatment_component_order=None,  # RXC(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP TEMPLATE-----
"""


class RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP"""
    _hl7_name = """ENCODING"""
    _hl7_description = """Segment group for RRE_O26_RESPONSE_GROUP_ORDER_GROUP - ORDER consisting of RXE, NTE|None, TIMING ENCODED, RXR, RXC|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 65535, 65535, 65535)
    _c_usage = ("R", "O", "R", "R", "O")
    _c_aliases = ("11", "12", "None", "15", "16")
    _c_components = (RXE, NTE, RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP, RXR, RXC)
    ...
    def __init__(
        ...
        timing_encoded: RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP
        | tuple[
            RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP, ...
        ...
        """
        None - `RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP>`_
        Segment group for RRE_O26_RESPONSE_GROUP_ORDER_GROUP - ORDER consisting of RXE, NTE|None, TIMING ENCODED, RXR, RXC|None
    ...
    def timing_encoded(
        ...
        """
        id: RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP
        """
    ...
    def timing_encoded(
        ...
        ---
        param_type: RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP.None | tuple[RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RRE_O26_RESPONSE_GROUP_ORDER_GROUP_ENCODING_GROUP_TIMING_ENCODED_GROUP
        """
