...
"""
PERSONNEL RESOURCE - SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP
from utils.hl7.v2_5_1.segments import (
    AIP, APR, NTE
)

srm_s01_resources_group_personnel_resource_group = SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP(  # PERSONNEL RESOURCE - Segment group for SRM_S01_RESOURCES_GROUP - RESOURCES consisting of AIP, APR|None, NTE|None
    appointment_information_personnel_resource=aip,  # AIP(...)  # Required.
    appointment_preferences=None,  # APR(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP TEMPLATE-----
"""


class SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP"""
    _hl7_name = """PERSONNEL RESOURCE"""
    _hl7_description = """Segment group for SRM_S01_RESOURCES_GROUP - RESOURCES consisting of AIP, APR|None, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP"""
    _c_length = (-1,-1,-1,)
    _c_rpt = (1, 1, 65535)
    _c_usage = ("R", "O", "O")
    _c_aliases = ("20", "21", "22")
    ...
    def __init__(
        ...
        """
        None - `SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S01_RESOURCES_GROUP_PERSONNEL_RESOURCE_GROUP>`_
        Segment group for SRM_S01_RESOURCES_GROUP - RESOURCES consisting of AIP, APR|None, NTE|None
