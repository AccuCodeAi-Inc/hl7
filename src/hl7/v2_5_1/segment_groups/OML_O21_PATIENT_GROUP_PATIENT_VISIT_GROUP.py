...
"""
PATIENT VISIT - OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP
from utils.hl7.v2_5_1.segments import (
    PV2, PV1
)

oml_o21_patient_group_patient_visit_group = OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP(  # PATIENT VISIT - Segment group for OML_O21_PATIENT_GROUP - PATIENT consisting of PV1, PV2|None
    patient_visit=pv1,  # PV1(...)  # Required.
    patient_visit_additional_information=None,  # PV2(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP TEMPLATE-----
"""


class OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP"""
    _hl7_name = """PATIENT VISIT"""
    _hl7_description = """Segment group for OML_O21_PATIENT_GROUP - PATIENT consisting of PV1, PV2|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 1)
    _c_usage = ("R", "O")
    _c_aliases = ("8", "9")
    ...
    def __init__(
        ...
        """
        None - `OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O21_PATIENT_GROUP_PATIENT_VISIT_GROUP>`_
        Segment group for OML_O21_PATIENT_GROUP - PATIENT consisting of PV1, PV2|None
