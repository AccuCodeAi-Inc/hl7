...
"""
PATHWAY - PPP_PCD_PATHWAY_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::PPP_PCD_PATHWAY_GROUP TEMPLATE-----
...
ppp_pcd_pathway_group = PPP_PCD_PATHWAY_GROUP(  # PATHWAY - Segment group for PPP_PCD - Pathway (problem-oriented) delete consisting of PTH, NTE|None, VAR|None, PATHWAY ROLE|None, PROBLEM|None
    ...
    variance=None,  # VAR(...) 
    pathway_role=None,  # PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP(...) 
    problem=None,  # PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::PPP_PCD_PATHWAY_GROUP TEMPLATE-----
"""


class PPP_PCD_PATHWAY_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """PPP_PCD_PATHWAY_GROUP"""
    _hl7_name = """PATHWAY"""
    _hl7_description = """Segment group for PPP_PCD - Pathway (problem-oriented) delete consisting of PTH, NTE|None, VAR|None, PATHWAY ROLE|None, PROBLEM|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PPP_PCD_PATHWAY_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 65535, 65535, 65535)
    _c_usage = ("R", "O", "O", "O", "O")
    _c_aliases = ("6", "7", "8", "None", "None")
    _c_components = (PTH, NTE, VAR, PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP, PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP)
    ...
    def __init__(
        ...
        pathway_role: PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP
        | tuple[PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP, ...]
        | None = None,  #  (ROL.9, VAR.10, ...)
        problem: PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP
        | tuple[PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP, ...]
        | None = None,  #  (PRB.11, NTE.12, VAR.13, ...)
    ):
        """
        None - `PPP_PCD_PATHWAY_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PPP_PCD_PATHWAY_GROUP>`_
        Segment group for PPP_PCD - Pathway (problem-oriented) delete consisting of PTH, NTE|None, VAR|None, PATHWAY ROLE|None, PROBLEM|None
    ...
    def pathway_role(
        self,
    ) -> tuple[PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP, ...] | tuple[None]:
        """
        id: PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP
        """
    ...
    def pathway_role(
        ...
        ---
        param_type: PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP.None | tuple[PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PPP_PCD_PATHWAY_GROUP_PATHWAY_ROLE_GROUP
        """
    ...
    def problem(self) -> tuple[PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP, ...] | tuple[None]:
        """
        id: PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP
        """
    ...
    def problem(
        ...
        ---
        param_type: PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP.None | tuple[PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/PPP_PCD_PATHWAY_GROUP_PROBLEM_GROUP
        """
