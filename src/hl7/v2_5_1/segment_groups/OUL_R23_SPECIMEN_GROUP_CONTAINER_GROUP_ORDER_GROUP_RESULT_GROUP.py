...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP
from utils.hl7.v2_5_1.segments import (
    TCD, NTE, SID, OBX
)

oul_r23_specimen_group_container_group_order_group_result_group = OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP(  # RESULT - Segment group for OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP - ORDER consisting of OBX, TCD|None, SID|None, NTE|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP TEMPLATE-----
"""


class OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP"""
    _hl7_name = """RESULT"""
    _hl7_description = """Segment group for OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP - ORDER consisting of OBX, TCD|None, SID|None, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
        None - `OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP>`_
        Segment group for OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP - ORDER consisting of OBX, TCD|None, SID|None, NTE|None
