...
"""
SCHEDULE - SRR_S11_SCHEDULE_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::SRR_S11_SCHEDULE_GROUP TEMPLATE-----
...
srr_s11_schedule_group = SRR_S11_SCHEDULE_GROUP(  # SCHEDULE - Segment group for SRR_S11 - Scheduled request response - Deletion of service/resource on appointment consisting of SCH, TQ1|None, NTE|None, PATIENT|None, RESOURCES
    ...
    patient=None,  # SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP(...) 
    resources=srr_s11_schedule_group_resources_group,  # SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::SRR_S11_SCHEDULE_GROUP TEMPLATE-----
"""


class SRR_S11_SCHEDULE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """SRR_S11_SCHEDULE_GROUP"""
    _hl7_name = """SCHEDULE"""
    _hl7_description = """Segment group for SRR_S11 - Scheduled request response - Deletion of service/resource on appointment consisting of SCH, TQ1|None, NTE|None, PATIENT|None, RESOURCES"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S11_SCHEDULE_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 65535, 65535, 65535)
    _c_usage = ("R", "O", "O", "O", "R")
    _c_aliases = ("4", "5", "6", "None", "None")
    _c_components = (SCH, TQ1, NTE, SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP, SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP)
    ...
    def __init__(
        ...
        patient: SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP
        | tuple[SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP, ...]
        | None = None,  #  (PID.7, PV1.8, PV2.9, DG1.10, ...)
    ):
        """
        None - `SRR_S11_SCHEDULE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S11_SCHEDULE_GROUP>`_
        Segment group for SRR_S11 - Scheduled request response - Deletion of service/resource on appointment consisting of SCH, TQ1|None, NTE|None, PATIENT|None, RESOURCES
    ...
    def patient(self) -> tuple[SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP, ...] | tuple[None]:
        """
        id: SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP
        """
    ...
    def patient(
        ...
        ---
        param_type: SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP.None | tuple[SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S11_SCHEDULE_GROUP_PATIENT_GROUP
        """
    ...
    def resources(self) -> tuple[SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP, ...]:
        """
        id: SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP
        """
    ...
    def resources(
        self,
        resources: SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP
        | tuple[SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP, ...],
    ):
        """
        id: RESOURCES SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP.None | tuple[SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/SRR_S11_SCHEDULE_GROUP_RESOURCES_GROUP
        """
