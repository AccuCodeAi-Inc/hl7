...
from ..segment_groups.OML_O33_PATIENT_GROUP_INSURANCE_GROUP import (
    OML_O33_PATIENT_GROUP_INSURANCE_GROUP,
)
from ..segments.NTE import NTE
from ..segments.GT1 import GT1
from ..segments.PID import PID
from ..segments.NK1 import NK1
from ..segment_groups.OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP import (
    OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP,
)
from ..segments.PD1 import PD1


"""
PATIENT - OML_O33_PATIENT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OML_O33_PATIENT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import OML_O33_PATIENT_GROUP
from utils.hl7.v2_5_1.segments import (
    NTE, GT1, PD1, NK1, AL1, PID
)
from utils.hl7.v2_5_1.segment_groups import (
    OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP, OML_O33_PATIENT_GROUP_INSURANCE_GROUP
)

oml_o33_patient_group = OML_O33_PATIENT_GROUP(  # PATIENT - Segment group for OML_O33 - Laboratory Order for Multiple Orders Related to a Single Specimen  consisting of PID, PD1|None, NTE|None, NK1|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None
    patient_identification=pid,  # PID(...)  # Required.
    patient_additional_demographic=None,  # PD1(...) 
    notes_and_comments=None,  # NTE(...) 
    next_of_kin_or_associated_parties=None,  # NK1(...) 
    patient_visit=None,  # OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP(...) 
    insurance=None,  # OML_O33_PATIENT_GROUP_INSURANCE_GROUP(...) 
    guarantor=None,  # GT1(...) 
    patient_allergy_information=None,  # AL1(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::OML_O33_PATIENT_GROUP TEMPLATE-----
"""


class OML_O33_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OML_O33_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for OML_O33 - Laboratory Order for Multiple Orders Related to a Single Specimen  consisting of PID, PD1|None, NTE|None, NK1|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O33_PATIENT_GROUP"""
    ...
    _c_components = (PID, PD1, NTE, NK1, OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP, OML_O33_PATIENT_GROUP_INSURANCE_GROUP, GT1, AL1)
    ...
    def __init__(
        ...
        | tuple[NK1, ...]
        | None = None,  #  NK1.7
        patient_visit: OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP
        | None = None,  #  PV1.8, PV2.9
        insurance: OML_O33_PATIENT_GROUP_INSURANCE_GROUP
        | tuple[OML_O33_PATIENT_GROUP_INSURANCE_GROUP, ...]
        | None = None,  #  (IN1.10, IN2.11, IN3.12, ...)
        guarantor: GT1 | None = None,  #  GT1.13
        patient_allergy_information: AL1 | tuple[AL1, ...] | None = None,  #  AL1.14
    ):
        """
        None - `OML_O33_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O33_PATIENT_GROUP>`_
        Segment group for OML_O33 - Laboratory Order for Multiple Orders Related to a Single Specimen  consisting of PID, PD1|None, NTE|None, NK1|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None
    ...
    @property  # get OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP.None
    def patient_visit(self) -> OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP | None:
        """
        id: OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP
        """
        return self._c_data[4][0]

    @patient_visit.setter  # set OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP.None
    def patient_visit(
        self, patient_v_isit: OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP | None
    ):
        """
        id: OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_PATIENT_GROUP_PATIENT_VISIT_GROUP
        """
    ...
    def insurance(
        self,
    ) -> tuple[OML_O33_PATIENT_GROUP_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: OML_O33_PATIENT_GROUP_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[OML_O33_PATIENT_GROUP_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_PATIENT_GROUP_INSURANCE_GROUP
        """
    ...
    def insurance(
        ...
        ---
        param_type: OML_O33_PATIENT_GROUP_INSURANCE_GROUP.None | tuple[OML_O33_PATIENT_GROUP_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_PATIENT_GROUP_INSURANCE_GROUP
        """
