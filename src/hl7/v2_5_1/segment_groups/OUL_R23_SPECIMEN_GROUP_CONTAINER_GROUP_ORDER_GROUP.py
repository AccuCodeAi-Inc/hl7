...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP TEMPLATE-----
...
from utils.hl7.v2_5_1.segment_groups import (
    OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP, OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP
)

oul_r23_specimen_group_container_group_order_group = OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP(  # ORDER - Segment group for OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP - CONTAINER consisting of OBR, ORC|None, NTE|None, TIMING QTY|None, RESULT|None, CTI|None
    observation_request=obr,  # OBR(...)  # Required.
    common_order=None,  # ORC(...) 
    notes_and_comments=None,  # NTE(...) 
    timing_qty=None,  # OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP(...) 
    result=None,  # OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP(...) 
    clinical_trial_identification=None,  # CTI(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP TEMPLATE-----
"""


class OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP"""
    _hl7_name = """ORDER"""
    _hl7_description = """Segment group for OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP - CONTAINER consisting of OBR, ORC|None, NTE|None, TIMING QTY|None, RESULT|None, CTI|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 65535)
    _c_usage = ("R", "O", "O", "O", "O", "O")
    _c_aliases = ("13", "14", "15", "None", "None", "22")
    _c_components = (OBR, ORC, NTE, OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP, OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP, CTI)
    ...
    def __init__(
        ...
        timing_qty: OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP
        | tuple[
            OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP, ...
        ]
        | None = None,  #  (TQ1.16, TQ2.17, ...)
        result: OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP
        | tuple[OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP, ...]
        | None = None,  #  (OBX.18, TCD.19, SID.20, NTE.21, ...)
        clinical_trial_identification: CTI | tuple[CTI, ...] | None = None,  #  CTI.22
    ):
        """
        None - `OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP>`_
        Segment group for OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP - CONTAINER consisting of OBR, ORC|None, NTE|None, TIMING QTY|None, RESULT|None, CTI|None
    ...
    def timing_qty(
        ...
        tuple[OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP, ...]
        | tuple[None]
    ):
        """
        id: OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP
        """
    ...
    def timing_qty(
        ...
        ---
        param_type: OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP.None | tuple[OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_TIMING_QTY_GROUP
        """
    ...
    def result(
        ...
        """
        id: OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP
        """
    ...
    def result(
        ...
        ---
        param_type: OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP.None | tuple[OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OUL_R23_SPECIMEN_GROUP_CONTAINER_GROUP_ORDER_GROUP_RESULT_GROUP
        """
