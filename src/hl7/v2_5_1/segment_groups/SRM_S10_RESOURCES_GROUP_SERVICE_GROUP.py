...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::SRM_S10_RESOURCES_GROUP_SERVICE_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SRM_S10_RESOURCES_GROUP_SERVICE_GROUP
from utils.hl7.v2_5_1.segments import (
    NTE, APR, AIS
)

srm_s10_resources_group_service_group = SRM_S10_RESOURCES_GROUP_SERVICE_GROUP(  # SERVICE - Segment group for SRM_S10_RESOURCES_GROUP - RESOURCES consisting of AIS, APR|None, NTE|None
    appointment_information=ais,  # AIS(...)  # Required.
    appointment_preferences=None,  # APR(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::SRM_S10_RESOURCES_GROUP_SERVICE_GROUP TEMPLATE-----
"""


class SRM_S10_RESOURCES_GROUP_SERVICE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """SRM_S10_RESOURCES_GROUP_SERVICE_GROUP"""
    _hl7_name = """SERVICE"""
    _hl7_description = """Segment group for SRM_S10_RESOURCES_GROUP - RESOURCES consisting of AIS, APR|None, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S10_RESOURCES_GROUP_SERVICE_GROUP"""
    _c_length = (-1,-1,-1,)
    _c_rpt = (1, 1, 65535)
    _c_usage = ("R", "O", "O")
    _c_aliases = ("11", "12", "13")
    ...
    def __init__(
        ...
        """
        None - `SRM_S10_RESOURCES_GROUP_SERVICE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S10_RESOURCES_GROUP_SERVICE_GROUP>`_
        Segment group for SRM_S10_RESOURCES_GROUP - RESOURCES consisting of AIS, APR|None, NTE|None
