...
from utils.hl7.v2_5_1.segment_groups import (
    PRR_PC5_PATIENT_GROUP_PROBLEM_GROUP_PROBLEM_ROLE_GROUP, PRR_PC5_PATIENT_GROUP_PROBLEM_GROUP_GOAL_GROUP, PRR_PC5_PATIENT_GROUP_PROBLEM_GROUP_PROBLEM_OBSERVATION_GROUP, PRR_PC5_PATIENT_GROUP_PROBLEM_GROUP_PROBLEM_PATHWAY_GROUP, PRR_PC5_PATIENT_GROUP_PROBLEM_GROUP_ORDER_GROUP
)
