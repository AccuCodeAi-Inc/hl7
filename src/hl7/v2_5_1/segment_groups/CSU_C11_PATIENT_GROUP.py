...
"""
PATIENT - CSU_C11_PATIENT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::CSU_C11_PATIENT_GROUP TEMPLATE-----
...
csu_c11_patient_group = CSU_C11_PATIENT_GROUP(  # PATIENT - Segment group for CSU_C11 - Patient completes a phase of the clinical trial consisting of PID, PD1|None, NTE|None, VISIT|None, CSR, STUDY PHASE
    ...
    visit=None,  # CSU_C11_PATIENT_GROUP_VISIT_GROUP(...) 
    clinical_study_registration=csr,  # CSR(...)  # Required.
    study_phase=csu_c11_patient_group_study_phase_group,  # CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::CSU_C11_PATIENT_GROUP TEMPLATE-----
"""


class CSU_C11_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """CSU_C11_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for CSU_C11 - Patient completes a phase of the clinical trial consisting of PID, PD1|None, NTE|None, VISIT|None, CSR, STUDY PHASE"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/CSU_C11_PATIENT_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 1, 1, 65535)
    _c_usage = ("R", "O", "O", "O", "R", "R")
    _c_aliases = ("3", "4", "5", "None", "8", "None")
    _c_components = (PID, PD1, NTE, CSU_C11_PATIENT_GROUP_VISIT_GROUP, CSR, CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP)
    ...
    def __init__(
        ...
        study_phase: CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP
        | tuple[
            CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP, ...
        ],  #  Required. (CSP.9, ...)
        patient_additional_demographic: PD1 | None = None,  #  PD1.4
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.5
        visit: CSU_C11_PATIENT_GROUP_VISIT_GROUP | None = None,  #  PV1.6, PV2.7
    ):
        """
        None - `CSU_C11_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/CSU_C11_PATIENT_GROUP>`_
        Segment group for CSU_C11 - Patient completes a phase of the clinical trial consisting of PID, PD1|None, NTE|None, VISIT|None, CSR, STUDY PHASE
    ...
    @property  # get CSU_C11_PATIENT_GROUP_VISIT_GROUP.None
    def visit(self) -> CSU_C11_PATIENT_GROUP_VISIT_GROUP | None:
        """
        id: CSU_C11_PATIENT_GROUP_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: CSU_C11_PATIENT_GROUP_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/CSU_C11_PATIENT_GROUP_VISIT_GROUP
        """
        return self._c_data[3][0]

    @visit.setter  # set CSU_C11_PATIENT_GROUP_VISIT_GROUP.None
    def visit(self, v_isit: CSU_C11_PATIENT_GROUP_VISIT_GROUP | None):
        """
        id: CSU_C11_PATIENT_GROUP_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: CSU_C11_PATIENT_GROUP_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/CSU_C11_PATIENT_GROUP_VISIT_GROUP
        """
    ...
    def study_phase(self) -> tuple[CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP, ...]:
        """
        id: CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP
        """
    ...
    def study_phase(
        self,
        study_phase: CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP
        | tuple[CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP, ...],
    ):
        """
        id: STUDY PHASE SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP.None | tuple[CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/CSU_C11_PATIENT_GROUP_STUDY_PHASE_GROUP
        """
