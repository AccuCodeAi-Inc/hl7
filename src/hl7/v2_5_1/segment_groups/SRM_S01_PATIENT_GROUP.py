...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::SRM_S01_PATIENT_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::SRM_S01_PATIENT_GROUP TEMPLATE-----
"""


class SRM_S01_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """SRM_S01_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for SRM_S01 - Schedule request - New appointment booking consisting of PID, PV1|None, PV2|None, OBX|None, DG1|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S01_PATIENT_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
        None - `SRM_S01_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S01_PATIENT_GROUP>`_
        Segment group for SRM_S01 - Schedule request - New appointment booking consisting of PID, PV1|None, PV2|None, OBX|None, DG1|None
