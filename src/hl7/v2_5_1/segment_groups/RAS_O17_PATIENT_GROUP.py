...
"""
PATIENT - RAS_O17_PATIENT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RAS_O17_PATIENT_GROUP TEMPLATE-----
...
ras_o17_patient_group = RAS_O17_PATIENT_GROUP(  # PATIENT - Segment group for RAS_O17 - Pharmacy/Treatment Administration consisting of PID, PD1|None, NTE|None, AL1|None, PATIENT VISIT|None
    patient_identification=pid,  # PID(...)  # Required.
    patient_additional_demographic=None,  # PD1(...) 
    notes_and_comments=None,  # NTE(...) 
    patient_allergy_information=None,  # AL1(...) 
    patient_visit=None,  # RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RAS_O17_PATIENT_GROUP TEMPLATE-----
"""


class RAS_O17_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RAS_O17_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for RAS_O17 - Pharmacy/Treatment Administration consisting of PID, PD1|None, NTE|None, AL1|None, PATIENT VISIT|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RAS_O17_PATIENT_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 1)
    _c_usage = ("R", "O", "O", "O", "O")
    _c_aliases = ("4", "5", "6", "7", "None")
    _c_components = (PID, PD1, NTE, AL1, RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP)
    ...
    def __init__(
        ...
        patient_visit: RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP
        | None = None,  #  PV1.8, PV2.9
    ):
        """
        None - `RAS_O17_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RAS_O17_PATIENT_GROUP>`_
        Segment group for RAS_O17 - Pharmacy/Treatment Administration consisting of PID, PD1|None, NTE|None, AL1|None, PATIENT VISIT|None
    ...
    @property  # get RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP.None
    def patient_visit(self) -> RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP | None:
        """
        id: RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP
        """
        return self._c_data[4][0]

    @patient_visit.setter  # set RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP.None
    def patient_visit(
        self, patient_v_isit: RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP | None
    ):
        """
        id: RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RAS_O17_PATIENT_GROUP_PATIENT_VISIT_GROUP
        """
