...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OML_O33_SPECIMEN_GROUP_ORDER_GROUP TEMPLATE-----
...
oml_o33_specimen_group_order_group = OML_O33_SPECIMEN_GROUP_ORDER_GROUP(  # ORDER - Segment group for OML_O33_SPECIMEN_GROUP - SPECIMEN consisting of ORC, TIIMING|None, OBSERVATION REQUEST|None, FT1|None, CTI|None, BLG|None
    ...
    tiiming=None,  # OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP(...) 
    observation_request=None,  # OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP(...) 
    financial_transaction=None,  # FT1(...) 
    clinical_trial_identification=None,  # CTI(...) 
    billing=None,  # BLG(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::OML_O33_SPECIMEN_GROUP_ORDER_GROUP TEMPLATE-----
"""


class OML_O33_SPECIMEN_GROUP_ORDER_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OML_O33_SPECIMEN_GROUP_ORDER_GROUP"""
    _hl7_name = """ORDER"""
    _hl7_description = """Segment group for OML_O33_SPECIMEN_GROUP - SPECIMEN consisting of ORC, TIIMING|None, OBSERVATION REQUEST|None, FT1|None, CTI|None, BLG|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O33_SPECIMEN_GROUP_ORDER_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 65535, 65535, 1)
    _c_usage = ("R", "O", "O", "O", "O", "O")
    _c_aliases = ("18", "None", "None", "40", "41", "42")
    _c_components = (ORC, OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP, OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP, FT1, CTI, BLG)
    ...
    def __init__(
        ...
        tiiming: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP
        | tuple[OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP, ...]
        | None = None,  #  (TQ1.19, TQ2.20, ...)
        observation_request: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP
        ...
        """
        None - `OML_O33_SPECIMEN_GROUP_ORDER_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O33_SPECIMEN_GROUP_ORDER_GROUP>`_
        Segment group for OML_O33_SPECIMEN_GROUP - SPECIMEN consisting of ORC, TIIMING|None, OBSERVATION REQUEST|None, FT1|None, CTI|None, BLG|None
    ...
    def tiiming(
        self,
    ) -> tuple[OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP, ...] | tuple[None]:
        """
        id: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP
        """
    ...
    def tiiming(
        ...
        ---
        param_type: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP.None | tuple[OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_SPECIMEN_GROUP_ORDER_GROUP_TIIMING_GROUP
        """
    ...
    @property  # get OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP.None
    def observation_request(
        self,
    ) -> OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP | None:
        """
        id: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP
        """
        return self._c_data[2][0]

    @observation_request.setter  # set OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP.None
    def observation_request(
        self,
        observation_request: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP
        | None,
        ...
        id: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OML_O33_SPECIMEN_GROUP_ORDER_GROUP_OBSERVATION_REQUEST_GROUP
        """
