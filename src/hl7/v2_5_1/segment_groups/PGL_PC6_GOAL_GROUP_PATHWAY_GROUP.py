...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::PGL_PC6_GOAL_GROUP_PATHWAY_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::PGL_PC6_GOAL_GROUP_PATHWAY_GROUP TEMPLATE-----
"""


class PGL_PC6_GOAL_GROUP_PATHWAY_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """PGL_PC6_GOAL_GROUP_PATHWAY_GROUP"""
    _hl7_name = """PATHWAY"""
    _hl7_description = """Segment group for PGL_PC6_GOAL_GROUP - GOAL consisting of PTH, VAR|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PGL_PC6_GOAL_GROUP_PATHWAY_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("11", "12")
    ...
    def __init__(
        ...
        """
        None - `PGL_PC6_GOAL_GROUP_PATHWAY_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PGL_PC6_GOAL_GROUP_PATHWAY_GROUP>`_
        Segment group for PGL_PC6_GOAL_GROUP - GOAL consisting of PTH, VAR|None
