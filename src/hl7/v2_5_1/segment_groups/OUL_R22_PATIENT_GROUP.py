...
"""
PATIENT - OUL_R22_PATIENT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OUL_R22_PATIENT_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::OUL_R22_PATIENT_GROUP TEMPLATE-----
"""


class OUL_R22_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OUL_R22_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for OUL_R22 - Unsolicited Specimen Oriented Observation Message consisting of PID, PD1|None, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R22_PATIENT_GROUP"""
    _c_length = (-1,-1,-1,)
    _c_rpt = (1, 1, 65535)
    _c_usage = ("R", "O", "O")
    _c_aliases = ("4", "5", "6")
    ...
    def __init__(
        ...
        """
        None - `OUL_R22_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R22_PATIENT_GROUP>`_
        Segment group for OUL_R22 - Unsolicited Specimen Oriented Observation Message consisting of PID, PD1|None, NTE|None
