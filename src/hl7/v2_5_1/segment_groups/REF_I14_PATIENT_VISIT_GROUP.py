...
"""
PATIENT VISIT - REF_I14_PATIENT_VISIT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::REF_I14_PATIENT_VISIT_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::REF_I14_PATIENT_VISIT_GROUP TEMPLATE-----
"""


class REF_I14_PATIENT_VISIT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """REF_I14_PATIENT_VISIT_GROUP"""
    _hl7_name = """PATIENT VISIT"""
    _hl7_description = """Segment group for REF_I14 - Cancel patient referral consisting of PV1, PV2|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I14_PATIENT_VISIT_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 1)
    _c_usage = ("R", "O")
    _c_aliases = ("25", "26")
    ...
    def __init__(
        ...
        """
        None - `REF_I14_PATIENT_VISIT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I14_PATIENT_VISIT_GROUP>`_
        Segment group for REF_I14 - Cancel patient referral consisting of PV1, PV2|None
