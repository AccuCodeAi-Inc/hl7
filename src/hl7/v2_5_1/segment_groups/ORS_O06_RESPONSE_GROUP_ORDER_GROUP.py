...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::ORS_O06_RESPONSE_GROUP_ORDER_GROUP TEMPLATE-----
...
ors_o06_response_group_order_group = ORS_O06_RESPONSE_GROUP_ORDER_GROUP(  # ORDER - Segment group for ORS_O06_RESPONSE_GROUP - RESPONSE consisting of ORC, TIMING|None, RQD, RQ1|None, NTE|None
    common_order=orc,  # ORC(...)  # Required.
    timing=None,  # ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP(...) 
    requisition_detail=rqd,  # RQD(...)  # Required.
    requisition_detail_1=None,  # RQ1(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::ORS_O06_RESPONSE_GROUP_ORDER_GROUP TEMPLATE-----
"""


class ORS_O06_RESPONSE_GROUP_ORDER_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """ORS_O06_RESPONSE_GROUP_ORDER_GROUP"""
    _hl7_name = """ORDER"""
    _hl7_description = """Segment group for ORS_O06_RESPONSE_GROUP - RESPONSE consisting of ORC, TIMING|None, RQD, RQ1|None, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORS_O06_RESPONSE_GROUP_ORDER_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 65535)
    _c_usage = ("R", "O", "R", "O", "O")
    _c_aliases = ("8", "None", "11", "12", "13")
    _c_components = (ORC, ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP, RQD, RQ1, NTE)
    ...
    def __init__(
        ...
        | tuple[ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP, ...]
        | None = None,  #  (TQ1.9, TQ2.10, ...)
        requisition_detail_1: RQ1 | None = None,  #  RQ1.12
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.13
    ):
        """
        None - `ORS_O06_RESPONSE_GROUP_ORDER_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORS_O06_RESPONSE_GROUP_ORDER_GROUP>`_
        Segment group for ORS_O06_RESPONSE_GROUP - RESPONSE consisting of ORC, TIMING|None, RQD, RQ1|None, NTE|None
    ...
    def timing(
        self,
    ) -> tuple[ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP, ...] | tuple[None]:
        """
        id: ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP
        """
    ...
    def timing(
        ...
        ---
        param_type: ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP.None | tuple[ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/ORS_O06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP
        """
