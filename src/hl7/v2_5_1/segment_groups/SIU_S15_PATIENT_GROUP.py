...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::SIU_S15_PATIENT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SIU_S15_PATIENT_GROUP
from utils.hl7.v2_5_1.segments import (
    DG1, PID, PD1, PV1, PV2, OBX
)

siu_s15_patient_group = SIU_S15_PATIENT_GROUP(  # PATIENT - Segment group for SIU_S15 - Notification of Appointment Cancellation consisting of PID, PD1|None, PV1|None, PV2|None, OBX|None, DG1|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::SIU_S15_PATIENT_GROUP TEMPLATE-----
"""


class SIU_S15_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """SIU_S15_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for SIU_S15 - Notification of Appointment Cancellation consisting of PID, PD1|None, PV1|None, PV2|None, OBX|None, DG1|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SIU_S15_PATIENT_GROUP"""
    ...
    def __init__(
        ...
        """
        None - `SIU_S15_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SIU_S15_PATIENT_GROUP>`_
        Segment group for SIU_S15 - Notification of Appointment Cancellation consisting of PID, PD1|None, PV1|None, PV2|None, OBX|None, DG1|None
