...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OMS_O05_ORDER_GROUP TEMPLATE-----
...
oms_o05_order_group = OMS_O05_ORDER_GROUP(  # ORDER - Segment group for OMS_O05 - Stock Requisition Order consisting of ORC, TIMING|None, RQD, RQ1|None, NTE|None, OBSERVATION|None, BLG|None
    ...
    timing=None,  # OMS_O05_ORDER_GROUP_TIMING_GROUP(...) 
    requisition_detail=rqd,  # RQD(...)  # Required.
    requisition_detail_1=None,  # RQ1(...) 
    notes_and_comments=None,  # NTE(...) 
    observation=None,  # OMS_O05_ORDER_GROUP_OBSERVATION_GROUP(...) 
    billing=None,  # BLG(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::OMS_O05_ORDER_GROUP TEMPLATE-----
"""


class OMS_O05_ORDER_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OMS_O05_ORDER_GROUP"""
    _hl7_name = """ORDER"""
    _hl7_description = """Segment group for OMS_O05 - Stock Requisition Order consisting of ORC, TIMING|None, RQD, RQ1|None, NTE|None, OBSERVATION|None, BLG|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OMS_O05_ORDER_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 65535, 1, 1, 65535, 65535, 1)
    _c_usage = ("R", "O", "R", "O", "O", "O", "O")
    _c_aliases = ("14", "None", "17", "18", "19", "None", "22")
    _c_components = (ORC, OMS_O05_ORDER_GROUP_TIMING_GROUP, RQD, RQ1, NTE, OMS_O05_ORDER_GROUP_OBSERVATION_GROUP, BLG)
    ...
    def __init__(
        ...
        timing: OMS_O05_ORDER_GROUP_TIMING_GROUP
        | tuple[OMS_O05_ORDER_GROUP_TIMING_GROUP, ...]
        ...
        | tuple[OMS_O05_ORDER_GROUP_OBSERVATION_GROUP, ...]
        | None = None,  #  (OBX.20, NTE.21, ...)
        billing: BLG | None = None,  #  BLG.22
    ):
        """
        None - `OMS_O05_ORDER_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OMS_O05_ORDER_GROUP>`_
        Segment group for OMS_O05 - Stock Requisition Order consisting of ORC, TIMING|None, RQD, RQ1|None, NTE|None, OBSERVATION|None, BLG|None
    ...
    @property  # get TIMING
    def timing(self) -> tuple[OMS_O05_ORDER_GROUP_TIMING_GROUP, ...] | tuple[None]:
        """
        id: OMS_O05_ORDER_GROUP_TIMING_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[OMS_O05_ORDER_GROUP_TIMING_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OMS_O05_ORDER_GROUP_TIMING_GROUP
        """
    ...
    def timing(
        ...
        ---
        param_type: OMS_O05_ORDER_GROUP_TIMING_GROUP.None | tuple[OMS_O05_ORDER_GROUP_TIMING_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OMS_O05_ORDER_GROUP_TIMING_GROUP
        """
    ...
    def observation(
        self,
    ) -> tuple[OMS_O05_ORDER_GROUP_OBSERVATION_GROUP, ...] | tuple[None]:
        """
        id: OMS_O05_ORDER_GROUP_OBSERVATION_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[OMS_O05_ORDER_GROUP_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OMS_O05_ORDER_GROUP_OBSERVATION_GROUP
        """
    ...
    def observation(
        ...
        ---
        param_type: OMS_O05_ORDER_GROUP_OBSERVATION_GROUP.None | tuple[OMS_O05_ORDER_GROUP_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OMS_O05_ORDER_GROUP_OBSERVATION_GROUP
        """
