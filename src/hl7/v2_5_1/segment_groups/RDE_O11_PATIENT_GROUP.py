...
from ..segment_groups.RDE_O11_PATIENT_GROUP_INSURANCE_GROUP import (
    RDE_O11_PATIENT_GROUP_INSURANCE_GROUP,
)
from ..segments.PID import PID
from ..segment_groups.RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP import (
    RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP,
)
...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RDE_O11_PATIENT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RDE_O11_PATIENT_GROUP
from utils.hl7.v2_5_1.segments import (
    NTE, GT1, PD1, AL1, PID
)
from utils.hl7.v2_5_1.segment_groups import (
    RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP, RDE_O11_PATIENT_GROUP_INSURANCE_GROUP
)

rde_o11_patient_group = RDE_O11_PATIENT_GROUP(  # PATIENT - Segment group for RDE_O11 - Pharmacy/Treatment Encoded Order consisting of PID, PD1|None, NTE|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None
    patient_identification=pid,  # PID(...)  # Required.
    patient_additional_demographic=None,  # PD1(...) 
    notes_and_comments=None,  # NTE(...) 
    patient_visit=None,  # RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP(...) 
    insurance=None,  # RDE_O11_PATIENT_GROUP_INSURANCE_GROUP(...) 
    guarantor=None,  # GT1(...) 
    patient_allergy_information=None,  # AL1(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RDE_O11_PATIENT_GROUP TEMPLATE-----
"""


class RDE_O11_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RDE_O11_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for RDE_O11 - Pharmacy/Treatment Encoded Order consisting of PID, PD1|None, NTE|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RDE_O11_PATIENT_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 1, 65535, 1, 65535)
    _c_usage = ("R", "O", "O", "O", "O", "O", "O")
    _c_aliases = ("4", "5", "6", "None", "None", "12", "13")
    _c_components = (PID, PD1, NTE, RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP, RDE_O11_PATIENT_GROUP_INSURANCE_GROUP, GT1, AL1)
    ...
    def __init__(
        ...
        patient_visit: RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP
        | None = None,  #  PV1.7, PV2.8
        insurance: RDE_O11_PATIENT_GROUP_INSURANCE_GROUP
        | tuple[RDE_O11_PATIENT_GROUP_INSURANCE_GROUP, ...]
        | None = None,  #  (IN1.9, IN2.10, IN3.11, ...)
        guarantor: GT1 | None = None,  #  GT1.12
        patient_allergy_information: AL1 | tuple[AL1, ...] | None = None,  #  AL1.13
    ):
        """
        None - `RDE_O11_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RDE_O11_PATIENT_GROUP>`_
        Segment group for RDE_O11 - Pharmacy/Treatment Encoded Order consisting of PID, PD1|None, NTE|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None
    ...
    @property  # get RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP.None
    def patient_visit(self) -> RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP | None:
        """
        id: RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP
        """
        return self._c_data[3][0]

    @patient_visit.setter  # set RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP.None
    def patient_visit(
        self, patient_v_isit: RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP | None
    ):
        """
        id: RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O11_PATIENT_GROUP_PATIENT_VISIT_GROUP
        """
    ...
    def insurance(
        self,
    ) -> tuple[RDE_O11_PATIENT_GROUP_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: RDE_O11_PATIENT_GROUP_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RDE_O11_PATIENT_GROUP_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O11_PATIENT_GROUP_INSURANCE_GROUP
        """
    ...
    def insurance(
        ...
        ---
        param_type: RDE_O11_PATIENT_GROUP_INSURANCE_GROUP.None | tuple[RDE_O11_PATIENT_GROUP_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O11_PATIENT_GROUP_INSURANCE_GROUP
        """
