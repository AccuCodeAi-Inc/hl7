...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP
from utils.hl7.v2_5_1.segments import (
    TQ1, TQ2
)

osr_q06_response_group_order_group_timing_group = OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP(  # TIMING - Segment group for OSR_Q06_RESPONSE_GROUP_ORDER_GROUP - ORDER consisting of TQ1, TQ2|None
    timing_or_quantity=tq1,  # TQ1(...)  # Required.
    timing_or_quantity_relationship=None,  # TQ2(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP TEMPLATE-----
"""


class OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP"""
    _hl7_name = """TIMING"""
    _hl7_description = """Segment group for OSR_Q06_RESPONSE_GROUP_ORDER_GROUP - ORDER consisting of TQ1, TQ2|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("11", "12")
    ...
    def __init__(
        ...
        """
        None - `OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OSR_Q06_RESPONSE_GROUP_ORDER_GROUP_TIMING_GROUP>`_
        Segment group for OSR_Q06_RESPONSE_GROUP_ORDER_GROUP - ORDER consisting of TQ1, TQ2|None
