...
"""
AUTHORIZATION CONTACT - REF_I14_AUTHORIZATION_CONTACT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::REF_I14_AUTHORIZATION_CONTACT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import REF_I14_AUTHORIZATION_CONTACT_GROUP
from utils.hl7.v2_5_1.segments import (
    CTD, AUT
)

ref_i14_authorization_contact_group = REF_I14_AUTHORIZATION_CONTACT_GROUP(  # AUTHORIZATION CONTACT - Segment group for REF_I14 - Cancel patient referral consisting of AUT, CTD|None
    authorization_information=aut,  # AUT(...)  # Required.
    contact_data=None,  # CTD(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::REF_I14_AUTHORIZATION_CONTACT_GROUP TEMPLATE-----
"""


class REF_I14_AUTHORIZATION_CONTACT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """REF_I14_AUTHORIZATION_CONTACT_GROUP"""
    _hl7_name = """AUTHORIZATION CONTACT"""
    _hl7_description = """Segment group for REF_I14 - Cancel patient referral consisting of AUT, CTD|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I14_AUTHORIZATION_CONTACT_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 1)
    _c_usage = ("R", "O")
    _c_aliases = ("4", "5")
    ...
    def __init__(
        ...
        """
        None - `REF_I14_AUTHORIZATION_CONTACT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I14_AUTHORIZATION_CONTACT_GROUP>`_
        Segment group for REF_I14 - Cancel patient referral consisting of AUT, CTD|None
