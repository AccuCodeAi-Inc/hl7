...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RAR_RAR_DEFINITION_GROUP TEMPLATE-----
...
rar_rar_definition_group = RAR_RAR_DEFINITION_GROUP(  # DEFINITION - Segment group for RAR_RAR - Pharmacy/Treatment Administration Information Response consisting of QRD, QRF|None, PATIENT|None, ORDER
    ...
    patient=None,  # RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP(...) 
    order=rar_rar_definition_group_order_group,  # RAR_RAR_DEFINITION_GROUP_ORDER_GROUP(...)  # Required.
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RAR_RAR_DEFINITION_GROUP TEMPLATE-----
"""


class RAR_RAR_DEFINITION_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RAR_RAR_DEFINITION_GROUP"""
    _hl7_name = """DEFINITION"""
    _hl7_description = """Segment group for RAR_RAR - Pharmacy/Treatment Administration Information Response consisting of QRD, QRF|None, PATIENT|None, ORDER"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RAR_RAR_DEFINITION_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 1, 1, 65535)
    _c_usage = ("R", "O", "O", "R")
    _c_aliases = ("5", "6", "None", "None")
    _c_components = (QRD, QRF, RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP, RAR_RAR_DEFINITION_GROUP_ORDER_GROUP)
    ...
    def __init__(
        ...
        | tuple[
            RAR_RAR_DEFINITION_GROUP_ORDER_GROUP, ...
        ],  #  Required. (ORC.9, RXA.13, RXR.14, ...)
        original_style_query_filter: QRF | None = None,  #  QRF.6
        patient: RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP | None = None,  #  PID.7, NTE.8
    ):
        """
        None - `RAR_RAR_DEFINITION_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RAR_RAR_DEFINITION_GROUP>`_
        Segment group for RAR_RAR - Pharmacy/Treatment Administration Information Response consisting of QRD, QRF|None, PATIENT|None, ORDER
        ...
        :param order: Order segment group: [ORC, ENCODING|None, RXA, RXR] (id: ORDER | seq: 9, None, 13, 14 | use: R | rpt: *)
        """
        super().__init__()
    ...
    @property  # get RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP.None
    def patient(self) -> RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP | None:
        """
        id: RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP
        """
        return self._c_data[2][0]

    @patient.setter  # set RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP.None
    def patient(self, patient: RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP | None):
        """
        id: RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RAR_RAR_DEFINITION_GROUP_PATIENT_GROUP
        """
    ...
    @property  # get ORDER
    def order(self) -> tuple[RAR_RAR_DEFINITION_GROUP_ORDER_GROUP, ...]:
        """
        id: RAR_RAR_DEFINITION_GROUP_ORDER_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RAR_RAR_DEFINITION_GROUP_ORDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RAR_RAR_DEFINITION_GROUP_ORDER_GROUP
        """
    ...
    def order(
        self,
        order: RAR_RAR_DEFINITION_GROUP_ORDER_GROUP
        | tuple[RAR_RAR_DEFINITION_GROUP_ORDER_GROUP, ...],
    ):
        """
        id: ORDER SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RAR_RAR_DEFINITION_GROUP_ORDER_GROUP.None | tuple[RAR_RAR_DEFINITION_GROUP_ORDER_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RAR_RAR_DEFINITION_GROUP_ORDER_GROUP
        """
