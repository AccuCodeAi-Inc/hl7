...
"""
VISIT - CSU_C11_PATIENT_GROUP_VISIT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::CSU_C11_PATIENT_GROUP_VISIT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import CSU_C11_PATIENT_GROUP_VISIT_GROUP
from utils.hl7.v2_5_1.segments import (
    PV2, PV1
)

csu_c11_patient_group_visit_group = CSU_C11_PATIENT_GROUP_VISIT_GROUP(  # VISIT - Segment group for CSU_C11_PATIENT_GROUP - PATIENT consisting of PV1, PV2|None
    patient_visit=pv1,  # PV1(...)  # Required.
    patient_visit_additional_information=None,  # PV2(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::CSU_C11_PATIENT_GROUP_VISIT_GROUP TEMPLATE-----
"""


class CSU_C11_PATIENT_GROUP_VISIT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """CSU_C11_PATIENT_GROUP_VISIT_GROUP"""
    _hl7_name = """VISIT"""
    _hl7_description = """Segment group for CSU_C11_PATIENT_GROUP - PATIENT consisting of PV1, PV2|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/CSU_C11_PATIENT_GROUP_VISIT_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 1)
    _c_usage = ("R", "O")
    _c_aliases = ("6", "7")
    ...
    def __init__(
        ...
        """
        None - `CSU_C11_PATIENT_GROUP_VISIT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/CSU_C11_PATIENT_GROUP_VISIT_GROUP>`_
        Segment group for CSU_C11_PATIENT_GROUP - PATIENT consisting of PV1, PV2|None
