...
"""
GENERAL RESOURCE - SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP
from utils.hl7.v2_5_1.segments import (
    NTE, AIG, APR
)

srm_s05_resources_group_general_resource_group = SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP(  # GENERAL RESOURCE - Segment group for SRM_S05_RESOURCES_GROUP - RESOURCES consisting of AIG, APR|None, NTE|None
    appointment_information_general_resource=aig,  # AIG(...)  # Required.
    appointment_preferences=None,  # APR(...) 
    notes_and_comments=None,  # NTE(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP TEMPLATE-----
"""


class SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP"""
    _hl7_name = """GENERAL RESOURCE"""
    _hl7_description = """Segment group for SRM_S05_RESOURCES_GROUP - RESOURCES consisting of AIG, APR|None, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP"""
    _c_length = (-1,-1,-1,)
    _c_rpt = (1, 1, 65535)
    _c_usage = ("R", "O", "O")
    _c_aliases = ("14", "15", "16")
    ...
    def __init__(
        ...
        """
        None - `SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S05_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP>`_
        Segment group for SRM_S05_RESOURCES_GROUP - RESOURCES consisting of AIG, APR|None, NTE|None
