...
"""
GENERAL RESOURCE - SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP TEMPLATE-----
"""


class SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP"""
    _hl7_name = """GENERAL RESOURCE"""
    _hl7_description = """Segment group for SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP - RESOURCES consisting of AIG, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("14", "15")
    ...
    def __init__(
        ...
        """
        None - `SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP_GENERAL_RESOURCE_GROUP>`_
        Segment group for SRR_S01_SCHEDULE_GROUP_RESOURCES_GROUP - RESOURCES consisting of AIG, NTE|None
