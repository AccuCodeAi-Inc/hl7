...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::MDM_T08_OBXNTE_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::MDM_T08_OBXNTE_GROUP TEMPLATE-----
"""


class MDM_T08_OBXNTE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """MDM_T08_OBXNTE_GROUP"""
    _hl7_name = """OBXNTE"""
    _hl7_description = """Segment group for MDM_T08 - Document edit notification and content  consisting of OBX, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T08_OBXNTE_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("12", "13")
    ...
    def __init__(
        ...
        """
        None - `MDM_T08_OBXNTE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T08_OBXNTE_GROUP>`_
        Segment group for MDM_T08 - Document edit notification and content  consisting of OBX, NTE|None
