...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::CRM_C07_PATIENT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import CRM_C07_PATIENT_GROUP
from utils.hl7.v2_5_1.segments import (
    CSR, PID, CSP, PV1
)

crm_c07_patient_group = CRM_C07_PATIENT_GROUP(  # PATIENT - Segment group for CRM_C07 - Correct/update phase information consisting of PID, PV1|None, CSR, CSP|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::CRM_C07_PATIENT_GROUP TEMPLATE-----
"""


class CRM_C07_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """CRM_C07_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for CRM_C07 - Correct/update phase information consisting of PID, PV1|None, CSR, CSP|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/CRM_C07_PATIENT_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 1, 1, 65535)
    _c_usage = ("R", "O", "R", "O")
    _c_aliases = ("3", "4", "5", "6")
    ...
    def __init__(
        ...
        """
        None - `CRM_C07_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/CRM_C07_PATIENT_GROUP>`_
        Segment group for CRM_C07 - Correct/update phase information consisting of PID, PV1|None, CSR, CSP|None
