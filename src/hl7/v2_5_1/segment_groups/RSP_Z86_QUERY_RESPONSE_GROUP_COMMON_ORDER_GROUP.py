...
from utils.hl7.v2_5_1.segment_groups import (
    RSP_Z86_QUERY_RESPONSE_GROUP_COMMON_ORDER_GROUP_ADMINISTRATION_GROUP, RSP_Z86_QUERY_RESPONSE_GROUP_COMMON_ORDER_GROUP_ORDER_DETAIL_GROUP, RSP_Z86_QUERY_RESPONSE_GROUP_COMMON_ORDER_GROUP_OBSERVATION_GROUP, RSP_Z86_QUERY_RESPONSE_GROUP_COMMON_ORDER_GROUP_ENCODED_ORDER_GROUP, RSP_Z86_QUERY_RESPONSE_GROUP_COMMON_ORDER_GROUP_DISPENSE_GROUP, RSP_Z86_QUERY_RESPONSE_GROUP_COMMON_ORDER_GROUP_TIMING_GROUP, RSP_Z86_QUERY_RESPONSE_GROUP_COMMON_ORDER_GROUP_GIVE_GROUP
)
