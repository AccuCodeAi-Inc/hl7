...
"""
AUTHORIZATION - RQA_I08_AUTHORIZATION_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RQA_I08_AUTHORIZATION_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RQA_I08_AUTHORIZATION_GROUP
from utils.hl7.v2_5_1.segments import (
    AUT, CTD
)

rqa_i08_authorization_group = RQA_I08_AUTHORIZATION_GROUP(  # AUTHORIZATION - Segment group for RQA_I08 - Request for treatment authorization information consisting of AUT, CTD|None
    authorization_information=aut,  # AUT(...)  # Required.
    contact_data=None,  # CTD(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RQA_I08_AUTHORIZATION_GROUP TEMPLATE-----
"""


class RQA_I08_AUTHORIZATION_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RQA_I08_AUTHORIZATION_GROUP"""
    _hl7_name = """AUTHORIZATION"""
    _hl7_description = """Segment group for RQA_I08 - Request for treatment authorization information consisting of AUT, CTD|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I08_AUTHORIZATION_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 1)
    _c_usage = ("R", "O")
    _c_aliases = ("4", "5")
    ...
    def __init__(
        ...
        """
        None - `RQA_I08_AUTHORIZATION_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I08_AUTHORIZATION_GROUP>`_
        Segment group for RQA_I08 - Request for treatment authorization information consisting of AUT, CTD|None
