...
"""
PATIENT ID - ADT_A42_PATIENT_ID_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::ADT_A42_PATIENT_ID_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ADT_A42_PATIENT_ID_GROUP
from utils.hl7.v2_5_1.segments import (
    MRG, PID, PV1, PD1
)

adt_a42_patient_id_group = ADT_A42_PATIENT_ID_GROUP(  # PATIENT ID - Segment group for ADT_A42 - Merge Visit - Visit Number  consisting of PID, PD1|None, MRG, PV1|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::ADT_A42_PATIENT_ID_GROUP TEMPLATE-----
"""


class ADT_A42_PATIENT_ID_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """ADT_A42_PATIENT_ID_GROUP"""
    _hl7_name = """PATIENT ID"""
    _hl7_description = """Segment group for ADT_A42 - Merge Visit - Visit Number  consisting of PID, PD1|None, MRG, PV1|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A42_PATIENT_ID_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 1, 1, 1)
    _c_usage = ("R", "O", "R", "O")
    _c_aliases = ("4", "5", "6", "7")
    ...
    def __init__(
        ...
        """
        None - `ADT_A42_PATIENT_ID_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A42_PATIENT_ID_GROUP>`_
        Segment group for ADT_A42 - Merge Visit - Visit Number  consisting of PID, PD1|None, MRG, PV1|None
