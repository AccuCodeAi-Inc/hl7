...
from utils.hl7.v2_5_1.segment_groups import (
    OMG_O19_ORDER_GROUP_PRIOR_RESULT_GROUP_ORDER_PRIOR_GROUP_OBSERVATION_PRIOR_GROUP, OMG_O19_ORDER_GROUP_PRIOR_RESULT_GROUP_ORDER_PRIOR_GROUP_TIMING_PRIOR_GROUP
)
