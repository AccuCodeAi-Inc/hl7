...
from utils.hl7.v2_5_1.segment_groups import (
    PGL_PC8_GOAL_GROUP_PATHWAY_GROUP, PGL_PC8_GOAL_GROUP_OBSERVATION_GROUP, PGL_PC8_GOAL_GROUP_ORDER_GROUP, PGL_PC8_GOAL_GROUP_GOAL_ROLE_GROUP, PGL_PC8_GOAL_GROUP_PROBLEM_GROUP
)
