...
from utils.hl7.v2_5_1.segment_groups import (
    PPG_PCH_PATHWAY_GROUP_GOAL_GROUP_GOAL_OBSERVATION_GROUP, PPG_PCH_PATHWAY_GROUP_GOAL_GROUP_PROBLEM_GROUP, PPG_PCH_PATHWAY_GROUP_GOAL_GROUP_GOAL_ROLE_GROUP, PPG_PCH_PATHWAY_GROUP_GOAL_GROUP_ORDER_GROUP
)
