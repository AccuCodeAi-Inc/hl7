...
"""
TIMING GIVE - RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP
from utils.hl7.v2_5_1.segments import (
    TQ2, TQ1
)

rgv_o15_order_group_give_group_timing_give_group = RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP(  # TIMING GIVE - Segment group for RGV_O15_ORDER_GROUP_GIVE_GROUP - GIVE consisting of TQ1, TQ2|None
    timing_or_quantity=tq1,  # TQ1(...)  # Required.
    timing_or_quantity_relationship=None,  # TQ2(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP TEMPLATE-----
"""


class RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP"""
    _hl7_name = """TIMING GIVE"""
    _hl7_description = """Segment group for RGV_O15_ORDER_GROUP_GIVE_GROUP - GIVE consisting of TQ1, TQ2|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("23", "24")
    ...
    def __init__(
        ...
        """
        None - `RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RGV_O15_ORDER_GROUP_GIVE_GROUP_TIMING_GIVE_GROUP>`_
        Segment group for RGV_O15_ORDER_GROUP_GIVE_GROUP - GIVE consisting of TQ1, TQ2|None
