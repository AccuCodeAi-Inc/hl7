...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP
from utils.hl7.v2_5_1.segments import (
    RXE, RXR, RXC
)

rgr_rgr_definition_group_order_group_encoding_group = RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP(  # ENCODING - Segment group for RGR_RGR_DEFINITION_GROUP_ORDER_GROUP - ORDER consisting of RXE, RXR, RXC|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP TEMPLATE-----
"""


class RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP"""
    _hl7_name = """ENCODING"""
    _hl7_description = """Segment group for RGR_RGR_DEFINITION_GROUP_ORDER_GROUP - ORDER consisting of RXE, RXR, RXC|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP"""
    _c_length = (-1,-1,-1,)
    ...
    def __init__(
        ...
        """
        None - `RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RGR_RGR_DEFINITION_GROUP_ORDER_GROUP_ENCODING_GROUP>`_
        Segment group for RGR_RGR_DEFINITION_GROUP_ORDER_GROUP - ORDER consisting of RXE, RXR, RXC|None
