...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::BAR_P05_VISIT_GROUP_INSURANCE_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import BAR_P05_VISIT_GROUP_INSURANCE_GROUP
from utils.hl7.v2_5_1.segments import (
    IN1, ROL, IN2, IN3
)

bar_p05_visit_group_insurance_group = BAR_P05_VISIT_GROUP_INSURANCE_GROUP(  # INSURANCE - Segment group for BAR_P05_VISIT_GROUP - VISIT consisting of IN1, IN2|None, IN3|None, ROL|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::BAR_P05_VISIT_GROUP_INSURANCE_GROUP TEMPLATE-----
"""


class BAR_P05_VISIT_GROUP_INSURANCE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """BAR_P05_VISIT_GROUP_INSURANCE_GROUP"""
    _hl7_name = """INSURANCE"""
    _hl7_description = """Segment group for BAR_P05_VISIT_GROUP - VISIT consisting of IN1, IN2|None, IN3|None, ROL|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/BAR_P05_VISIT_GROUP_INSURANCE_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
        None - `BAR_P05_VISIT_GROUP_INSURANCE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/BAR_P05_VISIT_GROUP_INSURANCE_GROUP>`_
        Segment group for BAR_P05_VISIT_GROUP - VISIT consisting of IN1, IN2|None, IN3|None, ROL|None
