...
from utils.hl7.v2_5_1.segment_groups import (
    PTR_PCF_PATIENT_GROUP_PATHWAY_GROUP_PROBLEM_GROUP_ORDER_GROUP_ORDER_DETAIL_GROUP_ORDER_OBSERVATION_GROUP, PTR_PCF_PATIENT_GROUP_PATHWAY_GROUP_PROBLEM_GROUP_ORDER_GROUP_ORDER_DETAIL_GROUP_ORDER_DETAIL_SEGMENT_GROUP
)
