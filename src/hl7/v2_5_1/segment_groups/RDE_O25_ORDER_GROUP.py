...
"""
ORDER - RDE_O25_ORDER_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RDE_O25_ORDER_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RDE_O25_ORDER_GROUP
from utils.hl7.v2_5_1.segments import (
    NTE, RXC, RXE, ORC, BLG, FT1, CTI, RXR
)
from utils.hl7.v2_5_1.segment_groups import (
    RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP, RDE_O25_ORDER_GROUP_OBSERVATION_GROUP, RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP, RDE_O25_ORDER_GROUP_TIMING_GROUP
)
...
rde_o25_order_group = RDE_O25_ORDER_GROUP(  # ORDER - Segment group for RDE_O25 - Pharmacy/Treatment Refill Authorization Request consisting of ORC, TIMING|None, ORDER DETAIL|None, RXE, NTE|None, TIMING ENCODED, RXR, RXC|None, OBSERVATION|None, FT1|None, BLG|None, CTI|None
    ...
    timing=None,  # RDE_O25_ORDER_GROUP_TIMING_GROUP(...) 
    order_detail=None,  # RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP(...) 
    pharmacy_or_treatment_encoded_order=rxe,  # RXE(...)  # Required.
    notes_and_comments=None,  # NTE(...) 
    timing_encoded=rde_o25_order_group_timing_encoded_group,  # RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP(...)  # Required.
    pharmacy_or_treatment_route=rxr,  # RXR(...)  # Required.
    pharmacy_or_treatment_component_order=None,  # RXC(...) 
    observation=None,  # RDE_O25_ORDER_GROUP_OBSERVATION_GROUP(...) 
    financial_transaction=None,  # FT1(...) 
    billing=None,  # BLG(...) 
    clinical_trial_identification=None,  # CTI(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RDE_O25_ORDER_GROUP TEMPLATE-----
"""


class RDE_O25_ORDER_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RDE_O25_ORDER_GROUP"""
    _hl7_name = """ORDER"""
    _hl7_description = """Segment group for RDE_O25 - Pharmacy/Treatment Refill Authorization Request consisting of ORC, TIMING|None, ORDER DETAIL|None, RXE, NTE|None, TIMING ENCODED, RXR, RXC|None, OBSERVATION|None, FT1|None, BLG|None, CTI|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RDE_O25_ORDER_GROUP"""
    ...
    _c_components = (ORC, RDE_O25_ORDER_GROUP_TIMING_GROUP, RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP, RXE, NTE, RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP, RXR, RXC, RDE_O25_ORDER_GROUP_OBSERVATION_GROUP, FT1, BLG, CTI)
    ...
    def __init__(
        ...
        timing_encoded: RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP
        | tuple[
            RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP, ...
        ],  #  Required. (TQ1.24, TQ2.25, ...)
        pharmacy_or_treatment_route: RXR | tuple[RXR, ...],  #  Required. RXR.26
        timing: RDE_O25_ORDER_GROUP_TIMING_GROUP
        | tuple[RDE_O25_ORDER_GROUP_TIMING_GROUP, ...]
        | None = None,  #  (TQ1.15, TQ2.16, ...)
        order_detail: RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP
        | None = None,  #  RXO.17, NTE.18, RXR.19
        notes_and_comments: NTE | tuple[NTE, ...] | None = None,  #  NTE.23
        pharmacy_or_treatment_component_order: RXC
        | tuple[RXC, ...]
        | None = None,  #  RXC.27
        observation: RDE_O25_ORDER_GROUP_OBSERVATION_GROUP
        | tuple[RDE_O25_ORDER_GROUP_OBSERVATION_GROUP, ...]
        ...
        """
        None - `RDE_O25_ORDER_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RDE_O25_ORDER_GROUP>`_
        Segment group for RDE_O25 - Pharmacy/Treatment Refill Authorization Request consisting of ORC, TIMING|None, ORDER DETAIL|None, RXE, NTE|None, TIMING ENCODED, RXR, RXC|None, OBSERVATION|None, FT1|None, BLG|None, CTI|None
    ...
    @property  # get TIMING
    def timing(self) -> tuple[RDE_O25_ORDER_GROUP_TIMING_GROUP, ...] | tuple[None]:
        """
        id: RDE_O25_ORDER_GROUP_TIMING_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RDE_O25_ORDER_GROUP_TIMING_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O25_ORDER_GROUP_TIMING_GROUP
        """
    ...
    def timing(
        ...
        ---
        param_type: RDE_O25_ORDER_GROUP_TIMING_GROUP.None | tuple[RDE_O25_ORDER_GROUP_TIMING_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O25_ORDER_GROUP_TIMING_GROUP
        """
    ...
    @property  # get RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP.None
    def order_detail(self) -> RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP | None:
        """
        id: RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP
        """
        return self._c_data[2][0]

    @order_detail.setter  # set RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP.None
    def order_detail(self, order_detail: RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP | None):
        """
        id: RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O25_ORDER_GROUP_ORDER_DETAIL_GROUP
        """
    ...
    def timing_encoded(self) -> tuple[RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP, ...]:
        """
        id: RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        return_type: tuple[RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP
        """
    ...
    def timing_encoded(
        self,
        timing_encoded: RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP
        | tuple[RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP, ...],
    ):
        """
        id: TIMING ENCODED SEGMENT GROUP | use: R | rpt: * | seq: None
        ---
        param_type: RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP.None | tuple[RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O25_ORDER_GROUP_TIMING_ENCODED_GROUP
        """
    ...
    def observation(
        self,
    ) -> tuple[RDE_O25_ORDER_GROUP_OBSERVATION_GROUP, ...] | tuple[None]:
        """
        id: RDE_O25_ORDER_GROUP_OBSERVATION_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[RDE_O25_ORDER_GROUP_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O25_ORDER_GROUP_OBSERVATION_GROUP
        """
    ...
    def observation(
        ...
        ---
        param_type: RDE_O25_ORDER_GROUP_OBSERVATION_GROUP.None | tuple[RDE_O25_ORDER_GROUP_OBSERVATION_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/RDE_O25_ORDER_GROUP_OBSERVATION_GROUP
        """
