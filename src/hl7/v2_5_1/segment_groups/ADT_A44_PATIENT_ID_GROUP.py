...
"""
PATIENT ID - ADT_A44_PATIENT_ID_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::ADT_A44_PATIENT_ID_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::ADT_A44_PATIENT_ID_GROUP TEMPLATE-----
"""


class ADT_A44_PATIENT_ID_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """ADT_A44_PATIENT_ID_GROUP"""
    _hl7_name = """PATIENT ID"""
    _hl7_description = """Segment group for ADT_A44 - Move Account Information - Patient Account Number consisting of PID, PD1|None, MRG"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A44_PATIENT_ID_GROUP"""
    _c_length = (-1,-1,-1,)
    _c_rpt = (1, 1, 1)
    _c_usage = ("R", "O", "R")
    _c_aliases = ("4", "5", "6")
    ...
    def __init__(
        ...
        """
        None - `ADT_A44_PATIENT_ID_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A44_PATIENT_ID_GROUP>`_
        Segment group for ADT_A44 - Move Account Information - Patient Account Number consisting of PID, PD1|None, MRG
