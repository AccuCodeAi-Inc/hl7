...
"""
MF STAFF - MFK_M02_MF_STAFF_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::MFK_M02_MF_STAFF_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import MFK_M02_MF_STAFF_GROUP
from utils.hl7.v2_5_1.segments import (
    PRA, MFE, AFF, ORG, NTE, CER, STF, EDU, LAN
)

mfk_m02_mf_staff_group = MFK_M02_MF_STAFF_GROUP(  # MF STAFF - Segment group for MFK_M02 - Master file acknowledgment - Staff/practitioner master file consisting of MFE, STF, PRA|None, ORG|None, AFF|None, LAN|None, EDU|None, CER|None, NTE|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::MFK_M02_MF_STAFF_GROUP TEMPLATE-----
"""


class MFK_M02_MF_STAFF_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """MFK_M02_MF_STAFF_GROUP"""
    _hl7_name = """MF STAFF"""
    _hl7_description = """Segment group for MFK_M02 - Master file acknowledgment - Staff/practitioner master file consisting of MFE, STF, PRA|None, ORG|None, AFF|None, LAN|None, EDU|None, CER|None, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MFK_M02_MF_STAFF_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 65535, 65535, 65535, 65535, 65535, 65535)
    _c_usage = ("R", "R", "O", "O", "O", "O", "O", "O", "O")
    _c_aliases = ("7", "8", "9", "10", "11", "12", "13", "14", "15")
    ...
    def __init__(
        self,
        master_file_entry: MFE,  #  Required. MFE.7
        ...
        """
        None - `MFK_M02_MF_STAFF_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MFK_M02_MF_STAFF_GROUP>`_
        Segment group for MFK_M02 - Master file acknowledgment - Staff/practitioner master file consisting of MFE, STF, PRA|None, ORG|None, AFF|None, LAN|None, EDU|None, CER|None, NTE|None

        :param master_file_entry: Master File Entry (id: MFE | seq: 7 | use: R | rpt: 1)
    ...
    def master_file_entry(self) -> MFE:
        """
        id: MFE | use: R | rpt: 1 | seq: 7
        ---
        return_type: MFE.7: Master File Entry
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MFE
        """
        return self._c_data[0][0]

    @master_file_entry.setter  # set MFE.7
    def master_file_entry(self, mfe: MFE):
        """
        id: MFE | use: R | rpt: 1 | seq: 7
        ---
        param_type: MFE.7: Master File Entry
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MFE
        """
        self._c_data[0] = (mfe,)
