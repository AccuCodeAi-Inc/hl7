...
"""
QUERY RESPONSE - RSP_K21_QUERY_RESPONSE_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RSP_K21_QUERY_RESPONSE_GROUP TEMPLATE-----
...
rsp_k21_query_response_group = RSP_K21_QUERY_RESPONSE_GROUP(  # QUERY RESPONSE - Segment group for RSP_K21 - Get Person Demographics Response consisting of PID, PD1|None, NK1|None, QRI
    ...
    query_response_instance=qri,  # QRI(...)  # Required.
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RSP_K21_QUERY_RESPONSE_GROUP TEMPLATE-----
"""


class RSP_K21_QUERY_RESPONSE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RSP_K21_QUERY_RESPONSE_GROUP"""
    _hl7_name = """QUERY RESPONSE"""
    _hl7_description = """Segment group for RSP_K21 - Get Person Demographics Response consisting of PID, PD1|None, NK1|None, QRI"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_K21_QUERY_RESPONSE_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 1)
    _c_usage = ("R", "O", "O", "R")
    _c_aliases = ("7", "8", "9", "10")
    ...
    def __init__(
        ...
        query_response_instance: QRI,  #  Required. QRI.10
        ...
        """
        None - `RSP_K21_QUERY_RESPONSE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_K21_QUERY_RESPONSE_GROUP>`_
        Segment group for RSP_K21 - Get Person Demographics Response consisting of PID, PD1|None, NK1|None, QRI
        ...
        :param query_response_instance: Query Response Instance (id: QRI | seq: 10 | use: R | rpt: 1)
        """
        super().__init__()
    ...
    @property  # get QRI.10
    def query_response_instance(self) -> QRI:
        """
        id: QRI | use: R | rpt: 1 | seq: 10
        ---
    ...
    def query_response_instance(self, qri: QRI):
        """
        id: QRI | use: R | rpt: 1 | seq: 10
        ---
