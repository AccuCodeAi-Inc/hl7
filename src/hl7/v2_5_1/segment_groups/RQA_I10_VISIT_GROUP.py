...
"""
VISIT - RQA_I10_VISIT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RQA_I10_VISIT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RQA_I10_VISIT_GROUP
from utils.hl7.v2_5_1.segments import (
    PV2, PV1
)

rqa_i10_visit_group = RQA_I10_VISIT_GROUP(  # VISIT - Segment group for RQA_I10 - Request for resubmission of an authorization consisting of PV1, PV2|None
    patient_visit=pv1,  # PV1(...)  # Required.
    patient_visit_additional_information=None,  # PV2(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RQA_I10_VISIT_GROUP TEMPLATE-----
"""


class RQA_I10_VISIT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RQA_I10_VISIT_GROUP"""
    _hl7_name = """VISIT"""
    _hl7_description = """Segment group for RQA_I10 - Request for resubmission of an authorization consisting of PV1, PV2|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I10_VISIT_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 1)
    _c_usage = ("R", "O")
    _c_aliases = ("25", "26")
    ...
    def __init__(
        ...
        """
        None - `RQA_I10_VISIT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I10_VISIT_GROUP>`_
        Segment group for RQA_I10 - Request for resubmission of an authorization consisting of PV1, PV2|None
