...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::ADT_A06_INSURANCE_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::ADT_A06_INSURANCE_GROUP TEMPLATE-----
"""


class ADT_A06_INSURANCE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """ADT_A06_INSURANCE_GROUP"""
    _hl7_name = """INSURANCE"""
    _hl7_description = """Segment group for ADT_A06 - Change an Outpatient To an Inpatient consisting of IN1, IN2|None, IN3|None, ROL|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A06_INSURANCE_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
        None - `ADT_A06_INSURANCE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A06_INSURANCE_GROUP>`_
        Segment group for ADT_A06 - Change an Outpatient To an Inpatient consisting of IN1, IN2|None, IN3|None, ROL|None
