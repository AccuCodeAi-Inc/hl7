...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP
from utils.hl7.v2_5_1.segments import (
    IN3, IN2, IN1
)

rqa_i11_guarantor_insurance_group_insurance_group = RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP(  # INSURANCE - Segment group for RQA_I11_GUARANTOR_INSURANCE_GROUP - GUARANTOR INSURANCE consisting of IN1, IN2|None, IN3|None
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP TEMPLATE-----
"""


class RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP"""
    _hl7_name = """INSURANCE"""
    _hl7_description = """Segment group for RQA_I11_GUARANTOR_INSURANCE_GROUP - GUARANTOR INSURANCE consisting of IN1, IN2|None, IN3|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP"""
    _c_length = (-1,-1,-1,)
    _c_rpt = (1, 1, 1)
    _c_usage = ("R", "O", "O")
    _c_aliases = ("11", "12", "13")
    ...
    def __init__(
        ...
        """
        None - `RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I11_GUARANTOR_INSURANCE_GROUP_INSURANCE_GROUP>`_
        Segment group for RQA_I11_GUARANTOR_INSURANCE_GROUP - GUARANTOR INSURANCE consisting of IN1, IN2|None, IN3|None
