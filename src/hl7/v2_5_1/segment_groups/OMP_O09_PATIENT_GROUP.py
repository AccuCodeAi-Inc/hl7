...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OMP_O09_PATIENT_GROUP TEMPLATE-----
...
omp_o09_patient_group = OMP_O09_PATIENT_GROUP(  # PATIENT - Segment group for OMP_O09 - Pharmacy/Treatment Order consisting of PID, PD1|None, NTE|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None
    ...
    patient_visit=None,  # OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP(...) 
    insurance=None,  # OMP_O09_PATIENT_GROUP_INSURANCE_GROUP(...) 
    guarantor=None,  # GT1(...) 
    patient_allergy_information=None,  # AL1(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::OMP_O09_PATIENT_GROUP TEMPLATE-----
"""


class OMP_O09_PATIENT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OMP_O09_PATIENT_GROUP"""
    _hl7_name = """PATIENT"""
    _hl7_description = """Segment group for OMP_O09 - Pharmacy/Treatment Order consisting of PID, PD1|None, NTE|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OMP_O09_PATIENT_GROUP"""
    _c_length = (-1,-1,-1,-1,-1,-1,-1,)
    _c_rpt = (1, 1, 65535, 1, 65535, 1, 65535)
    _c_usage = ("R", "O", "O", "O", "O", "O", "O")
    _c_aliases = ("4", "5", "6", "None", "None", "12", "13")
    _c_components = (PID, PD1, NTE, OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP, OMP_O09_PATIENT_GROUP_INSURANCE_GROUP, GT1, AL1)
    ...
    def __init__(
        ...
        patient_visit: OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP
        | None = None,  #  PV1.7, PV2.8
        insurance: OMP_O09_PATIENT_GROUP_INSURANCE_GROUP
        | tuple[OMP_O09_PATIENT_GROUP_INSURANCE_GROUP, ...]
        | None = None,  #  (IN1.9, IN2.10, IN3.11, ...)
        guarantor: GT1 | None = None,  #  GT1.12
        patient_allergy_information: AL1 | tuple[AL1, ...] | None = None,  #  AL1.13
    ):
        """
        None - `OMP_O09_PATIENT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OMP_O09_PATIENT_GROUP>`_
        Segment group for OMP_O09 - Pharmacy/Treatment Order consisting of PID, PD1|None, NTE|None, PATIENT VISIT|None, INSURANCE|None, GT1|None, AL1|None
    ...
    @property  # get OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP.None
    def patient_visit(self) -> OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP | None:
        """
        id: OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        return_type: OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP
        """
        return self._c_data[3][0]

    @patient_visit.setter  # set OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP.None
    def patient_visit(
        self, patient_v_isit: OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP | None
    ):
        """
        id: OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP | use: O | rpt: 1 | seq: None
        ---
        param_type: OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP.None: None
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OMP_O09_PATIENT_GROUP_PATIENT_VISIT_GROUP
        """
    ...
    def insurance(
        self,
    ) -> tuple[OMP_O09_PATIENT_GROUP_INSURANCE_GROUP, ...] | tuple[None]:
        """
        id: OMP_O09_PATIENT_GROUP_INSURANCE_GROUP SEGMENT GROUP | use: O | rpt: * | seq: None
        ---
        return_type: tuple[OMP_O09_PATIENT_GROUP_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OMP_O09_PATIENT_GROUP_INSURANCE_GROUP
        """
    ...
    def insurance(
        ...
        ---
        param_type: OMP_O09_PATIENT_GROUP_INSURANCE_GROUP.None | tuple[OMP_O09_PATIENT_GROUP_INSURANCE_GROUP, ...]: (None, ...)
        ---
        https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/OMP_O09_PATIENT_GROUP_INSURANCE_GROUP
        """
