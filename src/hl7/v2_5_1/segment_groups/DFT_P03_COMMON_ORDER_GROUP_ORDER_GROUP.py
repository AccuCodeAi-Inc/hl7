...
"""
ORDER - DFT_P03_COMMON_ORDER_GROUP_ORDER_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::DFT_P03_COMMON_ORDER_GROUP_ORDER_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::DFT_P03_COMMON_ORDER_GROUP_ORDER_GROUP TEMPLATE-----
"""


class DFT_P03_COMMON_ORDER_GROUP_ORDER_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """DFT_P03_COMMON_ORDER_GROUP_ORDER_GROUP"""
    _hl7_name = """ORDER"""
    _hl7_description = """Segment group for DFT_P03_COMMON_ORDER_GROUP - COMMON ORDER consisting of OBR, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/DFT_P03_COMMON_ORDER_GROUP_ORDER_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("14", "15")
    ...
    def __init__(
        ...
        """
        None - `DFT_P03_COMMON_ORDER_GROUP_ORDER_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/DFT_P03_COMMON_ORDER_GROUP_ORDER_GROUP>`_
        Segment group for DFT_P03_COMMON_ORDER_GROUP - COMMON ORDER consisting of OBR, NTE|None
