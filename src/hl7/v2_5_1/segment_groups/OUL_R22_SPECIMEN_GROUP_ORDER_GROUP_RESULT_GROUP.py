...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::OUL_R22_SPECIMEN_GROUP_ORDER_GROUP_RESULT_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::OUL_R22_SPECIMEN_GROUP_ORDER_GROUP_RESULT_GROUP TEMPLATE-----
"""


class OUL_R22_SPECIMEN_GROUP_ORDER_GROUP_RESULT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """OUL_R22_SPECIMEN_GROUP_ORDER_GROUP_RESULT_GROUP"""
    _hl7_name = """RESULT"""
    _hl7_description = """Segment group for OUL_R22_SPECIMEN_GROUP_ORDER_GROUP - ORDER consisting of OBX, TCD|None, SID|None, NTE|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R22_SPECIMEN_GROUP_ORDER_GROUP_RESULT_GROUP"""
    _c_length = (-1,-1,-1,-1,)
    ...
    def __init__(
        ...
        """
        None - `OUL_R22_SPECIMEN_GROUP_ORDER_GROUP_RESULT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R22_SPECIMEN_GROUP_ORDER_GROUP_RESULT_GROUP>`_
        Segment group for OUL_R22_SPECIMEN_GROUP_ORDER_GROUP - ORDER consisting of OBX, TCD|None, SID|None, NTE|None
