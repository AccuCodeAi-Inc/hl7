...
"""
PATHWAY ROLE - PPP_PCB_PATHWAY_GROUP_PATHWAY_ROLE_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::PPP_PCB_PATHWAY_GROUP_PATHWAY_ROLE_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::PPP_PCB_PATHWAY_GROUP_PATHWAY_ROLE_GROUP TEMPLATE-----
"""


class PPP_PCB_PATHWAY_GROUP_PATHWAY_ROLE_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """PPP_PCB_PATHWAY_GROUP_PATHWAY_ROLE_GROUP"""
    _hl7_name = """PATHWAY ROLE"""
    _hl7_description = """Segment group for PPP_PCB_PATHWAY_GROUP - PATHWAY consisting of ROL, VAR|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PPP_PCB_PATHWAY_GROUP_PATHWAY_ROLE_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("9", "10")
    ...
    def __init__(
        ...
        """
        None - `PPP_PCB_PATHWAY_GROUP_PATHWAY_ROLE_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PPP_PCB_PATHWAY_GROUP_PATHWAY_ROLE_GROUP>`_
        Segment group for PPP_PCB_PATHWAY_GROUP - PATHWAY consisting of ROL, VAR|None
