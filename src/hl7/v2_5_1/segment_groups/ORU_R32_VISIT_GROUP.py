...
"""
VISIT - ORU_R32_VISIT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::ORU_R32_VISIT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import ORU_R32_VISIT_GROUP
from utils.hl7.v2_5_1.segments import (
    PV1, PV2
)

oru_r32_visit_group = ORU_R32_VISIT_GROUP(  # VISIT - Segment group for ORU_R32 - Unsolicited Pre-Ordered Point-Of-Care Observation consisting of PV1, PV2|None
    patient_visit=pv1,  # PV1(...)  # Required.
    patient_visit_additional_information=None,  # PV2(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::ORU_R32_VISIT_GROUP TEMPLATE-----
"""


class ORU_R32_VISIT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """ORU_R32_VISIT_GROUP"""
    _hl7_name = """VISIT"""
    _hl7_description = """Segment group for ORU_R32 - Unsolicited Pre-Ordered Point-Of-Care Observation consisting of PV1, PV2|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORU_R32_VISIT_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 1)
    _c_usage = ("R", "O")
    _c_aliases = ("5", "6")
    ...
    def __init__(
        ...
        """
        None - `ORU_R32_VISIT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ORU_R32_VISIT_GROUP>`_
        Segment group for ORU_R32 - Unsolicited Pre-Ordered Point-Of-Care Observation consisting of PV1, PV2|None
