...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RQA_I08_PROVIDER_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RQA_I08_PROVIDER_GROUP
from utils.hl7.v2_5_1.segments import (
    PRD, CTD
)

rqa_i08_provider_group = RQA_I08_PROVIDER_GROUP(  # PROVIDER - Segment group for RQA_I08 - Request for treatment authorization information consisting of PRD, CTD|None
    provider_data=prd,  # PRD(...)  # Required.
    contact_data=None,  # CTD(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RQA_I08_PROVIDER_GROUP TEMPLATE-----
"""


class RQA_I08_PROVIDER_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RQA_I08_PROVIDER_GROUP"""
    _hl7_name = """PROVIDER"""
    _hl7_description = """Segment group for RQA_I08 - Request for treatment authorization information consisting of PRD, CTD|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I08_PROVIDER_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("6", "7")
    ...
    def __init__(
        ...
        """
        None - `RQA_I08_PROVIDER_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RQA_I08_PROVIDER_GROUP>`_
        Segment group for RQA_I08 - Request for treatment authorization information consisting of PRD, CTD|None
