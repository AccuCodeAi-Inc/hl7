...
"""
PATIENT VISIT - RRI_I12_PATIENT_VISIT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::RRI_I12_PATIENT_VISIT_GROUP TEMPLATE-----

from utils.hl7.v2_5_1.trigger_events import RRI_I12_PATIENT_VISIT_GROUP
from utils.hl7.v2_5_1.segments import (
    PV2, PV1
)

rri_i12_patient_visit_group = RRI_I12_PATIENT_VISIT_GROUP(  # PATIENT VISIT - Segment group for RRI_I12 - Patient referral acknowledgement consisting of PV1, PV2|None
    patient_visit=pv1,  # PV1(...)  # Required.
    patient_visit_additional_information=None,  # PV2(...) 
)

-----END TRIGGER_EVENT_SEGMENT_GROUP::RRI_I12_PATIENT_VISIT_GROUP TEMPLATE-----
"""


class RRI_I12_PATIENT_VISIT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """RRI_I12_PATIENT_VISIT_GROUP"""
    _hl7_name = """PATIENT VISIT"""
    _hl7_description = """Segment group for RRI_I12 - Patient referral acknowledgement consisting of PV1, PV2|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRI_I12_PATIENT_VISIT_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 1)
    _c_usage = ("R", "O")
    _c_aliases = ("21", "22")
    ...
    def __init__(
        ...
        """
        None - `RRI_I12_PATIENT_VISIT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RRI_I12_PATIENT_VISIT_GROUP>`_
        Segment group for RRI_I12 - Patient referral acknowledgement consisting of PV1, PV2|None
