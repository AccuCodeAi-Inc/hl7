...
"""
PROVIDER CONTACT - REF_I15_PROVIDER_CONTACT_GROUP
HL7 Version: 2.5.1

-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::REF_I15_PROVIDER_CONTACT_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::REF_I15_PROVIDER_CONTACT_GROUP TEMPLATE-----
"""


class REF_I15_PROVIDER_CONTACT_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """REF_I15_PROVIDER_CONTACT_GROUP"""
    _hl7_name = """PROVIDER CONTACT"""
    _hl7_description = """Segment group for REF_I15 - Request patient referral status consisting of PRD, CTD|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I15_PROVIDER_CONTACT_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("6", "7")
    ...
    def __init__(
        ...
        """
        None - `REF_I15_PROVIDER_CONTACT_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/REF_I15_PROVIDER_CONTACT_GROUP>`_
        Segment group for REF_I15 - Request patient referral status consisting of PRD, CTD|None
