...
-----BEGIN TRIGGER_EVENT_SEGMENT_GROUP::PIN_I07_PROVIDER_GROUP TEMPLATE-----
...
-----END TRIGGER_EVENT_SEGMENT_GROUP::PIN_I07_PROVIDER_GROUP TEMPLATE-----
"""


class PIN_I07_PROVIDER_GROUP(HL7SegmentGroup):
    # fmt: off
    _hl7_version = """2.5.1"""
    _hl7_type = """TRIGGER_EVENT_SEGMENT_GROUP"""
    _hl7_length = -1
    _hl7_id = """PIN_I07_PROVIDER_GROUP"""
    _hl7_name = """PROVIDER"""
    _hl7_description = """Segment group for PIN_I07 - Unsolicited insurance information consisting of PRD, CTD|None"""
    _hl7_ref_url = """https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PIN_I07_PROVIDER_GROUP"""
    _c_length = (-1,-1,)
    _c_rpt = (1, 65535)
    _c_usage = ("R", "O")
    _c_aliases = ("3", "4")
    ...
    def __init__(
        ...
        """
        None - `PIN_I07_PROVIDER_GROUP <https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PIN_I07_PROVIDER_GROUP>`_
        Segment group for PIN_I07 - Unsolicited insurance information consisting of PRD, CTD|None
