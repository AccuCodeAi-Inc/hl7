"""
HL7 Version: 2.5.1
Discharged to location - 0113
Table Type: User
"""


class DischargedToLocation(str):
    """
    Discharged to location - 0113 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0113
