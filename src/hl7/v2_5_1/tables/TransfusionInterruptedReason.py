"""
HL7 Version: 2.5.1
Transfusion Interrupted Reason - 0515
Table Type: User
"""


class TransfusionInterruptedReason(str):
    """
    Transfusion Interrupted Reason - 0515 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0515
