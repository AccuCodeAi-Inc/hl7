"""
HL7 Version: 2.5.1
Location cost center - 0462
Table Type: User
"""


class LocationCostCenter(str):
    """
    Location cost center - 0462 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0462
