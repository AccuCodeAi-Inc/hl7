"""
HL7 Version: 2.5.1
Special Program Indicator - 0348
Table Type: User
"""


class SpecialProgramIndicator(str):
    """
    Special Program Indicator - 0348 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0348
