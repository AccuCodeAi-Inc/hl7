"""
HL7 Version: 2.5.1
PSRO/UR Approval Indicator - 0349
Table Type: User
"""


class PsroOrUrApprovalIndicator(str):
    """
    PSRO/UR Approval Indicator - 0349 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0349
