"""
HL7 Version: 2.5.1
Supplier identifier - 0386
Table Type: User
"""


class SupplierIdentifier(str):
    """
    Supplier identifier - 0386 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0386
