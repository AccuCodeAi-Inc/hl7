"""
HL7 Version: 2.5.1
Patient Charge Adjustment - 0218
Table Type: User
"""


class PatientChargeAdjustment(str):
    """
    Patient Charge Adjustment - 0218 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0218
