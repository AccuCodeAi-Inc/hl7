"""
HL7 Version: 2.5.1
Insurance company ID codes - 0285
Table Type: User
"""


class InsuranceCompanyIdCodes(str):
    """
    Insurance company ID codes - 0285 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0285
