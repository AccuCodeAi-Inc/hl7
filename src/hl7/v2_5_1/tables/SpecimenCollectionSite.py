"""
HL7 Version: 2.5.1
Specimen Collection Site - 0543
Table Type: User
"""


class SpecimenCollectionSite(str):
    """
    Specimen Collection Site - 0543 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0543
