"""
HL7 Version: 2.5.1
Procedure code modifier - 0340
Table Type: User
"""


class ProcedureCodeModifier(str):
    """
    Procedure code modifier - 0340 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0340
