"""
HL7 Version: 2.5.1
Procedure Coding Method - 0089
Table Type: User
"""


class ProcedureCodingMethod(str):
    """
    Procedure Coding Method - 0089 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0089
