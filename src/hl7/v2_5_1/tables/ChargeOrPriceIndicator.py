"""
HL7 Version: 2.5.1
Charge/Price Indicator - 0032
Table Type: User
"""


class ChargeOrPriceIndicator(str):
    """
    Charge/Price Indicator - 0032 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0032
