"""
HL7 Version: 2.5.1
Non-covered Insurance Code - 0143
Table Type: User
"""


class NonCoveredInsuranceCode(str):
    """
    Non-covered Insurance Code - 0143 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0143
