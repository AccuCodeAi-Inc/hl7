"""
HL7 Version: 2.5.1
Guarantor Credit Rating Code - 0341
Table Type: User
"""


class GuarantorCreditRatingCode(str):
    """
    Guarantor Credit Rating Code - 0341 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0341
