"""
HL7 Version: 2.5.1
Employee classification - 0328
Table Type: User
"""


class EmployeeClassification(str):
    """
    Employee classification - 0328 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0328
