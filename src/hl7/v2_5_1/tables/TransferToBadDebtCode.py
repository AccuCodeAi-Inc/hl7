"""
HL7 Version: 2.5.1
Transfer to Bad Debt Code - 0110
Table Type: User
"""


class TransferToBadDebtCode(str):
    """
    Transfer to Bad Debt Code - 0110 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0110
