"""
HL7 Version: 2.5.1
Specimen Source Type Modifier - 0542
Table Type: User
"""


class SpecimenSourceTypeModifier(str):
    """
    Specimen Source Type Modifier - 0542 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0542
