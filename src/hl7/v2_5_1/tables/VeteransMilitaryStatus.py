"""
HL7 Version: 2.5.1
Veterans Military Status - 0172
Table Type: User
"""


class VeteransMilitaryStatus(str):
    """
    Veterans Military Status - 0172 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0172
