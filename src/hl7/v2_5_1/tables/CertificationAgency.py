"""
HL7 Version: 2.5.1
Certification Agency - 0346
Table Type: User
"""


class CertificationAgency(str):
    """
    Certification Agency - 0346 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0346
