"""
HL7 Version: 2.5.1
Pre-Admit Test Indicator - 0087
Table Type: User
"""


class PreAdmitTestIndicator(str):
    """
    Pre-Admit Test Indicator - 0087 // User table type
    https://hl7-definition.caristix.com/v2/HL7v2.5.1/Tables/0087
