...
class PEO(HL7Segment):
    ...
    def __init__(
        self,
        event_onset_date_or_time: TS,  # PEO.3
        event_identifiers_used: CE | None = None,  # PEO.1
        event_symptom_or_diagnosis_code: CE | None = None,  # PEO.2
        event_exacerbation_date_or_time: TS | None = None,  # PEO.4
        event_improved_date_or_time: TS | None = None,  # PEO.5
        event_ended_data_or_time: TS | None = None,  # PEO.6
        event_location_occurred_address: XAD | None = None,  # PEO.7
        event_qualification: EventQualification | ID | None = None,  # PEO.8
        event_serious: EventSeriousness | ID | None = None,  # PEO.9
        event_expected: EventExpected | ID | None = None,  # PEO.10
        event_outcome: EventConsequence | ID | None = None,  # PEO.11
        patient_outcome: PatientOutcome | ID | None = None,  # PEO.12
        event_description_from_others: FT | None = None,  # PEO.13
        event_from_original_reporter: FT | None = None,  # PEO.14
        event_description_from_patient: FT | None = None,  # PEO.15
        event_description_from_practitioner: FT | None = None,  # PEO.16
        event_description_from_autopsy: FT | None = None,  # PEO.17
        cause_of_death: CE | None = None,  # PEO.18
        primary_observer_name: XPN | None = None,  # PEO.19
        primary_observer_address: XAD | None = None,  # PEO.20
        primary_observer_telephone: XTN | None = None,  # PEO.21
        ...
        | ID
        | None = None,  # PEO.23
        primary_observer_aware_date_or_time: TS | None = None,  # PEO.24
