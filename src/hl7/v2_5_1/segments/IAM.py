...
from utils.hl7.v2_5_1.data_type import (
    IAM,
    TS, ST, SI, CE, CNE, XPN, EI, DT, XCN, XON
)
...
class IAM(HL7Segment):
    ...
    def __init__(
        self,
        set_id_iam: SI,  # IAM.1
        allergen_code_or_mnemonic_or_description: CE,  # IAM.3
        allergy_action_code: ActionCode | CNE,  # IAM.6
        allergen_type_code: AllergenType | CE | None = None,  # IAM.2
        allergy_severity_code: AllergySeverity | CE | None = None,  # IAM.4
        allergy_reaction_code: ST | None = None,  # IAM.5
        allergy_unique_identifier: EI | None = None,  # IAM.7
        action_reason: ST | None = None,  # IAM.8
        sensitivity_to_causative_agent_code: SensitivityToCausativeAgentCode
        | CE
        | None = None,  # IAM.9
        allergen_group_code_or_mnemonic_or_description: CE | None = None,  # IAM.10
        onset_date: DT | None = None,  # IAM.11
        onset_date_text: ST | None = None,  # IAM.12
        reported_date_or_time: TS | None = None,  # IAM.13
        reported_by: XPN | None = None,  # IAM.14
        relationship_to_patient_code: Relationship | CE | None = None,  # IAM.15
        alert_device_code: AlertDeviceCode | CE | None = None,  # IAM.16
        allergy_clinical_status_code: AllergyClinicalStatus
        | CE
        | None = None,  # IAM.17
        statused_by_person: XCN | None = None,  # IAM.18
        statused_by_organization: XON | None = None,  # IAM.19
        statused_at_date_or_time: TS | None = None,  # IAM.20
    ):
        """
