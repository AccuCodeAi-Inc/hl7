...
class IIM(HL7Segment):
    ...
    def __init__(
        self,
        primary_key_value_iim: CWE,  # IIM.1
        service_item_code: CWE,  # IIM.2
        inventory_lot_number: ST | None = None,  # IIM.3
        inventory_expiration_date: TS | None = None,  # IIM.4
        inventory_manufacturer_name: CWE | None = None,  # IIM.5
        inventory_location: CWE | None = None,  # IIM.6
        inventory_received_date: TS | None = None,  # IIM.7
        inventory_received_quantity: NM | None = None,  # IIM.8
        inventory_received_quantity_unit: CWE | None = None,  # IIM.9
        inventory_received_item_cost: MO | None = None,  # IIM.10
        inventory_on_hand_date: TS | None = None,  # IIM.11
        inventory_on_hand_quantity: NM | None = None,  # IIM.12
        inventory_on_hand_quantity_unit: CWE | None = None,  # IIM.13
        procedure_code: ProcedureCode | CE | None = None,  # IIM.14
        procedure_code_modifier: ProcedureCodeModifier | CE | None = None,  # IIM.15
    ):
        """
