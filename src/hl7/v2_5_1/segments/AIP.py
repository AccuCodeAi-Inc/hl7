...
class AIP(HL7Segment):
    ...
    def __init__(
        self,
        set_id_aip: SI,  # AIP.1
        segment_action_code: SegmentActionCode | ID | None = None,  # AIP.2
        personnel_resource_id: XCN | None = None,  # AIP.3
        resource_type: StaffType | CE | None = None,  # AIP.4
        resource_group: CE | None = None,  # AIP.5
        start_date_or_time: TS | None = None,  # AIP.6
        start_date_or_time_offset: NM | None = None,  # AIP.7
        start_date_or_time_offset_units: CE | None = None,  # AIP.8
        duration: NM | None = None,  # AIP.9
        duration_units: CE | None = None,  # AIP.10
        allow_substitution_code: AllowSubstitutionCodes | IS | None = None,  # AIP.11
        filler_status_code: FillerStatusCodes | CE | None = None,  # AIP.12
    ):
        """
