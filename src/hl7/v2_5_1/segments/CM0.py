...
class CM0(HL7Segment):
    ...
    def __init__(
        self,
        sponsor_study_id: EI,  # CM0.2
        title_of_study: ST,  # CM0.4
        set_id_cm0: SI | None = None,  # CM0.1
        alternate_study_id: EI | None = None,  # CM0.3
        chairman_of_study: XCN | None = None,  # CM0.5
        last_irb_approval_date: DT | None = None,  # CM0.6
        total_accrual_to_date: NM | None = None,  # CM0.7
        last_accrual_date: DT | None = None,  # CM0.8
        contact_for_study: XCN | None = None,  # CM0.9
        contacts_telephone_number: XTN | None = None,  # CM0.10
        contacts_address: XAD | None = None,  # CM0.11
    ):
        """
