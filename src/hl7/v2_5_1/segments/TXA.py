...
class TXA(HL7Segment):
    ...
    def __init__(
        self,
        set_id_txa: SI,  # TXA.1
        document_type: DocumentType | IS,  # TXA.2
        unique_document_number: EI,  # TXA.12
        document_completion_status: DocumentCompletionStatus | ID,  # TXA.17
        document_content_presentation: TypeOfReferencedData | ID | None = None,  # TXA.3
        activity_date_or_time: TS | None = None,  # TXA.4
        primary_activity_provider_code_or_name: XCN | None = None,  # TXA.5
        origination_date_or_time: TS | None = None,  # TXA.6
        transcription_date_or_time: TS | None = None,  # TXA.7
        edit_date_or_time: TS | None = None,  # TXA.8
        originator_code_or_name: XCN | None = None,  # TXA.9
        assigned_document_authenticator: XCN | None = None,  # TXA.10
        transcriptionist_code_or_name: XCN | None = None,  # TXA.11
        parent_document_number: EI | None = None,  # TXA.13
        placer_order_number: EI | None = None,  # TXA.14
        filler_order_number: EI | None = None,  # TXA.15
        unique_document_file_name: ST | None = None,  # TXA.16
        ...
        | ID
        | None = None,  # TXA.19
        document_storage_status: DocumentStorageStatus | ID | None = None,  # TXA.20
        document_change_reason: ST | None = None,  # TXA.21
        authentication_person_time_stamp: PPN | None = None,  # TXA.22
        distributed_copies: XCN | None = None,  # TXA.23
    ):
        """
