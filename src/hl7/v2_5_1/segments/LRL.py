...
class LRL(HL7Segment):
    ...
    def __init__(
        self,
        primary_key_value_lrl: PL,  # LRL.1
        location_relationship_id: LocationRelationshipId | CE,  # LRL.4
        segment_action_code: SegmentActionCode | ID | None = None,  # LRL.2
        segment_unique_key: EI | None = None,  # LRL.3
        organizational_location_relationship_value: XON | None = None,  # LRL.5
        patient_location_relationship_value: PL | None = None,  # LRL.6
    ):
        """
