...
class OM1(HL7Segment):
    ...
    def __init__(
        self,
        sequence_number_test_or_observation_master_file: NM,  # OM1.1
        producers_service_or_test_or_observation_id: CE,  # OM1.2
        specimen_required: YesOrNoIndicator | ID,  # OM1.4
        producer_id: CE,  # OM1.5
        other_names: ST,  # OM1.8
        nature_of_service_or_test_or_observation: NatureOfServiceOrTestOrObservation
        | IS,  # OM1.18
        permitted_data_types: ValueType | ID | None = None,  # OM1.3
        observation_description: TX | None = None,  # OM1.6
        other_service_or_test_or_observation_ids_for_the_observation: CE
        | None = None,  # OM1.7
        preferred_report_name_for_the_observation: ST | None = None,  # OM1.9
        preferred_short_name_or_mnemonic_for_observation: ST | None = None,  # OM1.10
        preferred_long_name_for_the_observation: ST | None = None,  # OM1.11
        orderability: YesOrNoIndicator | ID | None = None,  # OM1.12
        identity_of_instrument_used_to_perform_this_study: CE | None = None,  # OM1.13
        coded_representation_of_method: CE | None = None,  # OM1.14
        portable_device_indicator: YesOrNoIndicator | ID | None = None,  # OM1.15
        observation_producing_department_or_section: CE | None = None,  # OM1.16
        telephone_number_of_section: XTN | None = None,  # OM1.17
        report_subheader: CE | None = None,  # OM1.19
        report_display_order: ST | None = None,  # OM1.20
        date_or_time_stamp_for_any_change_in_definition_for_the_observation: TS
        | None = None,  # OM1.21
        effective_date_or_time_of_change: TS | None = None,  # OM1.22
        typical_turn_around_time: NM | None = None,  # OM1.23
        processing_time: NM | None = None,  # OM1.24
        processing_priority: ProcessingPriority | ID | None = None,  # OM1.25
        reporting_priority: ReportingPriority | ID | None = None,  # OM1.26
        outside_site: CE | None = None,  # OM1.27
        address_of_outside_site: XAD | None = None,  # OM1.28
        phone_number_of_outside_site: XTN | None = None,  # OM1.29
        confidentiality_code: ConfidentialityCode | CWE | None = None,  # OM1.30
        observations_required_to_interpret_the_observation: CE | None = None,  # OM1.31
        interpretation_of_observations: TX | None = None,  # OM1.32
        contraindications_to_observations: CE | None = None,  # OM1.33
        reflex_tests_or_observations: CE | None = None,  # OM1.34
        rules_that_trigger_reflex_testing: TX | None = None,  # OM1.35
        fixed_canned_message: CE | None = None,  # OM1.36
        patient_preparation: TX | None = None,  # OM1.37
        procedure_medication: CE | None = None,  # OM1.38
        factors_that_may_affect_the_observation: TX | None = None,  # OM1.39
        service_or_test_or_observation_performance_schedule: ST | None = None,  # OM1.40
        description_of_test_methods: TX | None = None,  # OM1.41
        kind_of_quantity_observed: KindOfQuantity | CE | None = None,  # OM1.42
        point_versus_interval: DurationCategories | CE | None = None,  # OM1.43
        challenge_information: TX | None = None,  # OM1.44
        relationship_modifier: RelationshipModifier | CE | None = None,  # OM1.45
        target_anatomic_site_of_test: CE | None = None,  # OM1.46
        modality_of_imaging_measurement: Modality | CE | None = None,  # OM1.47
    ):
        """
