...
from utils.hl7.v2_5_1.data_type import (
    BPX,
    CWE, TS, ID, XAD, XCN, SI, CE, CNE, NM, EI, XON, PL
)
...
class BPX(HL7Segment):
    ...
    def __init__(
        self,
        set_id_bpx: SI,  # BPX.1
        bp_dispense_status: BloodProductDispenseStatus | CWE,  # BPX.2
        bp_status: BpObservationStatusCodesInterpretation | ID,  # BPX.3
        bp_date_or_time_of_status: TS,  # BPX.4
        bp_quantity: NM,  # BPX.14
        bc_donation_id: EI | None = None,  # BPX.5
        bc_component: CNE | None = None,  # BPX.6
        bc_donation_type_or_intended_use: CNE | None = None,  # BPX.7
        cp_commercial_product: CommercialProduct | CWE | None = None,  # BPX.8
        cp_manufacturer: XON | None = None,  # BPX.9
        cp_lot_number: EI | None = None,  # BPX.10
        bp_blood_group: CNE | None = None,  # BPX.11
        bc_special_testing: CNE | None = None,  # BPX.12
        bp_expiration_date_or_time: TS | None = None,  # BPX.13
        bp_amount: NM | None = None,  # BPX.15
        bp_units: CE | None = None,  # BPX.16
        bp_unique_id: EI | None = None,  # BPX.17
        bp_actual_dispensed_to_location: PL | None = None,  # BPX.18
        bp_actual_dispensed_to_address: XAD | None = None,  # BPX.19
        bp_dispensed_to_receiver: XCN | None = None,  # BPX.20
        bp_dispensing_individual: XCN | None = None,  # BPX.21
    ):
        """
