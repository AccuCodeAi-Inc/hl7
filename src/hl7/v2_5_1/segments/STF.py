...
class STF(HL7Segment):
    ...
    def __init__(
        self,
        primary_key_value_stf: CE | None = None,  # STF.1
        staff_identifier_list: CX | None = None,  # STF.2
        staff_name: XPN | None = None,  # STF.3
        staff_type: StaffType | IS | None = None,  # STF.4
        administrative_sex: AdministrativeSex | IS | None = None,  # STF.5
        date_or_time_of_birth: TS | None = None,  # STF.6
        active_or_inactive_flag: ActiveOrInactive | ID | None = None,  # STF.7
        department: Department | CE | None = None,  # STF.8
        hospital_service_stf: HospitalService | CE | None = None,  # STF.9
        phone: XTN | None = None,  # STF.10
        office_or_home_address_or_birthplace: XAD | None = None,  # STF.11
        institution_activation_date: DIN | None = None,  # STF.12
        institution_inactivation_date: DIN | None = None,  # STF.13
        backup_person_id: CE | None = None,  # STF.14
        e_mail_address: ST | None = None,  # STF.15
        preferred_method_of_contact: PreferredMethodOfContact
        | CE
        | None = None,  # STF.16
        marital_status: MaritalStatus | CE | None = None,  # STF.17
        job_title: ST | None = None,  # STF.18
        job_code_or_class: JCC | None = None,  # STF.19
        employment_status_code: EmploymentStatus | CE | None = None,  # STF.20
        additional_insured_on_auto: YesOrNoIndicator | ID | None = None,  # STF.21
        drivers_license_number_staff: DLN | None = None,  # STF.22
        copy_auto_ins: YesOrNoIndicator | ID | None = None,  # STF.23
        auto_ins_expires: DT | None = None,  # STF.24
        date_last_dmv_review: DT | None = None,  # STF.25
        date_next_dmv_review: DT | None = None,  # STF.26
        race: Race | CE | None = None,  # STF.27
        ethnic_group: EthnicGroup | CE | None = None,  # STF.28
        re_activation_approval_indicator: YesOrNoIndicator | ID | None = None,  # STF.29
        citizenship: Citizenship | CWE | None = None,  # STF.30
        death_date_and_time: TS | None = None,  # STF.31
        death_indicator: YesOrNoIndicator | ID | None = None,  # STF.32
        institution_relationship_type_code: InstitutionRelationshipType
        | CWE
        | None = None,  # STF.33
        institution_relationship_period: DR | None = None,  # STF.34
        expected_return_date: DT | None = None,  # STF.35
        cost_center_code: CostCenterCode | CWE | None = None,  # STF.36
        generic_classification_indicator: YesOrNoIndicator | ID | None = None,  # STF.37
        inactive_reason_code: InactiveReasonCode | CWE | None = None,  # STF.38
    ):
        """
