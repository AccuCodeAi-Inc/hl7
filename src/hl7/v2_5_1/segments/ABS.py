...
class ABS(HL7Segment):
    ...
    def __init__(
        self,
        discharge_care_provider: PhysicianId | XCN | None = None,  # ABS.1
        transfer_medical_service_code: HospitalService | CE | None = None,  # ABS.2
        severity_of_illness_code: SeverityOfIllnessCode | CE | None = None,  # ABS.3
        date_or_time_of_attestation: TS | None = None,  # ABS.4
        attested_by: XCN | None = None,  # ABS.5
        triage_code: TriageCode | CE | None = None,  # ABS.6
        abstract_completion_date_or_time: TS | None = None,  # ABS.7
        abstracted_by: XCN | None = None,  # ABS.8
        case_category_code: CaseCategoryCode | CE | None = None,  # ABS.9
        caesarian_section_indicator: YesOrNoIndicator | ID | None = None,  # ABS.10
        gestation_category_code: GestationCategoryCode | CE | None = None,  # ABS.11
        gestation_period_weeks: NM | None = None,  # ABS.12
        newborn_code: NewbornCode | CE | None = None,  # ABS.13
        stillborn_indicator: YesOrNoIndicator | ID | None = None,  # ABS.14
    ):
        """
