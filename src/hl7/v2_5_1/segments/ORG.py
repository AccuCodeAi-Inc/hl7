...
class ORG(HL7Segment):
    ...
    def __init__(
        self,
        set_id_org: SI,  # ORG.1
        organization_unit_code: OrganizationUnit | CE | None = None,  # ORG.2
        organization_unit_type_code: OrganizationUnitType | CE | None = None,  # ORG.3
        primary_org_unit_indicator: YesOrNoIndicator | ID | None = None,  # ORG.4
        practitioner_org_unit_identifier: CX | None = None,  # ORG.5
        ...
        | CE
        | None = None,  # ORG.8
        effective_date_range: DR | None = None,  # ORG.9
        employment_status_code: EmploymentStatus | CE | None = None,  # ORG.10
        board_approval_indicator: YesOrNoIndicator | ID | None = None,  # ORG.11
        primary_care_physician_indicator: YesOrNoIndicator | ID | None = None,  # ORG.12
    ):
        """
