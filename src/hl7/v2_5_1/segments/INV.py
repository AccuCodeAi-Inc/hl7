...
class INV(HL7Segment):
    ...
    def __init__(
        self,
        substance_identifier: SubstanceIdentifier | CE,  # INV.1
        substance_status: SubstanceStatus | CE,  # INV.2
        substance_type: SubstanceType | CE | None = None,  # INV.3
        inventory_container_identifier: CE | None = None,  # INV.4
        container_carrier_identifier: CE | None = None,  # INV.5
        position_on_carrier: CE | None = None,  # INV.6
        initial_quantity: NM | None = None,  # INV.7
        current_quantity: NM | None = None,  # INV.8
        available_quantity: NM | None = None,  # INV.9
        consumption_quantity: NM | None = None,  # INV.10
        quantity_units: CE | None = None,  # INV.11
        expiration_date_or_time: TS | None = None,  # INV.12
        first_used_date_or_time: TS | None = None,  # INV.13
        on_board_stability_duration: TQ | None = None,  # INV.14
        test_or_fluid_identifier: CE | None = None,  # INV.15
        manufacturer_lot_number: ST | None = None,  # INV.16
        manufacturer_identifier: ManufacturerIdentifier | CE | None = None,  # INV.17
        supplier_identifier: SupplierIdentifier | CE | None = None,  # INV.18
        on_board_stability_time: CQ | None = None,  # INV.19
        target_value: CQ | None = None,  # INV.20
    ):
        """
