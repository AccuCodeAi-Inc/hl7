...
class BHS(HL7Segment):
    ...
    def __init__(
        self,
        batch_field_separator: ST,  # BHS.1
        batch_encoding_characters: ST,  # BHS.2
        batch_sending_application: HD | None = None,  # BHS.3
        batch_sending_facility: HD | None = None,  # BHS.4
        batch_receiving_application: HD | None = None,  # BHS.5
        batch_receiving_facility: HD | None = None,  # BHS.6
        batch_creation_date_or_time: TS | None = None,  # BHS.7
        batch_security: ST | None = None,  # BHS.8
        batch_name_or_id_or_type: ST | None = None,  # BHS.9
        batch_comment: ST | None = None,  # BHS.10
        batch_control_id: ST | None = None,  # BHS.11
        reference_batch_control_id: ST | None = None,  # BHS.12
    ):
        """
