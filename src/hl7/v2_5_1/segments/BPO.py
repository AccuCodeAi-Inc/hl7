...
class BPO(HL7Segment):
    ...
    def __init__(
        self,
        set_id_bpo: SI,  # BPO.1
        bp_universal_service_id: CWE,  # BPO.2
        bp_quantity: NM,  # BPO.4
        bp_processing_requirements: BloodProductProcessingRequirements
        | CWE
        | None = None,  # BPO.3
        bp_amount: NM | None = None,  # BPO.5
        bp_units: CE | None = None,  # BPO.6
        bp_intended_use_date_or_time: TS | None = None,  # BPO.7
        bp_intended_dispense_from_location: PL | None = None,  # BPO.8
        bp_intended_dispense_from_address: XAD | None = None,  # BPO.9
        bp_requested_dispense_date_or_time: TS | None = None,  # BPO.10
        bp_requested_dispense_to_location: PL | None = None,  # BPO.11
        bp_requested_dispense_to_address: XAD | None = None,  # BPO.12
        bp_indication_for_use: IndicationForUse | CWE | None = None,  # BPO.13
        bp_informed_consent_indicator: YesOrNoIndicator | ID | None = None,  # BPO.14
    ):
        """
