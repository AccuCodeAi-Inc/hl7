...
class ARQ(HL7Segment):
    ...
    def __init__(
        self,
        placer_appointment_id: EI,  # ARQ.1
        placer_contact_person: XCN,  # ARQ.15
        entered_by_person: XCN,  # ARQ.19
        filler_appointment_id: EI | None = None,  # ARQ.2
        occurrence_number: NM | None = None,  # ARQ.3
        placer_group_number: EI | None = None,  # ARQ.4
        schedule_id: CE | None = None,  # ARQ.5
        request_event_reason: CE | None = None,  # ARQ.6
        appointment_reason: AppointmentReasonCodes | CE | None = None,  # ARQ.7
        appointment_type: AppointmentTypeCodes | CE | None = None,  # ARQ.8
        appointment_duration: NM | None = None,  # ARQ.9
        appointment_duration_units: CE | None = None,  # ARQ.10
        requested_start_date_or_time_range: DR | None = None,  # ARQ.11
        priority_arq: ST | None = None,  # ARQ.12
        repeating_interval: RI | None = None,  # ARQ.13
        repeating_interval_duration: ST | None = None,  # ARQ.14
        placer_contact_phone_number: XTN | None = None,  # ARQ.16
        placer_contact_address: XAD | None = None,  # ARQ.17
        placer_contact_location: PL | None = None,  # ARQ.18
        entered_by_phone_number: XTN | None = None,  # ARQ.20
        entered_by_location: PL | None = None,  # ARQ.21
        parent_placer_appointment_id: EI | None = None,  # ARQ.22
        parent_filler_appointment_id: EI | None = None,  # ARQ.23
        placer_order_number: EI | None = None,  # ARQ.24
        filler_order_number: EI | None = None,  # ARQ.25
    ):
        """
