...
class AFF(HL7Segment):
    ...
    def __init__(
        self,
        set_id_aff: SI,  # AFF.1
        professional_organization: XON,  # AFF.2
        professional_organization_address: XAD | None = None,  # AFF.3
        professional_organization_affiliation_date_range: DR | None = None,  # AFF.4
        professional_affiliation_additional_information: ST | None = None,  # AFF.5
    ):
        """
