...
class SPR(HL7Segment):
    ...
    def __init__(
        self,
        query_or_response_format_code: QueryOrResponseFormatCode | ID,  # SPR.2
        stored_procedure_name: CE,  # SPR.3
        query_tag: ST | None = None,  # SPR.1
        input_parameter_list: QIP | None = None,  # SPR.4
    ):
        """
