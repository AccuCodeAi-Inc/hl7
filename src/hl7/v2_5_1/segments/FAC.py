...
class FAC(HL7Segment):
    ...
    def __init__(
        self,
        facility_id_fac: EI,  # FAC.1
        facility_address: XAD,  # FAC.3
        facility_telecommunication: XTN,  # FAC.4
        signature_authority: XCN,  # FAC.9
        facility_type: FacilityType | ID | None = None,  # FAC.2
        contact_person: XCN | None = None,  # FAC.5
        contact_title: ST | None = None,  # FAC.6
        contact_address: XAD | None = None,  # FAC.7
        contact_telecommunication: XTN | None = None,  # FAC.8
        signature_authority_title: ST | None = None,  # FAC.10
        signature_authority_address: XAD | None = None,  # FAC.11
        signature_authority_telecommunication: XTN | None = None,  # FAC.12
    ):
        """
