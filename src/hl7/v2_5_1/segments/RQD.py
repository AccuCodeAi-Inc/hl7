...
class RQD(HL7Segment):
    ...
    def __init__(
        self,
        requisition_line_number: SI | None = None,  # RQD.1
        item_code_internal: CE | None = None,  # RQD.2
        item_code_external: CE | None = None,  # RQD.3
        hospital_item_code: CE | None = None,  # RQD.4
        requisition_quantity: NM | None = None,  # RQD.5
        requisition_unit_of_measure: CE | None = None,  # RQD.6
        dept_cost_center: DepartmentCostCenter | IS | None = None,  # RQD.7
        item_natural_account_code: ItemNaturalAccountCode | IS | None = None,  # RQD.8
        deliver_to_id: CE | None = None,  # RQD.9
        date_needed: DT | None = None,  # RQD.10
    ):
        """
