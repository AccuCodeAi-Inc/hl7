...
class FHS(HL7Segment):
    ...
    def __init__(
        self,
        file_field_separator: ST,  # FHS.1
        file_encoding_characters: ST,  # FHS.2
        file_sending_application: HD | None = None,  # FHS.3
        file_sending_facility: HD | None = None,  # FHS.4
        file_receiving_application: HD | None = None,  # FHS.5
        file_receiving_facility: HD | None = None,  # FHS.6
        file_creation_date_or_time: TS | None = None,  # FHS.7
        file_security: ST | None = None,  # FHS.8
        file_name_or_id: ST | None = None,  # FHS.9
        file_header_comment: ST | None = None,  # FHS.10
        file_control_id: ST | None = None,  # FHS.11
        reference_file_control_id: ST | None = None,  # FHS.12
    ):
        """
