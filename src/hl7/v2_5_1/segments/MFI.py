...
class MFI(HL7Segment):
    ...
    def __init__(
        self,
        master_file_identifier: MasterFileIdentifierCode | CE,  # MFI.1
        file_level_event_code: FileLevelEventCode | ID,  # MFI.3
        response_level_code: ResponseLevel | ID,  # MFI.6
        master_file_application_identifier: Application | HD | None = None,  # MFI.2
        entered_date_or_time: TS | None = None,  # MFI.4
        effective_date_or_time: TS | None = None,  # MFI.5
    ):
        """
