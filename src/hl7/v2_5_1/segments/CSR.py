...
class CSR(HL7Segment):
    ...
    def __init__(
        self,
        sponsor_study_id: EI,  # CSR.1
        sponsor_patient_id: CX,  # CSR.4
        date_or_time_of_patient_study_registration: TS,  # CSR.6
        study_authorizing_provider: XCN,  # CSR.8
        alternate_study_id: EI | None = None,  # CSR.2
        institution_registering_the_patient: CE | None = None,  # CSR.3
        alternate_patient_id_csr: CX | None = None,  # CSR.5
        person_performing_study_registration: XCN | None = None,  # CSR.7
        date_or_time_patient_study_consent_signed: TS | None = None,  # CSR.9
        patient_study_eligibility_status: CE | None = None,  # CSR.10
        study_randomization_date_or_time: TS | None = None,  # CSR.11
        randomized_study_arm: CE | None = None,  # CSR.12
        stratum_for_study_randomization: CE | None = None,  # CSR.13
        patient_evaluability_status: CE | None = None,  # CSR.14
        date_or_time_ended_study: TS | None = None,  # CSR.15
        reason_ended_study: CE | None = None,  # CSR.16
    ):
        """
