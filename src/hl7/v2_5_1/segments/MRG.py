...
class MRG(HL7Segment):
    ...
    def __init__(
        self,
        prior_patient_identifier_list: CX,  # MRG.1
        prior_alternate_patient_id: CX | None = None,  # MRG.2
        prior_patient_account_number: CX | None = None,  # MRG.3
        prior_patient_id: CX | None = None,  # MRG.4
        prior_visit_number: CX | None = None,  # MRG.5
        prior_alternate_visit_id: CX | None = None,  # MRG.6
        prior_patient_name: XPN | None = None,  # MRG.7
    ):
        """
