...
class LDP(HL7Segment):
    ...
    def __init__(
        self,
        primary_key_value_ldp: PL,  # LDP.1
        location_department: LocationDepartment | CE,  # LDP.2
        location_service: HospitalService | IS | None = None,  # LDP.3
        specialty_type: SpecialtyType | CE | None = None,  # LDP.4
        valid_patient_classes: PatientClass | IS | None = None,  # LDP.5
        active_or_inactive_flag: ActiveOrInactive | ID | None = None,  # LDP.6
        activation_date_ldp: TS | None = None,  # LDP.7
        inactivation_date_ldp: TS | None = None,  # LDP.8
        inactivated_reason: ST | None = None,  # LDP.9
        visiting_hours: VH | None = None,  # LDP.10
        contact_phone: XTN | None = None,  # LDP.11
        location_cost_center: LocationCostCenter | CE | None = None,  # LDP.12
    ):
        """
