...
class FT1(HL7Segment):
    ...
    def __init__(
        self,
        transaction_date: DR,  # FT1.4
        transaction_type: TransactionType | IS,  # FT1.6
        transaction_code: TransactionCode | CE,  # FT1.7
        set_id_ft1: SI | None = None,  # FT1.1
        transaction_id: ST | None = None,  # FT1.2
        transaction_batch_id: ST | None = None,  # FT1.3
        transaction_posting_date: TS | None = None,  # FT1.5
        transaction_description: ST | None = None,  # FT1.8
        transaction_description_alt: ST | None = None,  # FT1.9
        transaction_quantity: NM | None = None,  # FT1.10
        transaction_amount_extended: CP | None = None,  # FT1.11
        transaction_amount_unit: CP | None = None,  # FT1.12
        department_code: DepartmentCode | CE | None = None,  # FT1.13
        insurance_plan_id: InsurancePlanId | CE | None = None,  # FT1.14
        insurance_amount: CP | None = None,  # FT1.15
        assigned_patient_location: PL | None = None,  # FT1.16
        fee_schedule: FeeSchedule | IS | None = None,  # FT1.17
        patient_type: PatientType | IS | None = None,  # FT1.18
        diagnosis_code_ft1: DiagnosisCode | CE | None = None,  # FT1.19
        performed_by_code: PerformedBy | XCN | None = None,  # FT1.20
        ordered_by_code: XCN | None = None,  # FT1.21
        unit_cost: CP | None = None,  # FT1.22
        filler_order_number: EI | None = None,  # FT1.23
        entered_by_code: XCN | None = None,  # FT1.24
        procedure_code: ProcedureCode | CE | None = None,  # FT1.25
        procedure_code_modifier: ProcedureCodeModifier | CE | None = None,  # FT1.26
        ...
        | CWE
        | None = None,  # FT1.28
        ndc_code: NdcCodes | CNE | None = None,  # FT1.29
        payment_reference_id: CX | None = None,  # FT1.30
        transaction_reference_key: SI | None = None,  # FT1.31
    ):
        """
