...
class PDA(HL7Segment):
    ...
    def __init__(
        self,
        death_cause_code: CE | None = None,  # PDA.1
        death_location: PL | None = None,  # PDA.2
        death_certified_indicator: YesOrNoIndicator | ID | None = None,  # PDA.3
        death_certificate_signed_date_or_time: TS | None = None,  # PDA.4
        death_certified_by: XCN | None = None,  # PDA.5
        autopsy_indicator: YesOrNoIndicator | ID | None = None,  # PDA.6
        autopsy_start_and_end_date_or_time: DR | None = None,  # PDA.7
        autopsy_performed_by: XCN | None = None,  # PDA.8
        coroner_indicator: YesOrNoIndicator | ID | None = None,  # PDA.9
    ):
        """
