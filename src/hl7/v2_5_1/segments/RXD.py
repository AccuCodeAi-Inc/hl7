...
from utils.hl7.v2_5_1.data_type import (
    RXD,
    ID, TS, CWE, XAD, ST, CQ, CE, NM, XCN, LA2
)
...
class RXD(HL7Segment):
    ...
    def __init__(
        self,
        dispense_sub_id_counter: NM,  # RXD.1
        dispense_or_give_code: VaccinesAdministered | CE,  # RXD.2
        date_or_time_dispensed: TS,  # RXD.3
        actual_dispense_amount: NM,  # RXD.4
        prescription_number: ST,  # RXD.7
        actual_dispense_units: CE | None = None,  # RXD.5
        actual_dosage_form: CE | None = None,  # RXD.6
        number_of_refills_remaining: NM | None = None,  # RXD.8
        dispense_notes: ST | None = None,  # RXD.9
        dispensing_provider: XCN | None = None,  # RXD.10
        substitution_status: SubstitutionStatus | ID | None = None,  # RXD.11
        total_daily_dose: CQ | None = None,  # RXD.12
        dispense_to_location: LA2 | None = None,  # RXD.13
        needs_human_review: YesOrNoIndicator | ID | None = None,  # RXD.14
        pharmacy_or_treatment_suppliers_special_dispensing_instructions: CE
        | None = None,  # RXD.15
        actual_strength: NM | None = None,  # RXD.16
        actual_strength_unit: CE | None = None,  # RXD.17
        substance_lot_number: ST | None = None,  # RXD.18
        substance_expiration_date: TS | None = None,  # RXD.19
        substance_manufacturer_name: ManufacturersOfVaccines
        | CE
        | None = None,  # RXD.20
        indication: CE | None = None,  # RXD.21
        dispense_package_size: NM | None = None,  # RXD.22
        dispense_package_size_unit: CE | None = None,  # RXD.23
        dispense_package_method: DispenseMethod | ID | None = None,  # RXD.24
        supplementary_code: CE | None = None,  # RXD.25
        initiating_location: CE | None = None,  # RXD.26
        packaging_or_assembly_location: CE | None = None,  # RXD.27
        actual_drug_strength_volume: NM | None = None,  # RXD.28
        actual_drug_strength_volume_units: CWE | None = None,  # RXD.29
        dispense_to_pharmacy: CWE | None = None,  # RXD.30
        dispense_to_pharmacy_address: XAD | None = None,  # RXD.31
        pharmacy_order_type: PharmacyOrderTypes | ID | None = None,  # RXD.32
        dispense_type: DispenseType | CWE | None = None,  # RXD.33
    ):
        """
