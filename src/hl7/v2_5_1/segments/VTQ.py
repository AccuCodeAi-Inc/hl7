...
class VTQ(HL7Segment):
    ...
    def __init__(
        self,
        query_or_response_format_code: QueryOrResponseFormatCode | ID,  # VTQ.2
        vt_query_name: CE,  # VTQ.3
        virtual_table_name: CE,  # VTQ.4
        query_tag: ST | None = None,  # VTQ.1
        selection_criteria: QSC | None = None,  # VTQ.5
    ):
        """
