...
class RXO(HL7Segment):
    ...
    def __init__(
        self,
        requested_give_code: CE | None = None,  # RXO.1
        requested_give_amount_minimum: NM | None = None,  # RXO.2
        requested_give_amount_maximum: NM | None = None,  # RXO.3
        requested_give_units: CE | None = None,  # RXO.4
        requested_dosage_form: CE | None = None,  # RXO.5
        providers_pharmacy_or_treatment_instructions: CE | None = None,  # RXO.6
        providers_administration_instructions: CE | None = None,  # RXO.7
        deliver_to_location: LA1 | None = None,  # RXO.8
        allow_substitutions: AllowSubstitution | ID | None = None,  # RXO.9
        requested_dispense_code: CE | None = None,  # RXO.10
        requested_dispense_amount: NM | None = None,  # RXO.11
        requested_dispense_units: CE | None = None,  # RXO.12
        number_of_refills: NM | None = None,  # RXO.13
        ordering_providers_dea_number: XCN | None = None,  # RXO.14
        pharmacist_or_treatment_suppliers_verifier_id: XCN | None = None,  # RXO.15
        needs_human_review: YesOrNoIndicator | ID | None = None,  # RXO.16
        requested_give_per: ST | None = None,  # RXO.17
        requested_give_strength: NM | None = None,  # RXO.18
        requested_give_strength_units: CE | None = None,  # RXO.19
        indication: CE | None = None,  # RXO.20
        requested_give_rate_amount: ST | None = None,  # RXO.21
        requested_give_rate_units: CE | None = None,  # RXO.22
        total_daily_dose: CQ | None = None,  # RXO.23
        supplementary_code: CE | None = None,  # RXO.24
        requested_drug_strength_volume: NM | None = None,  # RXO.25
        requested_drug_strength_volume_units: CWE | None = None,  # RXO.26
        pharmacy_order_type: PharmacyOrderTypes | ID | None = None,  # RXO.27
        dispensing_interval: NM | None = None,  # RXO.28
    ):
        """
