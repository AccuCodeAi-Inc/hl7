...
class NST(HL7Segment):
    ...
    def __init__(
        self,
        statistics_available: YesOrNoIndicator | ID,  # NST.1
        source_identifier: ST | None = None,  # NST.2
        source_type: SourceType | ID | None = None,  # NST.3
        statistics_start: TS | None = None,  # NST.4
        statistics_end: TS | None = None,  # NST.5
        receive_character_count: NM | None = None,  # NST.6
        send_character_count: NM | None = None,  # NST.7
        messages_received: NM | None = None,  # NST.8
        messages_sent: NM | None = None,  # NST.9
        checksum_errors_received: NM | None = None,  # NST.10
        length_errors_received: NM | None = None,  # NST.11
        other_errors_received: NM | None = None,  # NST.12
        connect_timeouts: NM | None = None,  # NST.13
        receive_timeouts: NM | None = None,  # NST.14
        application_control_level_errors: NM | None = None,  # NST.15
    ):
        """
