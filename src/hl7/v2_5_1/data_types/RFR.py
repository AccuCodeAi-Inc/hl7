...
class RFR(DataType):
    ...
    def __init__(
        self,
        numeric_range: NR,  # RFR.1
        administrative_sex: AdministrativeSex | IS | None = None,  # RFR.2
        age_range: NR | None = None,  # RFR.3
        gestational_age_range: NR | None = None,  # RFR.4
        species: ST | None = None,  # RFR.5
        race_or_subspecies: ST | None = None,  # RFR.6
        conditions: TX | None = None,  # RFR.7
    ):
        """
