...
class TQ(DataType):
    ...
    def __init__(
        self,
        quantity: CQ | None = None,  # TQ.1
        interval: RI | None = None,  # TQ.2
        duration: ST | None = None,  # TQ.3
        start_date_or_time: TS | None = None,  # TQ.4
        end_date_or_time: TS | None = None,  # TQ.5
        priority: ST | None = None,  # TQ.6
        condition: ST | None = None,  # TQ.7
        text: TX | None = None,  # TQ.8
        conjunction: TqConjunctionId | ID | None = None,  # TQ.9
        order_sequencing: OSD | None = None,  # TQ.10
        occurrence_duration: CE | None = None,  # TQ.11
        total_occurrences: NM | None = None,  # TQ.12
    ):
        """
