...
class CP(DataType):
    ...
    def __init__(
        self,
        price: MO,  # CP.1
        price_type: PriceType | ID | None = None,  # CP.2
        from_value: NM | None = None,  # CP.3
        to_value: NM | None = None,  # CP.4
        range_units: CE | None = None,  # CP.5
        range_type: CpRangeType | ID | None = None,  # CP.6
    ):
        """
