...
class NA(DataType):
    ...
    def __init__(
        self,
        value1: NM,  # NA.1
        value2: NM | None = None,  # NA.2
        value3: NM | None = None,  # NA.3
        value4: NM | None = None,  # NA.4
        value5: NM | None = None,  # NA.5
        value6: NM | None = None,  # NA.6
        value7: NM | None = None,  # NA.7
        value8: NM | None = None,  # NA.8
        value9: NM | None = None,  # NA.9
        value10: NM | None = None,  # NA.10
    ):
        """
